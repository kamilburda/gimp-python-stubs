...
class AppLaunchContext(__gi_repository_Gio.AppLaunchContext):
    ...
    def set_desktop(self, desktop): # real signature unknown; restored from __doc__
        """ set_desktop(self, desktop:int) """
        pass

    def set_display(self, display): # real signature unknown; restored from __doc__
        """ set_display(self, display:Gdk.Display) """
        pass

    def set_icon(self, icon=None): # real signature unknown; restored from __doc__
        """ set_icon(self, icon:Gio.Icon=None) """
        pass
