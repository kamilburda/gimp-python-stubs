...
class Rectangle(__gi.Boxed):
    ...
    def equal(self, rect2): # real signature unknown; restored from __doc__
        """ equal(self, rect2:Gdk.Rectangle) -> bool """
        return False

    def intersect(self, src2): # real signature unknown; restored from __doc__
        """ intersect(self, src2:Gdk.Rectangle) -> bool, dest:Gdk.Rectangle """
        return False

    def union(self, src2): # real signature unknown; restored from __doc__
