...
class Cursor(Cursor):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000018725398d60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gdk', '__new__': <staticmethod(<function Cursor.__new__ at 0x00000187252af6a0>)>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkCursor (585158016)>'
