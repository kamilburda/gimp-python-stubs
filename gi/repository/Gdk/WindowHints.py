...
class WindowHints(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'POS': <WindowHints.POS: 1>, 'MIN_SIZE': <WindowHints.MIN_SIZE: 2>, 'MAX_SIZE': <WindowHints.MAX_SIZE: 4>, 'BASE_SIZE': <WindowHints.BASE_SIZE: 8>, 'ASPECT': <WindowHints.ASPECT: 16>, 'RESIZE_INC': <WindowHints.RESIZE_INC: 32>, 'WIN_GRAVITY': <WindowHints.WIN_GRAVITY: 64>, 'USER_POS': <WindowHints.USER_POS: 128>, 'USER_SIZE': <WindowHints.USER_SIZE: 256>})"
    __name__ = 'WindowHints'
    __qualname__ = 'WindowHints'
