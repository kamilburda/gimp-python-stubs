...
class DeviceManager(__gi_overrides_GObject.Object):
    ...
    def get_client_pointer(self): # real signature unknown; restored from __doc__
        """ get_client_pointer(self) -> Gdk.Device """
        pass
    ...
    def list_devices(self, type): # real signature unknown; restored from __doc__
        """ list_devices(self, type:Gdk.DeviceType) -> list """
        return []
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001872539b010>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceManager), '__module__': 'gi.repository.Gdk', '__gtype__': <GType GdkDeviceManager (587204432)>, '__doc__': None, '__gsignals__': {}, 'get_client_pointer': gi.FunctionInfo(get_client_pointer), 'get_display': gi.FunctionInfo(get_display), 'list_devices': gi.FunctionInfo(list_devices)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkDeviceManager (587204432)>'
