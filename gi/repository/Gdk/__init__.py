...
def add_option_entries_libgtk_only(group): # real signature unknown; restored from __doc__
    """ add_option_entries_libgtk_only(group:GLib.OptionGroup) """
    pass

def atom_intern(atom_name, only_if_exists): # real signature unknown; restored from __doc__
    """ atom_intern(atom_name:str, only_if_exists:bool) -> Gdk.Atom """
    pass

def atom_intern_static_string(atom_name): # real signature unknown; restored from __doc__
    """ atom_intern_static_string(atom_name:str) -> Gdk.Atom """
    pass

def beep(): # real signature unknown; restored from __doc__
    """ beep() """
    pass

def cairo_create(window): # real signature unknown; restored from __doc__
    """ cairo_create(window:Gdk.Window) -> cairo.Context """
    pass

def cairo_draw_from_gl(cr, window, source, source_type, buffer_scale, x, y, width, height): # real signature unknown; restored from __doc__
    """ cairo_draw_from_gl(cr:cairo.Context, window:Gdk.Window, source:int, source_type:int, buffer_scale:int, x:int, y:int, width:int, height:int) """
    pass

def cairo_get_clip_rectangle(cr): # real signature unknown; restored from __doc__
    """ cairo_get_clip_rectangle(cr:cairo.Context) -> bool, rect:Gdk.Rectangle """
    return False

def cairo_get_drawing_context(cr): # real signature unknown; restored from __doc__
    """ cairo_get_drawing_context(cr:cairo.Context) -> Gdk.DrawingContext or None """
    pass

def cairo_rectangle(cr, rectangle): # real signature unknown; restored from __doc__
    """ cairo_rectangle(cr:cairo.Context, rectangle:Gdk.Rectangle) """
    pass

def cairo_region(cr, region): # real signature unknown; restored from __doc__
    """ cairo_region(cr:cairo.Context, region:cairo.Region) """
    pass

def cairo_region_create_from_surface(surface): # real signature unknown; restored from __doc__
    """ cairo_region_create_from_surface(surface:cairo.Surface) -> cairo.Region """
    pass

def cairo_set_source_color(cr, color): # real signature unknown; restored from __doc__
    """ cairo_set_source_color(cr:cairo.Context, color:Gdk.Color) """
    pass

def cairo_set_source_pixbuf(cr, pixbuf, pixbuf_x, pixbuf_y): # real signature unknown; restored from __doc__
    """ cairo_set_source_pixbuf(cr:cairo.Context, pixbuf:GdkPixbuf.Pixbuf, pixbuf_x:float, pixbuf_y:float) """
    pass

def cairo_set_source_rgba(cr, rgba): # real signature unknown; restored from __doc__
    """ cairo_set_source_rgba(cr:cairo.Context, rgba:Gdk.RGBA) """
    pass

def cairo_set_source_window(cr, window, x, y): # real signature unknown; restored from __doc__
    """ cairo_set_source_window(cr:cairo.Context, window:Gdk.Window, x:float, y:float) """
    pass

def cairo_surface_create_from_pixbuf(pixbuf, scale, for_window=None): # real signature unknown; restored from __doc__
    """ cairo_surface_create_from_pixbuf(pixbuf:GdkPixbuf.Pixbuf, scale:int, for_window:Gdk.Window=None) -> cairo.Surface """
    pass

def color_parse(*args, **kwargs): # reliably restored by inspect
    """ color_parse(spec:str) -> bool, color:Gdk.Color """
    pass

def disable_multidevice(): # real signature unknown; restored from __doc__
    """ disable_multidevice() """
    pass

def drag_abort(context, time_): # real signature unknown; restored from __doc__
    """ drag_abort(context:Gdk.DragContext, time_:int) """
    pass

def drag_begin(window, targets): # real signature unknown; restored from __doc__
    """ drag_begin(window:Gdk.Window, targets:list) -> Gdk.DragContext """
    pass

def drag_begin_for_device(window, device, targets): # real signature unknown; restored from __doc__
    """ drag_begin_for_device(window:Gdk.Window, device:Gdk.Device, targets:list) -> Gdk.DragContext """
    pass

def drag_begin_from_point(window, device, targets, x_root, y_root): # real signature unknown; restored from __doc__
    """ drag_begin_from_point(window:Gdk.Window, device:Gdk.Device, targets:list, x_root:int, y_root:int) -> Gdk.DragContext """
    pass

def drag_drop(context, time_): # real signature unknown; restored from __doc__
    """ drag_drop(context:Gdk.DragContext, time_:int) """
    pass

def drag_drop_done(context, success): # real signature unknown; restored from __doc__
    """ drag_drop_done(context:Gdk.DragContext, success:bool) """
    pass

def drag_drop_succeeded(context): # real signature unknown; restored from __doc__
    """ drag_drop_succeeded(context:Gdk.DragContext) -> bool """
    return False

def drag_find_window_for_screen(context, drag_window, screen, x_root, y_root): # real signature unknown; restored from __doc__
    """ drag_find_window_for_screen(context:Gdk.DragContext, drag_window:Gdk.Window, screen:Gdk.Screen, x_root:int, y_root:int) -> dest_window:Gdk.Window, protocol:Gdk.DragProtocol """
    pass

def drag_get_selection(context): # real signature unknown; restored from __doc__
    """ drag_get_selection(context:Gdk.DragContext) -> Gdk.Atom """
    pass

def drag_motion(context, dest_window, protocol, x_root, y_root, suggested_action, possible_actions, time_): # real signature unknown; restored from __doc__
    """ drag_motion(context:Gdk.DragContext, dest_window:Gdk.Window, protocol:Gdk.DragProtocol, x_root:int, y_root:int, suggested_action:Gdk.DragAction, possible_actions:Gdk.DragAction, time_:int) -> bool """
    return False

def drag_status(context, action, time_): # real signature unknown; restored from __doc__
    """ drag_status(context:Gdk.DragContext, action:Gdk.DragAction, time_:int) """
    pass

def drop_finish(context, success, time_): # real signature unknown; restored from __doc__
    """ drop_finish(context:Gdk.DragContext, success:bool, time_:int) """
    pass

def drop_reply(context, accepted, time_): # real signature unknown; restored from __doc__
    """ drop_reply(context:Gdk.DragContext, accepted:bool, time_:int) """
    pass

def error_trap_pop(): # real signature unknown; restored from __doc__
    """ error_trap_pop() -> int """
    return 0

def error_trap_pop_ignored(): # real signature unknown; restored from __doc__
    """ error_trap_pop_ignored() """
    pass

def error_trap_push(): # real signature unknown; restored from __doc__
    """ error_trap_push() """
    pass

def events_get_angle(event1, event2): # real signature unknown; restored from __doc__
    """ events_get_angle(event1:Gdk.Event, event2:Gdk.Event) -> bool, angle:float """
    return False

def events_get_center(event1, event2): # real signature unknown; restored from __doc__
    """ events_get_center(event1:Gdk.Event, event2:Gdk.Event) -> bool, x:float, y:float """
    return False

def events_get_distance(event1, event2): # real signature unknown; restored from __doc__
    """ events_get_distance(event1:Gdk.Event, event2:Gdk.Event) -> bool, distance:float """
    return False
...
def event_get(): # real signature unknown; restored from __doc__
    """ event_get() -> Gdk.Event or None """
    pass

def event_handler_set(func, data=None): # real signature unknown; restored from __doc__
    """ event_handler_set(func:Gdk.EventFunc, data=None) """
    pass

def event_peek(): # real signature unknown; restored from __doc__
    """ event_peek() -> Gdk.Event or None """
    pass

def event_request_motions(event): # real signature unknown; restored from __doc__
    """ event_request_motions(event:Gdk.EventMotion) """
    pass

def flush(): # real signature unknown; restored from __doc__
    """ flush() """
    pass

def get_default_root_window(): # real signature unknown; restored from __doc__
    """ get_default_root_window() -> Gdk.Window """
    pass

def get_display(): # real signature unknown; restored from __doc__
    """ get_display() -> str """
    return ""

def get_display_arg_name(): # real signature unknown; restored from __doc__
    """ get_display_arg_name() -> str or None """
    return ""

def get_program_class(): # real signature unknown; restored from __doc__
    """ get_program_class() -> str """
    return ""

def get_show_events(): # real signature unknown; restored from __doc__
    """ get_show_events() -> bool """
    return False

def gl_error_quark(): # real signature unknown; restored from __doc__
    """ gl_error_quark() -> int """
    return 0

def init(argv): # real signature unknown; restored from __doc__
    """ init(argv:list) -> argv:list """
    pass

def init_check(argv): # real signature unknown; restored from __doc__
    """ init_check(argv:list) -> bool, argv:list """
    return False

def keyboard_grab(window, owner_events, time_): # real signature unknown; restored from __doc__
    """ keyboard_grab(window:Gdk.Window, owner_events:bool, time_:int) -> Gdk.GrabStatus """
    pass

def keyboard_ungrab(time_): # real signature unknown; restored from __doc__
    """ keyboard_ungrab(time_:int) """
    pass

def keyval_convert_case(symbol): # real signature unknown; restored from __doc__
    """ keyval_convert_case(symbol:int) -> lower:int, upper:int """
    pass

def keyval_from_name(keyval_name): # real signature unknown; restored from __doc__
    """ keyval_from_name(keyval_name:str) -> int """
    return 0

def keyval_is_lower(keyval): # real signature unknown; restored from __doc__
    """ keyval_is_lower(keyval:int) -> bool """
    return False

def keyval_is_upper(keyval): # real signature unknown; restored from __doc__
    """ keyval_is_upper(keyval:int) -> bool """
    return False

def keyval_name(keyval): # real signature unknown; restored from __doc__
    """ keyval_name(keyval:int) -> str or None """
    return ""

def keyval_to_lower(keyval): # real signature unknown; restored from __doc__
    """ keyval_to_lower(keyval:int) -> int """
    return 0

def keyval_to_unicode(keyval): # real signature unknown; restored from __doc__
    """ keyval_to_unicode(keyval:int) -> int """
    return 0

def keyval_to_upper(keyval): # real signature unknown; restored from __doc__
    """ keyval_to_upper(keyval:int) -> int """
    return 0

def list_visuals(): # real signature unknown; restored from __doc__
    """ list_visuals() -> list """
    return []

def notify_startup_complete(): # real signature unknown; restored from __doc__
    """ notify_startup_complete() """
    pass

def notify_startup_complete_with_id(startup_id): # real signature unknown; restored from __doc__
    """ notify_startup_complete_with_id(startup_id:str) """
    pass

def offscreen_window_get_embedder(window): # real signature unknown; restored from __doc__
    """ offscreen_window_get_embedder(window:Gdk.Window) -> Gdk.Window or None """
    pass

def offscreen_window_get_surface(window): # real signature unknown; restored from __doc__
    """ offscreen_window_get_surface(window:Gdk.Window) -> cairo.Surface or None """
    pass

def offscreen_window_set_embedder(window, embedder): # real signature unknown; restored from __doc__
    """ offscreen_window_set_embedder(window:Gdk.Window, embedder:Gdk.Window) """
    pass

def pango_context_get(): # real signature unknown; restored from __doc__
    """ pango_context_get() -> Pango.Context """
    pass

def pango_context_get_for_display(display): # real signature unknown; restored from __doc__
    """ pango_context_get_for_display(display:Gdk.Display) -> Pango.Context """
    pass

def pango_context_get_for_screen(screen): # real signature unknown; restored from __doc__
    """ pango_context_get_for_screen(screen:Gdk.Screen) -> Pango.Context """
    pass

def parse_args(argv): # real signature unknown; restored from __doc__
    """ parse_args(argv:list) -> argv:list """
    pass

def pixbuf_get_from_surface(surface, src_x, src_y, width, height): # real signature unknown; restored from __doc__
    """ pixbuf_get_from_surface(surface:cairo.Surface, src_x:int, src_y:int, width:int, height:int) -> GdkPixbuf.Pixbuf or None """
    pass

def pixbuf_get_from_window(window, src_x, src_y, width, height): # real signature unknown; restored from __doc__
    """ pixbuf_get_from_window(window:Gdk.Window, src_x:int, src_y:int, width:int, height:int) -> GdkPixbuf.Pixbuf or None """
    pass

def pointer_grab(window, owner_events, event_mask, confine_to=None, cursor=None, time_): # real signature unknown; restored from __doc__
    """ pointer_grab(window:Gdk.Window, owner_events:bool, event_mask:Gdk.EventMask, confine_to:Gdk.Window=None, cursor:Gdk.Cursor=None, time_:int) -> Gdk.GrabStatus """
    pass

def pointer_is_grabbed(): # real signature unknown; restored from __doc__
    """ pointer_is_grabbed() -> bool """
    return False

def pointer_ungrab(time_): # real signature unknown; restored from __doc__
    """ pointer_ungrab(time_:int) """
    pass

def pre_parse_libgtk_only(): # real signature unknown; restored from __doc__
    """ pre_parse_libgtk_only() """
    pass

def property_delete(window, property): # real signature unknown; restored from __doc__
    """ property_delete(window:Gdk.Window, property:Gdk.Atom) """
    pass

def property_get(window, property, type, offset, length, pdelete): # real signature unknown; restored from __doc__
    """ property_get(window:Gdk.Window, property:Gdk.Atom, type:Gdk.Atom, offset:int, length:int, pdelete:int) -> bool, actual_property_type:Gdk.Atom, actual_format:int, data:list """
    return False

def query_depths(): # real signature unknown; restored from __doc__
    """ query_depths() -> depths:list """
    pass

def query_visual_types(): # real signature unknown; restored from __doc__
    """ query_visual_types() -> visual_types:list """
    pass

def rectangle_intersect(*args, **kwargs): # real signature unknown
    """ intersect(self, src2:Gdk.Rectangle) -> bool, dest:Gdk.Rectangle """
    pass

def rectangle_union(*args, **kwargs): # real signature unknown
    """ union(self, src2:Gdk.Rectangle) -> dest:Gdk.Rectangle """
    pass

def selection_convert(requestor, selection, target, time_): # real signature unknown; restored from __doc__
    """ selection_convert(requestor:Gdk.Window, selection:Gdk.Atom, target:Gdk.Atom, time_:int) """
    pass

def selection_owner_get(selection): # real signature unknown; restored from __doc__
    """ selection_owner_get(selection:Gdk.Atom) -> Gdk.Window or None """
    pass

def selection_owner_get_for_display(display, selection): # real signature unknown; restored from __doc__
    """ selection_owner_get_for_display(display:Gdk.Display, selection:Gdk.Atom) -> Gdk.Window or None """
    pass

def selection_owner_set(owner=None, selection, time_, send_event): # real signature unknown; restored from __doc__
    """ selection_owner_set(owner:Gdk.Window=None, selection:Gdk.Atom, time_:int, send_event:bool) -> bool """
    return False

def selection_owner_set_for_display(display, owner=None, selection, time_, send_event): # real signature unknown; restored from __doc__
    """ selection_owner_set_for_display(display:Gdk.Display, owner:Gdk.Window=None, selection:Gdk.Atom, time_:int, send_event:bool) -> bool """
    return False

def selection_send_notify(requestor, selection, target, property, time_): # real signature unknown; restored from __doc__
    """ selection_send_notify(requestor:Gdk.Window, selection:Gdk.Atom, target:Gdk.Atom, property:Gdk.Atom, time_:int) """
    pass

def selection_send_notify_for_display(display, requestor, selection, target, property, time_): # real signature unknown; restored from __doc__
    """ selection_send_notify_for_display(display:Gdk.Display, requestor:Gdk.Window, selection:Gdk.Atom, target:Gdk.Atom, property:Gdk.Atom, time_:int) """
    pass

def setting_get(name, value): # real signature unknown; restored from __doc__
    """ setting_get(name:str, value:GObject.Value) -> bool """
    return False

def set_allowed_backends(backends): # real signature unknown; restored from __doc__
    """ set_allowed_backends(backends:str) """
    pass

def set_double_click_time(msec): # real signature unknown; restored from __doc__
    """ set_double_click_time(msec:int) """
    pass

def set_program_class(program_class): # real signature unknown; restored from __doc__
    """ set_program_class(program_class:str) """
    pass

def set_show_events(show_events): # real signature unknown; restored from __doc__
    """ set_show_events(show_events:bool) """
    pass

def synthesize_window_state(window, unset_flags, set_flags): # real signature unknown; restored from __doc__
    """ synthesize_window_state(window:Gdk.Window, unset_flags:Gdk.WindowState, set_flags:Gdk.WindowState) """
    pass

def test_render_sync(window): # real signature unknown; restored from __doc__
    """ test_render_sync(window:Gdk.Window) """
    pass

def test_simulate_button(window, x, y, button, modifiers, button_pressrelease): # real signature unknown; restored from __doc__
    """ test_simulate_button(window:Gdk.Window, x:int, y:int, button:int, modifiers:Gdk.ModifierType, button_pressrelease:Gdk.EventType) -> bool """
    return False

def test_simulate_key(window, x, y, keyval, modifiers, key_pressrelease): # real signature unknown; restored from __doc__
    """ test_simulate_key(window:Gdk.Window, x:int, y:int, keyval:int, modifiers:Gdk.ModifierType, key_pressrelease:Gdk.EventType) -> bool """
    return False

def text_property_to_utf8_list_for_display(display, encoding, format, text): # real signature unknown; restored from __doc__
    """ text_property_to_utf8_list_for_display(display:Gdk.Display, encoding:Gdk.Atom, format:int, text:list) -> int, list:list """
    return 0

def threads_add_idle(priority, function, data=None): # real signature unknown; restored from __doc__
    """ threads_add_idle(priority:int, function:GLib.SourceFunc, data=None) -> int """
    return 0

def threads_add_timeout(priority, interval, function, data=None): # real signature unknown; restored from __doc__
    """ threads_add_timeout(priority:int, interval:int, function:GLib.SourceFunc, data=None) -> int """
    return 0

def threads_add_timeout_seconds(priority, interval, function, data=None): # real signature unknown; restored from __doc__
    """ threads_add_timeout_seconds(priority:int, interval:int, function:GLib.SourceFunc, data=None) -> int """
    return 0

def threads_enter(): # real signature unknown; restored from __doc__
    """ threads_enter() """
    pass
...
def threads_leave(): # real signature unknown; restored from __doc__
    """ threads_leave() """
    pass

def unicode_to_keyval(wc): # real signature unknown; restored from __doc__
    """ unicode_to_keyval(wc:int) -> int """
    return 0

def utf8_to_string_target(p_str): # real signature unknown; restored from __doc__
...
from .AxisFlags import AxisFlags
...
from .DevicePad import DevicePad
from .DevicePadFeature import DevicePadFeature
from .DevicePadInterface import DevicePadInterface
from .DeviceTool import DeviceTool
from .DeviceToolType import DeviceToolType
from .DeviceType import DeviceType
from .Display import Display
from .DisplayManager import DisplayManager
from .DragAction import DragAction
from .DragCancelReason import DragCancelReason
from .DragContext import DragContext
from .DragProtocol import DragProtocol
from .DrawingContext import DrawingContext
from .DrawingContextClass import DrawingContextClass
from .Event import Event
from .EventAny import EventAny
from .EventButton import EventButton
from .EventConfigure import EventConfigure
from .EventCrossing import EventCrossing
from .EventDND import EventDND
from .EventExpose import EventExpose
from .EventFocus import EventFocus
from .EventGrabBroken import EventGrabBroken
from .EventKey import EventKey
from .EventMask import EventMask
from .EventMotion import EventMotion
from .EventOwnerChange import EventOwnerChange
from .EventPadAxis import EventPadAxis
from .EventPadButton import EventPadButton
from .EventPadGroupMode import EventPadGroupMode
from .EventProperty import EventProperty
from .EventProximity import EventProximity
from .EventScroll import EventScroll
from .EventSelection import EventSelection
from .EventSequence import EventSequence
from .EventSetting import EventSetting
from .EventTouch import EventTouch
from .EventTouchpadPinch import EventTouchpadPinch
from .EventTouchpadSwipe import EventTouchpadSwipe
from .EventType import EventType
from .EventVisibility import EventVisibility
from .EventWindowState import EventWindowState
from .FilterReturn import FilterReturn
from .FrameClock import FrameClock
from .FrameClockClass import FrameClockClass
from .FrameClockPhase import FrameClockPhase
from .FrameClockPrivate import FrameClockPrivate
from .FrameTimings import FrameTimings
from .FullscreenMode import FullscreenMode
from .Geometry import Geometry
from .GLContext import GLContext
from .GLError import GLError
from .GrabOwnership import GrabOwnership
from .GrabStatus import GrabStatus
from .Gravity import Gravity
from .InputMode import InputMode
from .InputSource import InputSource
from .Keymap import Keymap
from .KeymapKey import KeymapKey
from .ModifierIntent import ModifierIntent
...
from .SeatCapabilities import SeatCapabilities
from .SettingAction import SettingAction
from .Status import Status
from .SubpixelLayout import SubpixelLayout
from .TimeCoord import TimeCoord
from .TouchpadGesturePhase import TouchpadGesturePhase
from .VisibilityState import VisibilityState
from .Visual import Visual
from .VisualType import VisualType
from .Window import Window
from .WindowAttr import WindowAttr
...
from .WindowRedirect import WindowRedirect
...
SELECTION_PRIMARY = None # (!) real value is 'Gdk.Atom.intern("PRIMARY", False)'

SELECTION_SECONDARY = None # (!) real value is 'Gdk.Atom.intern("SECONDARY", False)'

SELECTION_TYPE_ATOM = None # (!) real value is 'Gdk.Atom.intern("ATOM", False)'

SELECTION_TYPE_BITMAP = None # (!) real value is 'Gdk.Atom.intern("BITMAP", False)'

SELECTION_TYPE_COLORMAP = None # (!) real value is 'Gdk.Atom.intern("COLORMAP", False)'

SELECTION_TYPE_DRAWABLE = None # (!) real value is 'Gdk.Atom.intern("DRAWABLE", False)'

SELECTION_TYPE_INTEGER = None # (!) real value is 'Gdk.Atom.intern("INTEGER", False)'

SELECTION_TYPE_PIXMAP = None # (!) real value is 'Gdk.Atom.intern("PIXMAP", False)'

SELECTION_TYPE_STRING = None # (!) real value is 'Gdk.Atom.intern("STRING", False)'

SELECTION_TYPE_WINDOW = None # (!) real value is 'Gdk.Atom.intern("WINDOW", False)'

TARGET_BITMAP = None # (!) real value is 'Gdk.Atom.intern("BITMAP", False)'

TARGET_COLORMAP = None # (!) real value is 'Gdk.Atom.intern("COLORMAP", False)'

TARGET_DRAWABLE = None # (!) real value is 'Gdk.Atom.intern("DRAWABLE", False)'

TARGET_PIXMAP = None # (!) real value is 'Gdk.Atom.intern("PIXMAP", False)'
