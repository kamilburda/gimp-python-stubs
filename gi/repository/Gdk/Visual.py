...
class Visual(__gi_overrides_GObject.Object):
    ...
    def get_best(self): # real signature unknown; restored from __doc__
        """ get_best() -> Gdk.Visual """
        pass

    def get_best_depth(self): # real signature unknown; restored from __doc__
        """ get_best_depth() -> int """
        return 0

    def get_best_type(self): # real signature unknown; restored from __doc__
        """ get_best_type() -> Gdk.VisualType """
        pass

    def get_best_with_both(self, depth, visual_type): # real signature unknown; restored from __doc__
        """ get_best_with_both(depth:int, visual_type:Gdk.VisualType) -> Gdk.Visual or None """
        pass

    def get_best_with_depth(self, depth): # real signature unknown; restored from __doc__
        """ get_best_with_depth(depth:int) -> Gdk.Visual """
        pass

    def get_best_with_type(self, visual_type): # real signature unknown; restored from __doc__
        """ get_best_with_type(visual_type:Gdk.VisualType) -> Gdk.Visual """
        pass

    def get_bits_per_rgb(self): # real signature unknown; restored from __doc__
        """ get_bits_per_rgb(self) -> int """
        return 0

    def get_blue_pixel_details(self): # real signature unknown; restored from __doc__
        """ get_blue_pixel_details(self) -> mask:int, shift:int, precision:int """
        pass

    def get_byte_order(self): # real signature unknown; restored from __doc__
        """ get_byte_order(self) -> Gdk.ByteOrder """
        pass

    def get_colormap_size(self): # real signature unknown; restored from __doc__
        """ get_colormap_size(self) -> int """
        return 0
    ...
    def get_green_pixel_details(self): # real signature unknown; restored from __doc__
        """ get_green_pixel_details(self) -> mask:int, shift:int, precision:int """
        pass
    ...
    def get_red_pixel_details(self): # real signature unknown; restored from __doc__
        """ get_red_pixel_details(self) -> mask:int, shift:int, precision:int """
        pass
    ...
    def get_system(self): # real signature unknown; restored from __doc__
        """ get_system() -> Gdk.Visual """
        pass

    def get_visual_type(self): # real signature unknown; restored from __doc__
        """ get_visual_type(self) -> Gdk.VisualType """
        pass
