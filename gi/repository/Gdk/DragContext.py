...
class DragContext(DragContext):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x00000187227d12a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gdk', 'finish': <function DragContext.finish at 0x00000187252af560>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object GdkDragContext\n\nSignals from GdkDragContext:\n  cancel (GdkDragCancelReason)\n  drop-performed (gint)\n  dnd-finished ()\n  action-changed (GdkDragAction)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkDragContext (585157632)>'
