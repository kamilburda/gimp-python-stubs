...
class DevicePad(__gobject.GInterface):
    # no doc
    def get_feature_group(self, feature, feature_idx): # real signature unknown; restored from __doc__
        """ get_feature_group(self, feature:Gdk.DevicePadFeature, feature_idx:int) -> int """
        return 0

    def get_group_n_modes(self, group_idx): # real signature unknown; restored from __doc__
        """ get_group_n_modes(self, group_idx:int) -> int """
        return 0

    def get_n_features(self, feature): # real signature unknown; restored from __doc__
        """ get_n_features(self, feature:Gdk.DevicePadFeature) -> int """
        return 0

    def get_n_groups(self): # real signature unknown; restored from __doc__
        """ get_n_groups(self) -> int """
        return 0
