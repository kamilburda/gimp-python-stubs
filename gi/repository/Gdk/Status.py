...
class Status(__gi__gi.GEnum):
    ...
    __members__ = None # (!) real value is "mappingproxy({'OK': <Status.OK: 0>, 'ERROR': <Status.ERROR: -1>, 'ERROR_PARAM': <Status.ERROR_PARAM: -2>, 'ERROR_FILE': <Status.ERROR_FILE: -3>, 'ERROR_MEM': <Status.ERROR_MEM: -4>})"
    __name__ = 'Status'
    __qualname__ = 'Status'
