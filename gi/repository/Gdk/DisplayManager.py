...
class DisplayManager(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x00000187237443d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DisplayManager), '__module__': 'gi.repository.Gdk', '__gtype__': <GType GdkDisplayManager (585157536)>, '__doc__': None, '__gsignals__': {}, 'get': <staticmethod(gi.FunctionInfo(get))>, 'get_default_display': gi.FunctionInfo(get_default_display), 'list_displays': gi.FunctionInfo(list_displays), 'open_display': gi.FunctionInfo(open_display), 'set_default_display': gi.FunctionInfo(set_default_display)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkDisplayManager (585157536)>'
