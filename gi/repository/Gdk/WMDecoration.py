...
class WMDecoration(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'ALL': <WMDecoration.ALL: 1>, 'BORDER': <WMDecoration.BORDER: 2>, 'RESIZEH': <WMDecoration.RESIZEH: 4>, 'TITLE': <WMDecoration.TITLE: 8>, 'MENU': <WMDecoration.MENU: 16>, 'MINIMIZE': <WMDecoration.MINIMIZE: 32>, 'MAXIMIZE': <WMDecoration.MAXIMIZE: 64>})"
    __name__ = 'WMDecoration'
    __qualname__ = 'WMDecoration'
