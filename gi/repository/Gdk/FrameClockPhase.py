...
class FrameClockPhase(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <FrameClockPhase.NONE: 0>, 'FLUSH_EVENTS': <FrameClockPhase.FLUSH_EVENTS: 1>, 'BEFORE_PAINT': <FrameClockPhase.BEFORE_PAINT: 2>, 'UPDATE': <FrameClockPhase.UPDATE: 4>, 'LAYOUT': <FrameClockPhase.LAYOUT: 8>, 'PAINT': <FrameClockPhase.PAINT: 16>, 'RESUME_EVENTS': <FrameClockPhase.RESUME_EVENTS: 32>, 'AFTER_PAINT': <FrameClockPhase.AFTER_PAINT: 64>})"
    __name__ = 'FrameClockPhase'
    __qualname__ = 'FrameClockPhase'
