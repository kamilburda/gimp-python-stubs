...
class DragAction(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <DragAction.DEFAULT: 1>, 'COPY': <DragAction.COPY: 2>, 'MOVE': <DragAction.MOVE: 4>, 'LINK': <DragAction.LINK: 8>, 'PRIVATE': <DragAction.PRIVATE: 16>, 'ASK': <DragAction.ASK: 32>})"
    __name__ = 'DragAction'
    __qualname__ = 'DragAction'
