...
class PropMode(__gi__gi.GEnum):
    ...
    __members__ = None # (!) real value is "mappingproxy({'REPLACE': <PropMode.REPLACE: 0>, 'PREPEND': <PropMode.PREPEND: 1>, 'APPEND': <PropMode.APPEND: 2>})"
    __name__ = 'PropMode'
    __qualname__ = 'PropMode'
