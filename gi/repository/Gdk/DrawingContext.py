...
class DrawingContext(__gi_overrides_GObject.Object):
    ...
    def get_clip(self): # real signature unknown; restored from __doc__
        """ get_clip(self) -> cairo.Region or None """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001872539bd60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DrawingContext), '__module__': 'gi.repository.Gdk', '__gtype__': <GType GdkDrawingContext (587608416)>, '__doc__': None, '__gsignals__': {}, 'get_cairo_context': gi.FunctionInfo(get_cairo_context), 'get_clip': gi.FunctionInfo(get_clip), 'get_window': gi.FunctionInfo(get_window), 'is_valid': gi.FunctionInfo(is_valid)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkDrawingContext (587608416)>'
