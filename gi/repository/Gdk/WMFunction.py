...
class WMFunction(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'ALL': <WMFunction.ALL: 1>, 'RESIZE': <WMFunction.RESIZE: 2>, 'MOVE': <WMFunction.MOVE: 4>, 'MINIMIZE': <WMFunction.MINIMIZE: 8>, 'MAXIMIZE': <WMFunction.MAXIMIZE: 16>, 'CLOSE': <WMFunction.CLOSE: 32>})"
    __name__ = 'WMFunction'
    __qualname__ = 'WMFunction'
