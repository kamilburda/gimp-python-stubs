...
class EventVisibility(EventVisibility):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gdk', '__doc__': None, 'type': <property object at 0x00000187252d19e0>, 'window': <property object at 0x00000187252d1ad0>, 'send_event': <property object at 0x00000187252d1bc0>, 'state': <property object at 0x00000187252d1cb0>, 'new': <bound method new of <class 'gi.repository.Gdk.Event'>>, '_get_angle': gi.FunctionInfo(_get_angle), '_get_center': gi.FunctionInfo(_get_center), '_get_distance': gi.FunctionInfo(_get_distance), 'copy': gi.FunctionInfo(copy), 'free': gi.FunctionInfo(free), 'get_axis': <function strip_boolean_result.<locals>.wrapped at 0x00000187252aef20>, 'get_button': gi.FunctionInfo(get_button), 'get_click_count': gi.FunctionInfo(get_click_count), 'get_coords': <function strip_boolean_result.<locals>.wrapped at 0x00000187252aefc0>, 'get_device': gi.FunctionInfo(get_device), 'get_device_tool': gi.FunctionInfo(get_device_tool), 'get_event_sequence': gi.FunctionInfo(get_event_sequence), 'get_event_type': gi.FunctionInfo(get_event_type), 'get_keycode': gi.FunctionInfo(get_keycode), 'get_keyval': gi.FunctionInfo(get_keyval), 'get_pointer_emulated': gi.FunctionInfo(get_pointer_emulated), 'get_root_coords': <function strip_boolean_result.<locals>.wrapped at 0x00000187252af060>, 'get_scancode': gi.FunctionInfo(get_scancode), 'get_screen': gi.FunctionInfo(get_screen), 'get_scroll_deltas': gi.FunctionInfo(get_scroll_deltas), 'get_scroll_direction': gi.FunctionInfo(get_scroll_direction), 'get_seat': gi.FunctionInfo(get_seat), 'get_source_device': gi.FunctionInfo(get_source_device), 'get_state': <function strip_boolean_result.<locals>.wrapped at 0x00000187252af100>, 'get_time': gi.FunctionInfo(get_time), 'get_window': gi.FunctionInfo(get_window), 'is_scroll_stop_event': gi.FunctionInfo(is_scroll_stop_event), 'put': gi.FunctionInfo(put), 'set_device': gi.FunctionInfo(set_device), 'set_device_tool': gi.FunctionInfo(set_device_tool), 'set_screen': gi.FunctionInfo(set_screen), 'set_source_device': gi.FunctionInfo(set_source_device), 'triggers_context_menu': gi.FunctionInfo(triggers_context_menu), 'get': gi.FunctionInfo(get), 'handler_set': gi.FunctionInfo(handler_set), 'peek': gi.FunctionInfo(peek), 'request_motions': gi.FunctionInfo(request_motions)})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(EventVisibility)
