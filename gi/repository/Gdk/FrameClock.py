...
class FrameClock(__gi_overrides_GObject.Object):
    ...
    """
    def begin_updating(self): # real signature unknown; restored from __doc__
        """ begin_updating(self) """
        pass
    ...
    def end_updating(self): # real signature unknown; restored from __doc__
        """ end_updating(self) """
        pass
    ...
    def get_current_timings(self): # real signature unknown; restored from __doc__
        """ get_current_timings(self) -> Gdk.FrameTimings or None """
        pass
    ...
    def get_history_start(self): # real signature unknown; restored from __doc__
        """ get_history_start(self) -> int """
        return 0
    ...
    def get_refresh_info(self, base_time): # real signature unknown; restored from __doc__
        """ get_refresh_info(self, base_time:int) -> refresh_interval_return:int, presentation_time_return:int """
        pass

    def get_timings(self, frame_counter): # real signature unknown; restored from __doc__
        """ get_timings(self, frame_counter:int) -> Gdk.FrameTimings or None """
        pass
    ...
    def request_phase(self, phase): # real signature unknown; restored from __doc__
        """ request_phase(self, phase:Gdk.FrameClockPhase) """
        pass
