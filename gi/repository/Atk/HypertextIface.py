...
class HypertextIface(__gi.Struct):
    ...
    get_link = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_link_index = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_n_links = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    link_selected = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
