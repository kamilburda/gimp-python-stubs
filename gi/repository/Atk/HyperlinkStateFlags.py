...
class HyperlinkStateFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'INLINE': <HyperlinkStateFlags.INLINE: 1>})"
    __name__ = 'HyperlinkStateFlags'
    __qualname__ = 'HyperlinkStateFlags'
