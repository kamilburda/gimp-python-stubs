...
class Plug(Object, Component):
    ...
    def do_get_object_id(self, *args, **kwargs): # real signature unknown
    ...
    def set_child(self, child): # real signature unknown; restored from __doc__
        """ set_child(self, child:Atk.Object) """
        pass
