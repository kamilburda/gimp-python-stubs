...
class Socket(Object, Component):
    ...
    def do_embed(self, *args, **kwargs): # real signature unknown
    ...
    def embed(self, plug_id): # real signature unknown; restored from __doc__
        """ embed(self, plug_id:str) """
        pass
    ...
    def is_occupied(self): # real signature unknown; restored from __doc__
    ...
    embedded_plug_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
