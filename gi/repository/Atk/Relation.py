...
class Relation(__gi_overrides_GObject.Object):
    ...
    """
    def add_target(self, target): # real signature unknown; restored from __doc__
        """ add_target(self, target:Atk.Object) """
        pass
    ...
    def remove_target(self, target): # real signature unknown; restored from __doc__
        """ remove_target(self, target:Atk.Object) -> bool """
        return False
    ...
    relationship = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
