...
class TextSelection(__gi.Struct):
    """
    :Constructors:
    ...
    end_object = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    end_offset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    start_is_active = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    start_object = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
