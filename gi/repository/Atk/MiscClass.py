...
class MiscClass(__gi.Struct):
    ...
    threads_enter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    threads_leave = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    vfuncs = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
