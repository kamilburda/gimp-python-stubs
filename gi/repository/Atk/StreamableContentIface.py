...
class StreamableContentIface(__gi.Struct):
    ...
    get_n_mime_types = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_stream = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
