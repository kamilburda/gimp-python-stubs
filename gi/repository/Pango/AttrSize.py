...
class AttrSize(__gi.Struct):
    ...
    ::
        ...
        AttrSize()
    """
    def new(self, size): # real signature unknown; restored from __doc__
        """ new(size:int) -> Pango.Attribute """
        pass

    def new_absolute(self, size): # real signature unknown; restored from __doc__
        """ new_absolute(size:int) -> Pango.Attribute """
        pass
    ...
    absolute = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
