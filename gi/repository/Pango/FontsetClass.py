...
class FontsetClass(__gi.Struct):
    ...
    get_font = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_language = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_metrics = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _pango_reserved1 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
