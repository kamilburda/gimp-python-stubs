...
class ShapeFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <ShapeFlags.NONE: 0>, 'ROUND_POSITIONS': <ShapeFlags.ROUND_POSITIONS: 1>})"
    __name__ = 'ShapeFlags'
    __qualname__ = 'ShapeFlags'
