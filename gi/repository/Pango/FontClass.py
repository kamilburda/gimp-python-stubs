...
class FontClass(__gi.Struct):
    ...
    create_hb_font = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    describe = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    describe_absolute = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_coverage = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_features = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_font_map = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_glyph_extents = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
