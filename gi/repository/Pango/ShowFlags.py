...
class ShowFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <ShowFlags.NONE: 0>, 'SPACES': <ShowFlags.SPACES: 1>, 'LINE_BREAKS': <ShowFlags.LINE_BREAKS: 2>, 'IGNORABLES': <ShowFlags.IGNORABLES: 4>})"
    __name__ = 'ShowFlags'
    __qualname__ = 'ShowFlags'
