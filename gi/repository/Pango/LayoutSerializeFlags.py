...
class LayoutSerializeFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <LayoutSerializeFlags.DEFAULT: 0>, 'CONTEXT': <LayoutSerializeFlags.CONTEXT: 1>, 'OUTPUT': <LayoutSerializeFlags.OUTPUT: 2>})"
    __name__ = 'LayoutSerializeFlags'
    __qualname__ = 'LayoutSerializeFlags'
