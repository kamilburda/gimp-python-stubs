...
class FontFamily(__gi_overrides_GObject.Object, __gi_overrides_Gio.ListModel):
    ...
    def do_is_monospace(self, *args, **kwargs): # real signature unknown
        """ is_monospace(self) -> bool """
        pass

    def do_is_variable(self, *args, **kwargs): # real signature unknown
        """ is_variable(self) -> bool """
        pass

    def do_list_faces(self, *args, **kwargs): # real signature unknown
    ...
    def get_face(self, name=None): # real signature unknown; restored from __doc__
        """ get_face(self, name:str=None) -> Pango.FontFace or None """
        pass
    ...
    def is_monospace(self): # real signature unknown; restored from __doc__
        """ is_monospace(self) -> bool """
        return False

    def is_variable(self): # real signature unknown; restored from __doc__
        """ is_variable(self) -> bool """
        return False
    ...
    def list_faces(self): # real signature unknown; restored from __doc__
        """ list_faces(self) -> faces:list """
        pass
