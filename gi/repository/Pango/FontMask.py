...
class FontMask(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'FAMILY': <FontMask.FAMILY: 1>, 'STYLE': <FontMask.STYLE: 2>, 'VARIANT': <FontMask.VARIANT: 4>, 'WEIGHT': <FontMask.WEIGHT: 8>, 'STRETCH': <FontMask.STRETCH: 16>, 'SIZE': <FontMask.SIZE: 32>, 'GRAVITY': <FontMask.GRAVITY: 64>, 'VARIATIONS': <FontMask.VARIATIONS: 128>, 'FEATURES': <FontMask.FEATURES: 256>})"
    __name__ = 'FontMask'
    __qualname__ = 'FontMask'
