...
class LayoutDeserializeFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <LayoutDeserializeFlags.DEFAULT: 0>, 'CONTEXT': <LayoutDeserializeFlags.CONTEXT: 1>})"
    __name__ = 'LayoutDeserializeFlags'
    __qualname__ = 'LayoutDeserializeFlags'
