...
class FontFaceClass(__gi.Struct):
    ...
    get_face_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_family = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    is_synthesized = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    list_sizes = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
