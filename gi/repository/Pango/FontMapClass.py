...
class FontMapClass(__gi.Struct):
    ...
    list_families = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    load_font = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    load_fontset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    shape_engine_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
