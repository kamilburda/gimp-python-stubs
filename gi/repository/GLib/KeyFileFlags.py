...
class KeyFileFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <KeyFileFlags.NONE: 0>, 'KEEP_COMMENTS': <KeyFileFlags.KEEP_COMMENTS: 1>, 'KEEP_TRANSLATIONS': <KeyFileFlags.KEEP_TRANSLATIONS: 2>})"
    __name__ = 'KeyFileFlags'
    __qualname__ = 'KeyFileFlags'
