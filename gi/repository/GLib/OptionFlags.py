...
class OptionFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <OptionFlags.NONE: 0>, 'HIDDEN': <OptionFlags.HIDDEN: 1>, 'IN_MAIN': <OptionFlags.IN_MAIN: 2>, 'REVERSE': <OptionFlags.REVERSE: 4>, 'NO_ARG': <OptionFlags.NO_ARG: 8>, 'FILENAME': <OptionFlags.FILENAME: 16>, 'OPTIONAL_ARG': <OptionFlags.OPTIONAL_ARG: 32>, 'NOALIAS': <OptionFlags.NOALIAS: 64>, 'DEPRECATED': <OptionFlags.DEPRECATED: 128>})"
    __name__ = 'OptionFlags'
    __qualname__ = 'OptionFlags'
