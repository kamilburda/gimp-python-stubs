...
class Mutex(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': gi.UnionInfo(Mutex), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'Mutex' objects>, '__weakref__': <attribute '__weakref__' of 'Mutex' objects>, '__doc__': None, 'p': <property object at 0x0000018ea0079030>, 'i': <property object at 0x0000018ea0079120>, 'clear': gi.FunctionInfo(clear), 'init': gi.FunctionInfo(init), 'lock': gi.FunctionInfo(lock), 'trylock': gi.FunctionInfo(trylock), 'unlock': gi.FunctionInfo(unlock)})"
