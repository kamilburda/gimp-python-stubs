...
class MarkupParseFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT_FLAGS': <MarkupParseFlags.DEFAULT_FLAGS: 0>, 'DO_NOT_USE_THIS_UNSUPPORTED_FLAG': <MarkupParseFlags.DO_NOT_USE_THIS_UNSUPPORTED_FLAG: 1>, 'TREAT_CDATA_AS_TEXT': <MarkupParseFlags.TREAT_CDATA_AS_TEXT: 2>, 'PREFIX_ERROR_POSITION': <MarkupParseFlags.PREFIX_ERROR_POSITION: 4>, 'IGNORE_QUALIFIED': <MarkupParseFlags.IGNORE_QUALIFIED: 8>})"
    __name__ = 'MarkupParseFlags'
    __qualname__ = 'MarkupParseFlags'
