...
class SList(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SList), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SList' objects>, '__weakref__': <attribute '__weakref__' of 'SList' objects>, '__doc__': None, 'data': <property object at 0x0000018ea007bba0>, 'next': <property object at 0x0000018ea007bc90>, 'pop_allocator': <staticmethod(gi.FunctionInfo(pop_allocator))>, 'push_allocator': <staticmethod(gi.FunctionInfo(push_allocator))>})"
