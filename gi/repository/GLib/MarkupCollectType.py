...
class MarkupCollectType(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'INVALID': <MarkupCollectType.INVALID: 0>, 'STRING': <MarkupCollectType.STRING: 1>, 'STRDUP': <MarkupCollectType.STRDUP: 2>, 'BOOLEAN': <MarkupCollectType.BOOLEAN: 3>, 'TRISTATE': <MarkupCollectType.TRISTATE: 4>, 'OPTIONAL': <MarkupCollectType.OPTIONAL: 65536>})"
    __name__ = 'MarkupCollectType'
    __qualname__ = 'MarkupCollectType'
