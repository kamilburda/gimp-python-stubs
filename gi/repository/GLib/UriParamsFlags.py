...
class UriParamsFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <UriParamsFlags.NONE: 0>, 'CASE_INSENSITIVE': <UriParamsFlags.CASE_INSENSITIVE: 1>, 'WWW_FORM': <UriParamsFlags.WWW_FORM: 2>, 'PARSE_RELAXED': <UriParamsFlags.PARSE_RELAXED: 4>})"
    __name__ = 'UriParamsFlags'
    __qualname__ = 'UriParamsFlags'
