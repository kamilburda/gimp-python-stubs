...
class TraverseFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'LEAVES': <TraverseFlags.LEAVES: 1>, 'NON_LEAVES': <TraverseFlags.NON_LEAVES: 2>, 'ALL': <TraverseFlags.ALL: 3>, 'MASK': <TraverseFlags.ALL: 3>, 'LEAFS': <TraverseFlags.LEAVES: 1>, 'NON_LEAFS': <TraverseFlags.NON_LEAVES: 2>})"
    __name__ = 'TraverseFlags'
    __qualname__ = 'TraverseFlags'
