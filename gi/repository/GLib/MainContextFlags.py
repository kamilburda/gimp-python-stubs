...
class MainContextFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <MainContextFlags.NONE: 0>, 'OWNERLESS_POLLING': <MainContextFlags.OWNERLESS_POLLING: 1>})"
    __name__ = 'MainContextFlags'
    __qualname__ = 'MainContextFlags'
