...
class TestTrapFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <TestTrapFlags.DEFAULT: 0>, 'SILENCE_STDOUT': <TestTrapFlags.SILENCE_STDOUT: 128>, 'SILENCE_STDERR': <TestTrapFlags.SILENCE_STDERR: 256>, 'INHERIT_STDIN': <TestTrapFlags.INHERIT_STDIN: 512>})"
    __name__ = 'TestTrapFlags'
    __qualname__ = 'TestTrapFlags'
