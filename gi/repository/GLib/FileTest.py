...
class FileTest(__enum.IntFlag):
    ...
    __members__ = None # (!) real value is "mappingproxy({'IS_REGULAR': <FileTest.IS_REGULAR: 1>, 'IS_SYMLINK': <FileTest.IS_SYMLINK: 2>, 'IS_DIR': <FileTest.IS_DIR: 4>, 'IS_EXECUTABLE': <FileTest.IS_EXECUTABLE: 8>, 'EXISTS': <FileTest.EXISTS: 16>})"
    __name__ = 'FileTest'
    __qualname__ = 'FileTest'
