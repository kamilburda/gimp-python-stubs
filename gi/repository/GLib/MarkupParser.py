...
class MarkupParser(__gi.Struct):
    ...
    end_element = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    error = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    passthrough = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    start_element = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
