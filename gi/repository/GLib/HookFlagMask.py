...
class HookFlagMask(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'ACTIVE': <HookFlagMask.ACTIVE: 1>, 'IN_CALL': <HookFlagMask.IN_CALL: 2>, 'MASK': <HookFlagMask.MASK: 15>})"
    __name__ = 'HookFlagMask'
    __qualname__ = 'HookFlagMask'
