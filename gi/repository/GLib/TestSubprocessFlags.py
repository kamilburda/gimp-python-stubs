...
class TestSubprocessFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <TestSubprocessFlags.DEFAULT: 0>, 'INHERIT_STDIN': <TestSubprocessFlags.INHERIT_STDIN: 1>, 'INHERIT_STDOUT': <TestSubprocessFlags.INHERIT_STDOUT: 2>, 'INHERIT_STDERR': <TestSubprocessFlags.INHERIT_STDERR: 4>})"
    __name__ = 'TestSubprocessFlags'
    __qualname__ = 'TestSubprocessFlags'
