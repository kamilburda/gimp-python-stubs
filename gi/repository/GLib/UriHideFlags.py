...
class UriHideFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <UriHideFlags.NONE: 0>, 'USERINFO': <UriHideFlags.USERINFO: 1>, 'PASSWORD': <UriHideFlags.PASSWORD: 2>, 'AUTH_PARAMS': <UriHideFlags.AUTH_PARAMS: 4>, 'QUERY': <UriHideFlags.QUERY: 8>, 'FRAGMENT': <UriHideFlags.FRAGMENT: 16>})"
    __name__ = 'UriHideFlags'
    __qualname__ = 'UriHideFlags'
