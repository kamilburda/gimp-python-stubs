...
class PatternSpec(__gi.Boxed):
    ...
    def copy(self): # real signature unknown; restored from __doc__
        """ copy(self) -> GLib.PatternSpec """
        pass

    def equal(self, pspec2): # real signature unknown; restored from __doc__
        """ equal(self, pspec2:GLib.PatternSpec) -> bool """
        return False
    ...
    def match(self, string_length, string, string_reversed=None): # real signature unknown; restored from __doc__
        """ match(self, string_length:int, string:str, string_reversed:str=None) -> bool """
        return False

    def match_string(self, string): # real signature unknown; restored from __doc__
