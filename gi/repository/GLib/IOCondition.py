...
class IOCondition(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'IN': <IOCondition.IN: 1>, 'OUT': <IOCondition.OUT: 4>, 'PRI': <IOCondition.PRI: 2>, 'ERR': <IOCondition.ERR: 8>, 'HUP': <IOCondition.HUP: 16>, 'NVAL': <IOCondition.NVAL: 32>})"
    __name__ = 'IOCondition'
    __qualname__ = 'IOCondition'
