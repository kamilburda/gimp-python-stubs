...
class Timeout(__gi_overrides_GLib.Source):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.GLib', '__firstlineno__': 697, '__new__': <staticmethod(<function Timeout.__new__ at 0x0000018e9feea140>)>, '__init__': <function Timeout.__init__ at 0x0000018e9feea2a0>, '__static_attributes__': (), '__doc__': None})"
    __firstlineno__ = 697
