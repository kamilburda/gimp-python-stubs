...
class Completion(__gi.Struct):
    ...
    ::
        ...
        Completion()
    """
    def clear_items(self): # real signature unknown; restored from __doc__
        """ clear_items(self) """
        pass

    def complete_utf8(self, prefix, new_prefix): # real signature unknown; restored from __doc__
    ...
    strncmp_func = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
