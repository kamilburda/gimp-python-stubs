...
class List(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(List), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'List' objects>, '__weakref__': <attribute '__weakref__' of 'List' objects>, '__doc__': None, 'data': <property object at 0x0000018e9ff8b8d0>, 'next': <property object at 0x0000018e9ff8ba10>, 'prev': <property object at 0x0000018e9ff8bb00>, 'pop_allocator': <staticmethod(gi.FunctionInfo(pop_allocator))>, 'push_allocator': <staticmethod(gi.FunctionInfo(push_allocator))>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(List)
