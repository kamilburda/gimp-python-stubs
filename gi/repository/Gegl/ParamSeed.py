...
class ParamSeed(__gi_repository_GObject.ParamSpecUInt):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSeed), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamSeed (3645471376)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamSeed (3645471376)>'
    __info__ = ObjectInfo(ParamSeed)
