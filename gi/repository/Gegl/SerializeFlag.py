...
class SerializeFlag(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'TRIM_DEFAULTS': <SerializeFlag.TRIM_DEFAULTS: 1>, 'VERSION': <SerializeFlag.VERSION: 2>, 'INDENT': <SerializeFlag.INDENT: 4>, 'BAKE_ANIM': <SerializeFlag.BAKE_ANIM: 8>})"
    __name__ = 'SerializeFlag'
    __qualname__ = 'SerializeFlag'
