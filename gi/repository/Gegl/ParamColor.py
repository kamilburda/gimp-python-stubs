...
class ParamColor(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    
    ::
    
        ParamColor(**properties)
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamColor), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamColor (3657336000)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamColor (3657336000)>'
    __info__ = ObjectInfo(ParamColor)
