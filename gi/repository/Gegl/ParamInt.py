...
class ParamInt(__gi_repository_GObject.ParamSpecInt):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamInt), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamInt (3645470592)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamInt (3645470592)>'
    __info__ = ObjectInfo(ParamInt)
