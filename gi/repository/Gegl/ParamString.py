...
class ParamString(__gi_repository_GObject.ParamSpecString):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamString), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamString (3656428064)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamString (3656428064)>'
