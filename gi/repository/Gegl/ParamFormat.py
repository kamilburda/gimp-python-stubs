...
class ParamFormat(__gi_repository_GObject.ParamSpecPointer):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamFormat), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamFormat (3645470480)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamFormat (3645470480)>'
    __info__ = ObjectInfo(ParamFormat)
