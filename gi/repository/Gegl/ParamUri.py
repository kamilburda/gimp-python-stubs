...
class ParamUri(__gi_repository_GObject.ParamSpecString):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamUri), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamUri (3656426160)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamUri (3656426160)>'
    __info__ = ObjectInfo(ParamUri)
