...
class AccessMode(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'READ': <AccessMode.READ: 1>, 'WRITE': <AccessMode.WRITE: 2>, 'READWRITE': <AccessMode.READWRITE: 3>})"
    __name__ = 'AccessMode'
    __qualname__ = 'AccessMode'
