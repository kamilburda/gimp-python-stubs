...
class Curve(__gi_overrides_GObject.Object):
    ...
    def calc_value(self, x): # real signature unknown; restored from __doc__
    ...
    def get_point(self, index): # real signature unknown; restored from __doc__
    ...
    def get_y_bounds(self): # real signature unknown; restored from __doc__
    ...
    def num_points(self): # real signature unknown; restored from __doc__
        """ num_points(self) -> int """
        return 0
    ...
    def set_point(self, index, x, y): # real signature unknown; restored from __doc__
