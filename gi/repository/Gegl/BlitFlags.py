...
class BlitFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <BlitFlags.DEFAULT: 0>, 'CACHE': <BlitFlags.CACHE: 1>, 'DIRTY': <BlitFlags.DIRTY: 2>})"
    __name__ = 'BlitFlags'
    __qualname__ = 'BlitFlags'
