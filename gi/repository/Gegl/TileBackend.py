...
class TileBackend(TileSource):
    ...
    def command(self, command, x, y, z, data=None): # real signature unknown; restored from __doc__
    ...
    def get_flush_on_destroy(self): # real signature unknown; restored from __doc__
    ...
    def get_tile_height(self): # real signature unknown; restored from __doc__
    ...
    def get_tile_width(self): # real signature unknown; restored from __doc__
    ...
    def peek_storage(self): # real signature unknown; restored from __doc__
    ...
    def set_extent(self, rectangle): # real signature unknown; restored from __doc__
        """ set_extent(self, rectangle:Gegl.Rectangle) """
        pass

    def set_flush_on_destroy(self, flush_on_destroy): # real signature unknown; restored from __doc__
    ...
    def unlink_swap(self, path): # real signature unknown; restored from __doc__
