...
class AudioFragment(__gi_overrides_GObject.Object):
    ...
    def get_channel_layout(self): # real signature unknown; restored from __doc__
    ...
    def get_max_samples(self): # real signature unknown; restored from __doc__
    ...
    def get_sample_count(self): # real signature unknown; restored from __doc__
    ...
    def set_channels(self, channels): # real signature unknown; restored from __doc__
        """ set_channels(self, channels:int) """
        pass

    def set_channel_layout(self, channel_layout): # real signature unknown; restored from __doc__
    ...
    def set_max_samples(self, max_samples): # real signature unknown; restored from __doc__
    ...
    def set_sample_count(self, sample_count): # real signature unknown; restored from __doc__
        """ set_sample_count(self, sample_count:int) """
        pass

    def set_sample_rate(self, sample_rate): # real signature unknown; restored from __doc__
