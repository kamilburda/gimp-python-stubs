...
class ParamPath(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamPath), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamPath (3657336288)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamPath (3657336288)>'
    __info__ = ObjectInfo(ParamPath)
