...
class ParamDouble(__gi_repository_GObject.ParamSpecDouble):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamDouble), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamDouble (3652017600)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamDouble (3652017600)>'
    __info__ = ObjectInfo(ParamDouble)
