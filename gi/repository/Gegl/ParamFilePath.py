...
class ParamFilePath(__gi_repository_GObject.ParamSpecString):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamFilePath), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamFilePath (3645469920)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamFilePath (3645469920)>'
    __info__ = ObjectInfo(ParamFilePath)
