...
class CachePolicy(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'AUTO': <CachePolicy.AUTO: 0>, 'NEVER': <CachePolicy.NEVER: 1>, 'ALWAYS': <CachePolicy.ALWAYS: 2>})"
    __name__ = 'CachePolicy'
    __qualname__ = 'CachePolicy'
