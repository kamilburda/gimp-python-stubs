...
class ParamAudioFragment(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    
    ::
    
        ParamAudioFragment(**properties)
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamAudioFragment), '__module__': 'gi.repository.Gegl', '__gtype__': <GType GeglParamAudioFragment (3657336480)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GeglParamAudioFragment (3657336480)>'
    __info__ = ObjectInfo(ParamAudioFragment)
