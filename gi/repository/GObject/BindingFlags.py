...
class BindingFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <BindingFlags.DEFAULT: 0>, 'BIDIRECTIONAL': <BindingFlags.BIDIRECTIONAL: 1>, 'SYNC_CREATE': <BindingFlags.SYNC_CREATE: 2>, 'INVERT_BOOLEAN': <BindingFlags.INVERT_BOOLEAN: 4>})"
    __name__ = 'BindingFlags'
    __qualname__ = 'BindingFlags'
