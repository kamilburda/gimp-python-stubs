...
class ParamSpecBoxed(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecBoxed), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamBoxed (252364288)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e5b5b0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamBoxed (252364288)>'
    __info__ = ObjectInfo(ParamSpecBoxed)
