...
class ParamSpecPointer(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecPointer), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamPointer (252363616)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e4e020>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamPointer (252363616)>'
    __info__ = ObjectInfo(ParamSpecPointer)
