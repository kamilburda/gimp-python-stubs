...
class HashTable(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(HashTable), '__module__': 'gi.repository.GObject', '__gtype__': <GType GHashTable (265150144)>, '__dict__': <attribute '__dict__' of 'HashTable' objects>, '__weakref__': <attribute '__weakref__' of 'HashTable' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GHashTable (265150144)>'
