...
class StrvBuilder(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(StrvBuilder), '__module__': 'gi.repository.GObject', '__gtype__': <GType GStrvBuilder (265147168)>, '__dict__': <attribute '__dict__' of 'StrvBuilder' objects>, '__weakref__': <attribute '__weakref__' of 'StrvBuilder' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GStrvBuilder (265147168)>'
