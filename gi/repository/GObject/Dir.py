...
class Dir(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Dir), '__module__': 'gi.repository.GObject', '__gtype__': <GType GDir (265146688)>, '__dict__': <attribute '__dict__' of 'Dir' objects>, '__weakref__': <attribute '__weakref__' of 'Dir' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GDir (265146688)>'
