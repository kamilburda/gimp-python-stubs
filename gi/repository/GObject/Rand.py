...
class Rand(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Rand), '__module__': 'gi.repository.GObject', '__gtype__': <GType GRand (265147456)>, '__dict__': <attribute '__dict__' of 'Rand' objects>, '__weakref__': <attribute '__weakref__' of 'Rand' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GRand (265147456)>'
