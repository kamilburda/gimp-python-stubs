...
class Timeout(__gi_overrides_GLib.Source):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.GLib', '__new__': <staticmethod(<function Timeout.__new__ at 0x000001dd11de6ca0>)>, '__init__': <function Timeout.__init__ at 0x000001dd11de6d40>, '__doc__': None})"
