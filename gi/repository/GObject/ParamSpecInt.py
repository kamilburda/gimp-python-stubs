...
class ParamSpecInt(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecInt), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamInt (259904240)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e4cf40>, 'minimum': <property object at 0x000001dd11e4d030>, 'maximum': <property object at 0x000001dd11e4d120>, 'default_value': <property object at 0x000001dd11e4d210>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamInt (259904240)>'
    __info__ = ObjectInfo(ParamSpecInt)
