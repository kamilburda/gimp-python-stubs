...
class Date(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Date), '__module__': 'gi.repository.GObject', '__gtype__': <GType GDate (265146496)>, '__dict__': <attribute '__dict__' of 'Date' objects>, '__weakref__': <attribute '__weakref__' of 'Date' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GDate (265146496)>'
