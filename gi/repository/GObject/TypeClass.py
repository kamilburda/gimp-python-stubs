...
class TypeClass(__gi.Struct):
    ...
    ::
        ...
        TypeClass()
    """
    def add_private(self, private_size): # real signature unknown; restored from __doc__
        """ add_private(self, private_size:int) """
        pass

    def adjust_private_offset(self, g_class=None, private_size_or_offset): # real signature unknown; restored from __doc__
