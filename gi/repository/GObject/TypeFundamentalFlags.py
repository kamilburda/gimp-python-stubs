...
class TypeFundamentalFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'CLASSED': <TypeFundamentalFlags.CLASSED: 1>, 'INSTANTIATABLE': <TypeFundamentalFlags.INSTANTIATABLE: 2>, 'DERIVABLE': <TypeFundamentalFlags.DERIVABLE: 4>, 'DEEP_DERIVABLE': <TypeFundamentalFlags.DEEP_DERIVABLE: 8>})"
    __name__ = 'TypeFundamentalFlags'
    __qualname__ = 'TypeFundamentalFlags'
