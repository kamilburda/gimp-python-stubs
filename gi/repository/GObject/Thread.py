...
class Thread(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Thread), '__module__': 'gi.repository.GObject', '__gtype__': <GType GThread (265148128)>, '__dict__': <attribute '__dict__' of 'Thread' objects>, '__weakref__': <attribute '__weakref__' of 'Thread' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GThread (265148128)>'
