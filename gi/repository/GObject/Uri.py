...
class Uri(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Uri), '__module__': 'gi.repository.GObject', '__gtype__': <GType GUri (265148224)>, '__dict__': <attribute '__dict__' of 'Uri' objects>, '__weakref__': <attribute '__weakref__' of 'Uri' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GUri (265148224)>'
