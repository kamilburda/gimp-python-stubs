...
class VariantType(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(VariantType), '__module__': 'gi.repository.GObject', '__gtype__': <GType GVariantType (265148512)>, '__dict__': <attribute '__dict__' of 'VariantType' objects>, '__weakref__': <attribute '__weakref__' of 'VariantType' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GVariantType (265148512)>'
