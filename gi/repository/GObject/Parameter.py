...
class Parameter(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Parameter), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'Parameter' objects>, '__weakref__': <attribute '__weakref__' of 'Parameter' objects>, '__doc__': None, 'name': <property object at 0x000001dd11e48a40>, 'value': <property object at 0x000001dd11e48b30>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(Parameter)
