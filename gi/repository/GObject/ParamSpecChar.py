...
class ParamSpecChar(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecChar), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamChar (259903280)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e5b6f0>, 'minimum': <property object at 0x000001dd11e5b7e0>, 'maximum': <property object at 0x000001dd11e5b8d0>, 'default_value': <property object at 0x000001dd11e5b9c0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamChar (259903280)>'
    __info__ = ObjectInfo(ParamSpecChar)
