...
class ParamSpecValueArray(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    element_spec = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fixed_n_elements = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecValueArray), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamValueArray (252364384)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e48310>, 'element_spec': <property object at 0x000001dd11e48400>, 'fixed_n_elements': <property object at 0x000001dd11e484f0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamValueArray (252364384)>'
    __info__ = ObjectInfo(ParamSpecValueArray)
