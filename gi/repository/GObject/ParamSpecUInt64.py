...
class ParamSpecUInt64(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecUInt64), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamUInt64 (252365056)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e4f880>, 'minimum': <property object at 0x000001dd11e4f970>, 'maximum': <property object at 0x000001dd11e4fa60>, 'default_value': <property object at 0x000001dd11e4fb50>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamUInt64 (252365056)>'
    __info__ = ObjectInfo(ParamSpecUInt64)
