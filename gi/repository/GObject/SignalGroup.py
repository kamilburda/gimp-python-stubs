...
class SignalGroup(__gi_overrides_GObject.Object):
    ...
    def connect_closure(self, detailed_signal, closure, after): # real signature unknown; restored from __doc__
        """ connect_closure(self, detailed_signal:str, closure:GObject.Closure, after:bool) """
        pass

    def connect_data(self, detailed_signal, c_handler, data=None, flags): # real signature unknown; restored from __doc__
    ...
    def connect_swapped(self, detailed_signal, c_handler, data=None): # real signature unknown; restored from __doc__
    ...
    def dup_target(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, target_type): # real signature unknown; restored from __doc__
        """ new(target_type:GType) -> GObject.SignalGroup """
        pass
    ...
    def set_target(self, target=None): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001dd0f9991e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SignalGroup), '__module__': 'gi.repository.GObject', '__gtype__': <GType GSignalGroup (265147648)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'block': gi.FunctionInfo(block), 'connect_closure': gi.FunctionInfo(connect_closure), 'connect_data': gi.FunctionInfo(connect_data), 'connect_swapped': gi.FunctionInfo(connect_swapped), 'dup_target': gi.FunctionInfo(dup_target), 'set_target': gi.FunctionInfo(set_target), 'unblock': gi.FunctionInfo(unblock)})"
    __gdoc__ = 'Object GSignalGroup\n\nSignals from GSignalGroup:\n  bind (GObject)\n  unbind ()\n\nProperties from GSignalGroup:\n  target -> GObject: target\n  target-type -> GType: target-type\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GSignalGroup (265147648)>'
    __info__ = ObjectInfo(SignalGroup)
