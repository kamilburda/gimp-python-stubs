...
class Checksum(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Checksum), '__module__': 'gi.repository.GObject', '__gtype__': <GType GChecksum (265148608)>, '__dict__': <attribute '__dict__' of 'Checksum' objects>, '__weakref__': <attribute '__weakref__' of 'Checksum' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GChecksum (265148608)>'
