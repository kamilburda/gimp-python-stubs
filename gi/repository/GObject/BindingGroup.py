...
class BindingGroup(__gi_overrides_GObject.Object):
    ...
    """
    def bind(self, source_property, target, target_property, flags): # real signature unknown; restored from __doc__
        """ bind(self, source_property:str, target:GObject.Object, target_property:str, flags:GObject.BindingFlags) """
        pass

    def bind_full(self, source_property, target, target_property, flags, transform_to=None, transform_from=None): # real signature unknown; restored from __doc__
    ...
    def set_source(self, source=None): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001dd0f99b250>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BindingGroup), '__module__': 'gi.repository.GObject', '__gtype__': <GType GBindingGroup (265147840)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'bind': gi.FunctionInfo(bind), 'bind_full': gi.FunctionInfo(bind_full), 'dup_source': gi.FunctionInfo(dup_source), 'set_source': gi.FunctionInfo(set_source)})"
    __gdoc__ = 'Object GBindingGroup\n\nProperties from GBindingGroup:\n  source -> GObject: source\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GBindingGroup (265147840)>'
    __info__ = ObjectInfo(BindingGroup)
