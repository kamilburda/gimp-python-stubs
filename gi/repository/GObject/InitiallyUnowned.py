...
class InitiallyUnowned(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001dd11d369b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InitiallyUnowned), '__module__': 'gi.repository.GObject', '__gtype__': <GType GInitiallyUnowned (265148800)>, '__doc__': None, '__gsignals__': {}, 'g_type_instance': <property object at 0x000001dd11e58cc0>, 'ref_count': <property object at 0x000001dd11e58db0>, 'qdata': <property object at 0x000001dd11e58ea0>})"
    __gdoc__ = 'Object GInitiallyUnowned\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GInitiallyUnowned (265148800)>'
