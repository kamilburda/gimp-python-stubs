...
class ClosureNotifyData(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ClosureNotifyData), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ClosureNotifyData' objects>, '__weakref__': <attribute '__weakref__' of 'ClosureNotifyData' objects>, '__doc__': None, 'data': <property object at 0x000001dd11ea7920>, 'notify': <property object at 0x000001dd11ea7a10>})"
