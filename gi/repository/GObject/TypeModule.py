...
class TypeModule(__gi_overrides_GObject.Object, TypePlugin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001dd11de9cc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TypeModule), '__module__': 'gi.repository.GObject', '__gtype__': <GType GTypeModule (265146592)>, '__doc__': None, '__gsignals__': {}, 'add_interface': gi.FunctionInfo(add_interface), 'register_enum': gi.FunctionInfo(register_enum), 'register_flags': gi.FunctionInfo(register_flags), 'register_type': gi.FunctionInfo(register_type), 'set_name': gi.FunctionInfo(set_name), 'unuse': gi.FunctionInfo(unuse), 'use': gi.FunctionInfo(use), 'do_load': gi.VFuncInfo(load), 'do_unload': gi.VFuncInfo(unload), 'parent_instance': <property object at 0x000001dd11e4b150>, 'use_count': <property object at 0x000001dd11e4b240>, 'type_infos': <property object at 0x000001dd11e4b330>, 'interface_infos': <property object at 0x000001dd11e4b420>, 'name': <property object at 0x000001dd11e4b510>})"
    __gdoc__ = 'Object GTypeModule\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GTypeModule (265146592)>'
