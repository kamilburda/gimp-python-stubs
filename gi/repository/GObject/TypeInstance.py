...
class TypeInstance(__gi.Struct):
    ...
    g_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(TypeInstance), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'TypeInstance' objects>, '__weakref__': <attribute '__weakref__' of 'TypeInstance' objects>, '__doc__': None, 'g_class': <property object at 0x000001dd11e4acf0>, 'get_private': gi.FunctionInfo(get_private)})"
