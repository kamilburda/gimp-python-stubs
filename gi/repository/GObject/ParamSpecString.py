...
class ParamSpecString(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecString), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamString (252362752)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e4e1b0>, 'default_value': <property object at 0x000001dd11e4e2a0>, 'cset_first': <property object at 0x000001dd11e4e390>, 'cset_nth': <property object at 0x000001dd11e4e480>, 'substitutor': <property object at 0x000001dd11e4e570>, 'null_fold_if_empty': <property object at 0x000001dd11e4e660>, 'ensure_non_null': <property object at 0x000001dd11e4e750>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamString (252362752)>'
