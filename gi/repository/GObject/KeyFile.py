...
class KeyFile(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(KeyFile), '__module__': 'gi.repository.GObject', '__gtype__': <GType GKeyFile (265147552)>, '__dict__': <attribute '__dict__' of 'KeyFile' objects>, '__weakref__': <attribute '__weakref__' of 'KeyFile' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GKeyFile (265147552)>'
