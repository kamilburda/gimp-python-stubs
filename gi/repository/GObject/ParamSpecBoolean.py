...
class ParamSpecBoolean(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecBoolean), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamBoolean (259903472)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e5b380>, 'default_value': <property object at 0x000001dd11e5b470>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamBoolean (259903472)>'
    __info__ = ObjectInfo(ParamSpecBoolean)
