...
class Tree(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Tree), '__module__': 'gi.repository.GObject', '__gtype__': <GType GTree (265148896)>, '__dict__': <attribute '__dict__' of 'Tree' objects>, '__weakref__': <attribute '__weakref__' of 'Tree' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GTree (265148896)>'
