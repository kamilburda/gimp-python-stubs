...
class SignalQuery(__gi.Struct):
    ...
    itype = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    n_params = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    param_types = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    return_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    signal_flags = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    signal_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    signal_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SignalQuery), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SignalQuery' objects>, '__weakref__': <attribute '__weakref__' of 'SignalQuery' objects>, '__doc__': None, 'signal_id': <property object at 0x000001dd11e49170>, 'signal_name': <property object at 0x000001dd11e49260>, 'itype': <property object at 0x000001dd11e49350>, 'signal_flags': <property object at 0x000001dd11e49440>, 'return_type': <property object at 0x000001dd11e49530>, 'n_params': <property object at 0x000001dd11e49620>, 'param_types': <property object at 0x000001dd11e49710>})"
