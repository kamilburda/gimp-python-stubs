...
class ParamSpecGType(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    is_a_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecGType), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamGType (252362944)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e4cd10>, 'is_a_type': <property object at 0x000001dd11e4ce00>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamGType (252362944)>'
