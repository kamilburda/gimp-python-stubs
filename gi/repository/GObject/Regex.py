...
class Regex(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Regex), '__module__': 'gi.repository.GObject', '__gtype__': <GType GRegex (265150336)>, '__dict__': <attribute '__dict__' of 'Regex' objects>, '__weakref__': <attribute '__weakref__' of 'Regex' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GRegex (265150336)>'
