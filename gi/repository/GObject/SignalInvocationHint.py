...
class SignalInvocationHint(__gi.Struct):
    ...
    run_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    signal_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SignalInvocationHint), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SignalInvocationHint' objects>, '__weakref__': <attribute '__weakref__' of 'SignalInvocationHint' objects>, '__doc__': None, 'signal_id': <property object at 0x000001dd11e48e00>, 'detail': <property object at 0x000001dd11e48ef0>, 'run_type': <property object at 0x000001dd11e48fe0>})"
