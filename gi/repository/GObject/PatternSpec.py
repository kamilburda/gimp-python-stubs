...
class PatternSpec(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(PatternSpec), '__module__': 'gi.repository.GObject', '__gtype__': <GType GPatternSpec (265150240)>, '__dict__': <attribute '__dict__' of 'PatternSpec' objects>, '__weakref__': <attribute '__weakref__' of 'PatternSpec' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GPatternSpec (265150240)>'
