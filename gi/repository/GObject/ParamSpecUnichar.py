...
class ParamSpecUnichar(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecUnichar), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamUnichar (252364960)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e480e0>, 'default_value': <property object at 0x000001dd11e481d0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamUnichar (252364960)>'
    __info__ = ObjectInfo(ParamSpecUnichar)
