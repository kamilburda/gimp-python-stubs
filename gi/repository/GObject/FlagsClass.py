...
class FlagsClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(FlagsClass), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'FlagsClass' objects>, '__weakref__': <attribute '__weakref__' of 'FlagsClass' objects>, '__doc__': None, 'g_type_class': <property object at 0x000001dd11e584f0>, 'mask': <property object at 0x000001dd11e585e0>, 'n_values': <property object at 0x000001dd11e586d0>, 'values': <property object at 0x000001dd11e587c0>})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(FlagsClass)
