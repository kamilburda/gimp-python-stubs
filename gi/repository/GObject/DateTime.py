...
class DateTime(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(DateTime), '__module__': 'gi.repository.GObject', '__gtype__': <GType GDateTime (265149088)>, '__dict__': <attribute '__dict__' of 'DateTime' objects>, '__weakref__': <attribute '__weakref__' of 'DateTime' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GDateTime (265149088)>'
