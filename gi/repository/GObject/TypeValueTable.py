...
class TypeValueTable(__gi.Struct):
    ...
    collect_format = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    collect_value = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    lcopy_format = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    lcopy_value = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    value_copy = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    value_free = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    value_init = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    value_peek_pointer = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(TypeValueTable), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'TypeValueTable' objects>, '__weakref__': <attribute '__weakref__' of 'TypeValueTable' objects>, '__doc__': None, 'value_init': <property object at 0x000001dd11e38630>, 'value_free': <property object at 0x000001dd11e38720>, 'value_copy': <property object at 0x000001dd11e38810>, 'value_peek_pointer': <property object at 0x000001dd11e38900>, 'collect_format': <property object at 0x000001dd11e389f0>, 'collect_value': <property object at 0x000001dd11e38ae0>, 'lcopy_format': <property object at 0x000001dd11e38bd0>, 'lcopy_value': <property object at 0x000001dd11e38cc0>})"
