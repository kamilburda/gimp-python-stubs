...
class ParamSpecUInt(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecUInt), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamUInt (259903568)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e4f470>, 'minimum': <property object at 0x000001dd11e4f560>, 'maximum': <property object at 0x000001dd11e4f650>, 'default_value': <property object at 0x000001dd11e4f740>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamUInt (259903568)>'
    __info__ = ObjectInfo(ParamSpecUInt)
