...
class Hmac(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Hmac), '__module__': 'gi.repository.GObject', '__gtype__': <GType GHmac (265146784)>, '__dict__': <attribute '__dict__' of 'Hmac' objects>, '__weakref__': <attribute '__weakref__' of 'Hmac' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GHmac (265146784)>'
