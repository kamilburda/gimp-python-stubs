...
class SignalMatchType(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'ID': <SignalMatchType.ID: 1>, 'DETAIL': <SignalMatchType.DETAIL: 2>, 'CLOSURE': <SignalMatchType.CLOSURE: 4>, 'FUNC': <SignalMatchType.FUNC: 8>, 'DATA': <SignalMatchType.DATA: 16>, 'UNBLOCKED': <SignalMatchType.UNBLOCKED: 32>})"
    __name__ = 'SignalMatchType'
    __qualname__ = 'SignalMatchType'
