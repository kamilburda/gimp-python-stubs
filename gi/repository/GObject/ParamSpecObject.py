...
class ParamSpecObject(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecObject), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamObject (252361984)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e4db70>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamObject (252361984)>'
    __info__ = ObjectInfo(ParamSpecObject)
