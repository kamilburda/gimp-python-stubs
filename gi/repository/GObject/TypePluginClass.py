...
class TypePluginClass(__gi.Struct):
    ...
    complete_interface_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    complete_type_info = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    unuse_plugin = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    use_plugin = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(TypePluginClass), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'TypePluginClass' objects>, '__weakref__': <attribute '__weakref__' of 'TypePluginClass' objects>, '__doc__': None, 'base_iface': <property object at 0x000001dd11e4bd30>, 'use_plugin': <property object at 0x000001dd11e4be20>, 'unuse_plugin': <property object at 0x000001dd11e4bf10>, 'complete_type_info': <property object at 0x000001dd11e38040>, 'complete_interface_info': <property object at 0x000001dd11e38130>})"
