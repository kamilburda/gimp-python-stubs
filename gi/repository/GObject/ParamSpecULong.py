...
class ParamSpecULong(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecULong), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamULong (259904624)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e4fc90>, 'minimum': <property object at 0x000001dd11e4fd80>, 'maximum': <property object at 0x000001dd11e4fe70>, 'default_value': <property object at 0x000001dd11e4ff60>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamULong (259904624)>'
    __info__ = ObjectInfo(ParamSpecULong)
