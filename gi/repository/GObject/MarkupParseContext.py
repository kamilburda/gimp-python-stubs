...
class MarkupParseContext(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(MarkupParseContext), '__module__': 'gi.repository.GObject', '__gtype__': <GType GMarkupParseContext (265149664)>, '__dict__': <attribute '__dict__' of 'MarkupParseContext' objects>, '__weakref__': <attribute '__weakref__' of 'MarkupParseContext' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GMarkupParseContext (265149664)>'
