...
class ConnectFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <ConnectFlags.DEFAULT: 0>, 'AFTER': <ConnectFlags.AFTER: 1>, 'SWAPPED': <ConnectFlags.SWAPPED: 2>})"
    __name__ = 'ConnectFlags'
    __qualname__ = 'ConnectFlags'
