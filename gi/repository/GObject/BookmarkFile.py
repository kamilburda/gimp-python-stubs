...
class BookmarkFile(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(BookmarkFile), '__module__': 'gi.repository.GObject', '__gtype__': <GType GBookmarkFile (265149952)>, '__dict__': <attribute '__dict__' of 'BookmarkFile' objects>, '__weakref__': <attribute '__weakref__' of 'BookmarkFile' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GBookmarkFile (265149952)>'
