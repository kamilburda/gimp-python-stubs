...
class TimeZone(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(TimeZone), '__module__': 'gi.repository.GObject', '__gtype__': <GType GTimeZone (265149568)>, '__dict__': <attribute '__dict__' of 'TimeZone' objects>, '__weakref__': <attribute '__weakref__' of 'TimeZone' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GTimeZone (265149568)>'
