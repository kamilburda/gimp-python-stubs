...
class PtrArray(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(PtrArray), '__module__': 'gi.repository.GObject', '__gtype__': <GType GPtrArray (265148032)>, '__dict__': <attribute '__dict__' of 'PtrArray' objects>, '__weakref__': <attribute '__weakref__' of 'PtrArray' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GPtrArray (265148032)>'
