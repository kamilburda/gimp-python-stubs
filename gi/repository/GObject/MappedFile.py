...
class MappedFile(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(MappedFile), '__module__': 'gi.repository.GObject', '__gtype__': <GType GMappedFile (265149472)>, '__dict__': <attribute '__dict__' of 'MappedFile' objects>, '__weakref__': <attribute '__weakref__' of 'MappedFile' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GMappedFile (265149472)>'
