...
class VariantDict(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(VariantDict), '__module__': 'gi.repository.GObject', '__gtype__': <GType GVariantDict (265148320)>, '__dict__': <attribute '__dict__' of 'VariantDict' objects>, '__weakref__': <attribute '__weakref__' of 'VariantDict' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GVariantDict (265148320)>'
