...
class ParamFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'READABLE': <ParamFlags.READABLE: 1>, 'WRITABLE': <ParamFlags.WRITABLE: 2>, 'READWRITE': <ParamFlags.READWRITE: 3>, 'CONSTRUCT': <ParamFlags.CONSTRUCT: 4>, 'CONSTRUCT_ONLY': <ParamFlags.CONSTRUCT_ONLY: 8>, 'LAX_VALIDATION': <ParamFlags.LAX_VALIDATION: 16>, 'STATIC_NAME': <ParamFlags.STATIC_NAME: 32>, 'PRIVATE': <ParamFlags.STATIC_NAME: 32>, 'STATIC_NICK': <ParamFlags.STATIC_NICK: 64>, 'STATIC_BLURB': <ParamFlags.STATIC_BLURB: 128>, 'EXPLICIT_NOTIFY': <ParamFlags.EXPLICIT_NOTIFY: 1073741824>, 'DEPRECATED': <ParamFlags.DEPRECATED: 2147483648>})"
    __name__ = 'ParamFlags'
    __qualname__ = 'ParamFlags'
