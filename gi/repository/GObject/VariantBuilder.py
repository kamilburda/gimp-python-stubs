...
class VariantBuilder(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(VariantBuilder), '__module__': 'gi.repository.GObject', '__gtype__': <GType GVariantBuilder (265149184)>, '__dict__': <attribute '__dict__' of 'VariantBuilder' objects>, '__weakref__': <attribute '__weakref__' of 'VariantBuilder' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GVariantBuilder (265149184)>'
