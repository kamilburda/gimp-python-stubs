...
class InterfaceInfo(__gi.Struct):
    ...
    interface_data = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    interface_finalize = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    interface_init = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
