...
class ParamSpecPool(__gi.Struct):
    ...
    def insert(self, pspec, owner_type): # real signature unknown; restored from __doc__
        """ insert(self, pspec:GObject.ParamSpec, owner_type:GType) """
        pass

    def list(self, owner_type): # real signature unknown; restored from __doc__
        """ list(self, owner_type:GType) -> list """
        return []

    def list_owned(self, owner_type): # real signature unknown; restored from __doc__
        """ list_owned(self, owner_type:GType) -> list """
        return []

    def lookup(self, param_name, owner_type, walk_ancestors): # real signature unknown; restored from __doc__
        """ lookup(self, param_name:str, owner_type:GType, walk_ancestors:bool) -> GObject.ParamSpec or None """
        pass

    def remove(self, pspec): # real signature unknown; restored from __doc__
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ParamSpecPool), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ParamSpecPool' objects>, '__weakref__': <attribute '__weakref__' of 'ParamSpecPool' objects>, '__doc__': None, 'free': gi.FunctionInfo(free), 'insert': gi.FunctionInfo(insert), 'list': gi.FunctionInfo(list), 'list_owned': gi.FunctionInfo(list_owned), 'lookup': gi.FunctionInfo(lookup), 'remove': gi.FunctionInfo(remove)})"
    __gtype__ = None # (!) real value is '<GType void (4)>'
    __info__ = StructInfo(ParamSpecPool)
