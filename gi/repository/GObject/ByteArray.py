...
class ByteArray(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ByteArray), '__module__': 'gi.repository.GObject', '__gtype__': <GType GByteArray (265147360)>, '__dict__': <attribute '__dict__' of 'ByteArray' objects>, '__weakref__': <attribute '__weakref__' of 'ByteArray' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GByteArray (265147360)>'
