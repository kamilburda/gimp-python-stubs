...
class Bytes(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Bytes), '__module__': 'gi.repository.GObject', '__gtype__': <GType GBytes (265149376)>, '__dict__': <attribute '__dict__' of 'Bytes' objects>, '__weakref__': <attribute '__weakref__' of 'Bytes' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GBytes (265149376)>'
