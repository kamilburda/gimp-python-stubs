...
class String(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(String), '__module__': 'gi.repository.GObject', '__gtype__': <GType GString (255840976)>, '__dict__': <attribute '__dict__' of 'String' objects>, '__weakref__': <attribute '__weakref__' of 'String' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GString (255840976)>'
