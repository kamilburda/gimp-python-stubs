...
class MatchInfo(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(MatchInfo), '__module__': 'gi.repository.GObject', '__gtype__': <GType GMatchInfo (265147264)>, '__dict__': <attribute '__dict__' of 'MatchInfo' objects>, '__weakref__': <attribute '__weakref__' of 'MatchInfo' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GMatchInfo (265147264)>'
