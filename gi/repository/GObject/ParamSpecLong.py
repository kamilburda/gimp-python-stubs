...
class ParamSpecLong(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecLong), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamLong (259904336)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e4d760>, 'minimum': <property object at 0x000001dd11e4d850>, 'maximum': <property object at 0x000001dd11e4d940>, 'default_value': <property object at 0x000001dd11e4da30>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamLong (259904336)>'
    __info__ = ObjectInfo(ParamSpecLong)
