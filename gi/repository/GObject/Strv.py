...
class Strv(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Strv), '__module__': 'gi.repository.GObject', '__gtype__': <GType GStrv (255842032)>, '__dict__': <attribute '__dict__' of 'Strv' objects>, '__weakref__': <attribute '__weakref__' of 'Strv' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GStrv (255842032)>'
    __info__ = StructInfo(Strv)
