...
class Array(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Array), '__module__': 'gi.repository.GObject', '__gtype__': <GType GArray (265150048)>, '__dict__': <attribute '__dict__' of 'Array' objects>, '__weakref__': <attribute '__weakref__' of 'Array' objects>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GArray (265150048)>'
