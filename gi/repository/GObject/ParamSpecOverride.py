...
class ParamSpecOverride(__gi_overrides_GObject.ParamSpec):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecOverride), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamOverride (252364672)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x000001dd11e4dcb0>, 'overridden': <property object at 0x000001dd11e4dda0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamOverride (252364672)>'
