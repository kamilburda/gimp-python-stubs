...
class BrushChooser(ResourceChooser):
    ...
    @classmethod
    def new(cls, title=None, label=None, brush=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, brush:Gimp.Brush=None) -> Gtk.Widget """
        pass
