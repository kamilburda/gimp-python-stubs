...
class ChainButton(__gi_repository_Gtk.Grid):
    ...
    @classmethod
    def new(cls, position): # real signature unknown; restored from __doc__
        """ new(position:GimpUi.ChainPosition) -> Gtk.Widget """
        pass
    ...
    def set_icon_size(self, size): # real signature unknown; restored from __doc__
