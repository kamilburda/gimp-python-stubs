...
class ColorArea(__gi_repository_Gtk.DrawingArea):
    ...
    def enable_drag(self, drag_mask): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, color, type, drag_mask): # real signature unknown; restored from __doc__
        """ new(color:Gegl.Color, type:GimpUi.ColorAreaType, drag_mask:Gdk.ModifierType) -> Gtk.Widget """
        pass
    ...
    def set_draw_border(self, draw_border): # real signature unknown; restored from __doc__
    ...
    def set_out_of_gamut(self, out_of_gamut): # real signature unknown; restored from __doc__
