...
class ProcedureDialogClass(__gi.Struct):
    ...
    fill_end = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fill_list = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fill_start = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
