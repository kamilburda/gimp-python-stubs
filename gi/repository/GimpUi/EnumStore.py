...
class EnumStore(IntStore):
    ...
    def append(self, row=None): # reliably restored by inspect
        # no doc
        pass
    ...
    def insert(self, position, row=None): # reliably restored by inspect
        # no doc
        pass

    def insert_after(self, sibling, row=None): # reliably restored by inspect
        # no doc
        pass

    def insert_before(self, sibling, row=None): # reliably restored by inspect
        # no doc
        pass

    def insert_with_values(self, *args, **kwargs): # real signature unknown
        """ insert_with_valuesv(self, position:int, columns:list, values:list) -> iter:Gtk.TreeIter """
        pass

    def insert_with_valuesv(self, position, columns, values): # real signature unknown; restored from __doc__
        """ insert_with_valuesv(self, position:int, columns:list, values:list) -> iter:Gtk.TreeIter """
        pass
    ...
    def lookup_by_user_data(self, model, user_data=None): # real signature unknown; restored from __doc__
        """ lookup_by_user_data(model:Gtk.TreeModel, user_data=None) -> bool, iter:Gtk.TreeIter """
        return False

    def lookup_by_value(self, model, value): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new_with_range(cls, enum_type, minimum, maximum): # real signature unknown; restored from __doc__
        """ new_with_range(enum_type:GType, minimum:int, maximum:int) -> Gtk.ListStore """
        pass
    ...
    def prepend(self, row=None): # reliably restored by inspect
        # no doc
        pass
    ...
    def reorder(self, new_order): # real signature unknown; restored from __doc__
