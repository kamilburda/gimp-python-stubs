...
class UnitComboBox(__gi_overrides_Gtk.ComboBox):
    ...
    @classmethod
    def new_with_model(cls, model): # real signature unknown; restored from __doc__
        """ new_with_model(model:GimpUi.UnitStore) -> Gtk.Widget """
        pass
    ...
    def set_active(self, unit): # real signature unknown; restored from __doc__
