...
class BusyBox(__gi_overrides_Gtk.Box):
    ...
    @classmethod
    def new(cls, message=None): # real signature unknown; restored from __doc__
        """ new(message:str=None) -> Gtk.Widget """
        pass
