...
class ColorProfileChooserDialog(__gi_overrides_Gtk.FileChooserDialog):
    ...
    @classmethod
    def new(cls, title, parent, action): # real signature unknown; restored from __doc__
        """ new(title:str, parent:Gtk.Window, action:Gtk.FileChooserAction) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000020ee021e2f0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
