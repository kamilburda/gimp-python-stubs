...
class NumberPairEntry(__gi_repository_Gtk.Entry):
    ...
    def get_aspect(self): # real signature unknown; restored from __doc__
    ...
    def get_default_text(self): # real signature unknown; restored from __doc__
        """ get_default_text(self) -> str or None """
        return ""

    def get_default_values(self): # real signature unknown; restored from __doc__
    ...
    def get_ratio(self): # real signature unknown; restored from __doc__
    ...
    def get_user_override(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, separators, allow_simplification, min_valid_value, max_valid_value): # real signature unknown; restored from __doc__
        """ new(separators:str, allow_simplification:bool, min_valid_value:float, max_valid_value:float) -> Gtk.Widget """
        pass
    ...
    def set_aspect(self, aspect): # real signature unknown; restored from __doc__
    ...
    def set_default_text(self, string): # real signature unknown; restored from __doc__
        """ set_default_text(self, string:str) """
        pass

    def set_default_values(self, left, right): # real signature unknown; restored from __doc__
    ...
    def set_ratio(self, ratio): # real signature unknown; restored from __doc__
    ...
    def set_user_override(self, user_override): # real signature unknown; restored from __doc__
    ...
    def set_values(self, left, right): # real signature unknown; restored from __doc__
