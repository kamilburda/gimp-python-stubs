...
class ExportProcedureDialog(ProcedureDialog):
    ...
    def add_metadata(self, property): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, procedure, config, image): # real signature unknown; restored from __doc__
        """ new(procedure:Gimp.ExportProcedure, config:Gimp.ProcedureConfig, image:Gimp.Image) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000020ee01fdcc0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
