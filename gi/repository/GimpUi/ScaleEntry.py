...
class ScaleEntry(LabelSpin):
    ...
    def do_mnemonic_widget_changed(self, *args, **kwargs): # real signature unknown
    ...
    def get_logarithmic(self): # real signature unknown; restored from __doc__
    ...
    def get_spin_button(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, text, value, lower, upper, digits): # real signature unknown; restored from __doc__
        """ new(text:str, value:float, lower:float, upper:float, digits:int) -> Gtk.Widget """
        pass
    ...
    def set_bounds(self, lower, upper, limit_scale): # real signature unknown; restored from __doc__
    ...
    def set_logarithmic(self, logarithmic): # real signature unknown; restored from __doc__
