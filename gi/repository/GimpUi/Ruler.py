...
class Ruler(__gi_overrides_Gtk.Widget):
    ...
    def add_track_widget(self, widget): # real signature unknown; restored from __doc__
    ...
    def remove_track_widget(self, widget): # real signature unknown; restored from __doc__
    ...
    def set_range(self, lower, upper, max_size): # real signature unknown; restored from __doc__
