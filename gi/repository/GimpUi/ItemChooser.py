...
class ItemChooser(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        ItemChooser(**properties)
    ...
    @classmethod
    def new(cls, title=None, label=None, item_type, item=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, item_type:GType, item:Gimp.Item=None) -> Gtk.Widget """
        pass
