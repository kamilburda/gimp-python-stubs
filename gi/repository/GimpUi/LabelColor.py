...
class LabelColor(Labeled):
    ...
    def get_color_widget(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, label, color, editable): # real signature unknown; restored from __doc__
        """ new(label:str, color:Gegl.Color, editable:bool) -> Gtk.Widget """
        pass
    ...
    def set_editable(self, editable): # real signature unknown; restored from __doc__
