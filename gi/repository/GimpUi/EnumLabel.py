...
class EnumLabel(__gi_overrides_Gtk.Label):
    ...
    @classmethod
    def new(cls, enum_type, value): # real signature unknown; restored from __doc__
        """ new(enum_type:GType, value:int) -> Gtk.Widget """
        pass
