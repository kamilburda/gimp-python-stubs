...
class MemsizeEntry(__gi_overrides_Gtk.Box):
    ...
    def get_spinbutton(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, value, lower, upper): # real signature unknown; restored from __doc__
        """ new(value:int, lower:int, upper:int) -> Gtk.Widget """
        pass
