...
class ColorProfileComboBox(__gi_overrides_Gtk.ComboBox):
    ...
    def add_file(self, file, label): # real signature unknown; restored from __doc__
    ...
    def get_active_file(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, dialog, history): # real signature unknown; restored from __doc__
        """ new(dialog:Gtk.Widget, history:Gio.File) -> Gtk.Widget """
        pass
    ...
    @classmethod
    def new_with_model(cls, dialog, model): # real signature unknown; restored from __doc__
        """ new_with_model(dialog:Gtk.Widget, model:Gtk.TreeModel) -> Gtk.Widget """
        pass
    ...
    def set_active_file(self, file, label): # real signature unknown; restored from __doc__
    ...
    def set_active_profile(self, profile): # real signature unknown; restored from __doc__
