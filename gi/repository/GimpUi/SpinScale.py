...
class SpinScale(SpinButton):
    ...
    def get_constrain_drag(self): # real signature unknown; restored from __doc__
    ...
    def get_mnemonic_keyval(self): # real signature unknown; restored from __doc__
    ...
    def get_scale_limits(self, lower, upper): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, adjustment, label, digits): # real signature unknown; restored from __doc__
        """ new(adjustment:Gtk.Adjustment, label:str, digits:int) -> Gtk.Widget """
        pass
    ...
    def new_with_range(self, min, max, step): # real signature unknown; restored from __doc__
    ...
    def set_constrain_drag(self, constrain): # real signature unknown; restored from __doc__
    ...
    def set_gamma(self, gamma): # real signature unknown; restored from __doc__
    ...
    def set_scale_limits(self, lower, upper): # real signature unknown; restored from __doc__
    ...
    def unset_scale_limits(self): # real signature unknown; restored from __doc__
