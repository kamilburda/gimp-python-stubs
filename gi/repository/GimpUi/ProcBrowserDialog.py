...
class ProcBrowserDialog(Dialog):
    ...
    def get_selected(self): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000020ee1cebdf0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
