...
class LabelStringWidget(Labeled):
    ...
    @classmethod
    def new(cls, text, widget): # real signature unknown; restored from __doc__
        """ new(text:str, widget:Gtk.Widget) -> Gtk.Widget """
        pass
