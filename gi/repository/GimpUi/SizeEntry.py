...
class SizeEntry(__gi_repository_Gtk.Grid):
    ...
    def add_field(self, value_spinbutton, refval_spinbutton=None): # real signature unknown; restored from __doc__
    ...
    def attach_label(self, text, row, column, alignment): # real signature unknown; restored from __doc__
    ...
    def get_help_widget(self, field): # real signature unknown; restored from __doc__
    ...
    def get_n_fields(self): # real signature unknown; restored from __doc__
    ...
    def get_refval(self, field): # real signature unknown; restored from __doc__
    ...
    def get_unit_combo(self): # real signature unknown; restored from __doc__
    ...
    def get_value(self, field): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, number_of_fields, unit, unit_format, menu_show_pixels, menu_show_percent, show_refval, spinbutton_width, update_policy): # real signature unknown; restored from __doc__
        """ new(number_of_fields:int, unit:Gimp.Unit, unit_format:str, menu_show_pixels:bool, menu_show_percent:bool, show_refval:bool, spinbutton_width:int, update_policy:GimpUi.SizeEntryUpdatePolicy) -> Gtk.Widget """
        pass
    ...
    def set_pixel_digits(self, digits): # real signature unknown; restored from __doc__
    ...
    def set_refval(self, field, refval): # real signature unknown; restored from __doc__
        """ set_refval(self, field:int, refval:float) """
        pass

    def set_refval_boundaries(self, field, lower, upper): # real signature unknown; restored from __doc__
        """ set_refval_boundaries(self, field:int, lower:float, upper:float) """
        pass

    def set_refval_digits(self, field, digits): # real signature unknown; restored from __doc__
    ...
    def set_resolution(self, field, resolution, keep_size): # real signature unknown; restored from __doc__
    ...
    def set_size(self, field, lower, upper): # real signature unknown; restored from __doc__
    ...
    def set_value_boundaries(self, field, lower, upper): # real signature unknown; restored from __doc__
    ...
    def show_unit_menu(self, show): # real signature unknown; restored from __doc__
