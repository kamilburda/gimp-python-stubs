...
class ResourceChooser(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def do_draw_interior(self, *args, **kwargs): # real signature unknown
        """ draw_interior(self) """
        pass
    ...
    def do_resource_set(self, *args, **kwargs): # real signature unknown
    ...
    def get_resource(self): # real signature unknown; restored from __doc__
    ...
    def set_resource(self, resource): # real signature unknown; restored from __doc__
