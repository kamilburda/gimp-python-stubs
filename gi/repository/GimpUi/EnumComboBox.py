...
class EnumComboBox(IntComboBox):
    ...
    @classmethod
    def new(cls, enum_type): # real signature unknown; restored from __doc__
        """ new(enum_type:GType) -> Gtk.Widget """
        pass
    ...
    @classmethod
    def new_with_model(cls, enum_store): # real signature unknown; restored from __doc__
        """ new_with_model(enum_store:GimpUi.EnumStore) -> Gtk.Widget """
        pass
    ...
    def set_icon_prefix(self, icon_prefix): # real signature unknown; restored from __doc__
