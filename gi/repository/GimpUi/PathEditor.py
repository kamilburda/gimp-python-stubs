...
class PathEditor(__gi_overrides_Gtk.Box):
    ...
    def get_dir_writable(self, directory): # real signature unknown; restored from __doc__
    ...
    def get_writable_path(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, title, path=None): # real signature unknown; restored from __doc__
        """ new(title:str, path:str=None) -> Gtk.Widget """
        pass
    ...
    def set_dir_writable(self, directory, writable): # real signature unknown; restored from __doc__
    ...
    def set_writable_path(self, path): # real signature unknown; restored from __doc__
