...
class DrawableChooser(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    @classmethod
    def new(cls, title=None, label=None, drawable_type, drawable=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, drawable_type:GType, drawable:Gimp.Drawable=None) -> Gtk.Widget """
        pass
    ...
    def set_drawable(self, drawable): # real signature unknown; restored from __doc__
