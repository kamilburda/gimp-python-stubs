...
class FileChooser(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    @classmethod
    def new(cls, action, label=None, title=None, file=None): # real signature unknown; restored from __doc__
        """ new(action:Gimp.FileChooserAction, label:str=None, title:str=None, file:Gio.File=None) -> Gtk.Widget """
        pass
    ...
    def set_label(self, text=None): # real signature unknown; restored from __doc__
    ...
    def set_title(self, text=None): # real signature unknown; restored from __doc__
