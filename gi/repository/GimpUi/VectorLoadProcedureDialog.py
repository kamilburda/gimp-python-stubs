...
class VectorLoadProcedureDialog(ProcedureDialog):
    ...
    @classmethod
    def new(cls, procedure, config, extracted_data=None, file=None): # real signature unknown; restored from __doc__
        """ new(procedure:Gimp.VectorLoadProcedure, config:Gimp.ProcedureConfig, extracted_data:Gimp.VectorLoadData=None, file:Gio.File=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000020ee021e260>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
