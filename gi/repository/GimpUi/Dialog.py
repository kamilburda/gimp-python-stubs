...
class Dialog(__gi_overrides_Gtk.Dialog):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000020ee0176350>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
