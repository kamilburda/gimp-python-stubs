...
class PageSelector(__gi_overrides_Gtk.Box):
    ...
    def get_page_label(self, page_no): # real signature unknown; restored from __doc__
        """ get_page_label(self, page_no:int) -> str or None """
        return ""

    def get_page_thumbnail(self, page_no): # real signature unknown; restored from __doc__
    ...
    def get_selected_pages(self): # real signature unknown; restored from __doc__
        """ get_selected_pages(self) -> list """
        return []

    def get_selected_range(self): # real signature unknown; restored from __doc__
    ...
    def page_is_selected(self, page_no): # real signature unknown; restored from __doc__
    ...
    def select_page(self, page_no): # real signature unknown; restored from __doc__
        """ select_page(self, page_no:int) """
        pass

    def select_range(self, range): # real signature unknown; restored from __doc__
    ...
    def set_page_label(self, page_no, label): # real signature unknown; restored from __doc__
        """ set_page_label(self, page_no:int, label:str) """
        pass

    def set_page_thumbnail(self, page_no, thumbnail): # real signature unknown; restored from __doc__
    ...
    def unselect_page(self, page_no): # real signature unknown; restored from __doc__
