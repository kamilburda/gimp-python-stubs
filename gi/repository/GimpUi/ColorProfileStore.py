...
class ColorProfileStore(__gi_overrides_Gtk.ListStore):
    ...
    @classmethod
    def new(cls, history): # real signature unknown; restored from __doc__
        """ new(history:Gio.File) -> Gtk.ListStore """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000020ee0177730>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorProfileStore), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorProfileStore (3719889344)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'add_file': gi.FunctionInfo(add_file)})"
    __firstlineno__ = 1074
    __gdoc__ = 'Object GimpColorProfileStore\n\nProperties from GimpColorProfileStore:\n  history -> GFile: History\n    Filen of the color history used to populate the profile store\n\nSignals from GtkTreeModel:\n  row-changed (GtkTreePath, GtkTreeIter)\n  row-inserted (GtkTreePath, GtkTreeIter)\n  row-has-child-toggled (GtkTreePath, GtkTreeIter)\n  row-deleted (GtkTreePath)\n  rows-reordered (GtkTreePath, GtkTreeIter, gpointer)\n\nSignals from GtkTreeSortable:\n  sort-column-changed ()\n\nSignals from GtkTreeModel:\n  row-changed (GtkTreePath, GtkTreeIter)\n  row-inserted (GtkTreePath, GtkTreeIter)\n  row-has-child-toggled (GtkTreePath, GtkTreeIter)\n  row-deleted (GtkTreePath)\n  rows-reordered (GtkTreePath, GtkTreeIter, gpointer)\n\nSignals from GtkTreeSortable:\n  sort-column-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorProfileStore (3719889344)>'
    __info__ = ObjectInfo(ColorProfileStore)
