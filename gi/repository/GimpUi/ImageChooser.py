...
class ImageChooser(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        ImageChooser(**properties)
    ...
    @classmethod
    def new(cls, title=None, label=None, image=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, image:Gimp.Image=None) -> Gtk.Widget """
        pass
