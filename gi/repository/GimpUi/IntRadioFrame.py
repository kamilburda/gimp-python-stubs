...
class IntRadioFrame(Frame):
    ...
    def do_compute_child_allocation(self, *args, **kwargs): # real signature unknown
    ...
    def get_label_align(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new_from_store(cls, title, store): # real signature unknown; restored from __doc__
        """ new_from_store(title:str, store:GimpUi.IntStore) -> Gtk.Widget """
        pass
    ...
    def set_label_align(self, xalign, yalign): # real signature unknown; restored from __doc__
    ...
    def set_title(self, title, with_mnemonic): # real signature unknown; restored from __doc__
