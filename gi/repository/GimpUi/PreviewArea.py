...
class PreviewArea(__gi_repository_Gtk.DrawingArea):
    ...
    def blend(self, x, y, width, height, type, buf1, rowstride1, buf2, rowstride2, opacity): # real signature unknown; restored from __doc__
    ...
    def draw(self, x, y, width, height, type, buf, rowstride): # real signature unknown; restored from __doc__
    ...
    def fill(self, x, y, width, height, red, green, blue): # real signature unknown; restored from __doc__
    ...
    def mask(self, x, y, width, height, type, buf1, rowstride1, buf2, rowstride2, mask, rowstride_mask): # real signature unknown; restored from __doc__
    ...
    def menu_popup(self, event=None): # real signature unknown; restored from __doc__
    ...
    def set_colormap(self, colormap, num_colors): # real signature unknown; restored from __doc__
    ...
    def set_max_size(self, width, height): # real signature unknown; restored from __doc__
    ...
    def set_offsets(self, x, y): # real signature unknown; restored from __doc__
