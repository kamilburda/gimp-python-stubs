...
class OffsetArea(__gi_repository_Gtk.DrawingArea):
    ...
    @classmethod
    def new(cls, orig_width, orig_height): # real signature unknown; restored from __doc__
        """ new(orig_width:int, orig_height:int) -> Gtk.Widget """
        pass
    ...
    def set_offsets(self, offset_x, offset_y): # real signature unknown; restored from __doc__
