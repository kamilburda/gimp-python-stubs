...
class ZoomPreview(ScrolledPreview):
    ...
    def get_adjustments(self): # real signature unknown; restored from __doc__
    ...
    def get_drawable(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new_from_drawable(cls, drawable): # real signature unknown; restored from __doc__
        """ new_from_drawable(drawable:Gimp.Drawable) -> Gtk.Widget """
        pass

    @classmethod
    def new_with_model_from_drawable(cls, drawable, model): # real signature unknown; restored from __doc__
        """ new_with_model_from_drawable(drawable:Gimp.Drawable, model:GimpUi.ZoomModel) -> Gtk.Widget """
        pass
