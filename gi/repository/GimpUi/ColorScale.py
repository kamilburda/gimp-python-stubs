...
class ColorScale(__gi_repository_Gtk.Scale):
    """
    :Constructors:
    ...
    @classmethod
    def new(cls, orientation, channel): # real signature unknown; restored from __doc__
        """ new(orientation:Gtk.Orientation, channel:GimpUi.ColorSelectorChannel) -> Gtk.Widget """
        pass
    ...
    def new_with_range(self, orientation, min, max, step): # real signature unknown; restored from __doc__
    ...
    def set_channel(self, channel): # real signature unknown; restored from __doc__
    ...
    def set_color_config(self, config): # real signature unknown; restored from __doc__
