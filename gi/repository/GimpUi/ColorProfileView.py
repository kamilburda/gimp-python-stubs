...
class ColorProfileView(__gi_repository_Gtk.TextView):
    ...
    def set_error(self, message): # real signature unknown; restored from __doc__
    ...
    def set_profile(self, profile): # real signature unknown; restored from __doc__
