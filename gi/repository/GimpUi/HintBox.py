...
class HintBox(__gi_overrides_Gtk.Box):
    ...
    @classmethod
    def new(cls, hint): # real signature unknown; restored from __doc__
        """ new(hint:str) -> Gtk.Widget """
        pass
