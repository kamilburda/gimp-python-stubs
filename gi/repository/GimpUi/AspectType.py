...
class AspectType(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'SQUARE': <AspectType.SQUARE: 0>, 'PORTRAIT': <AspectType.PORTRAIT: 1>, 'LANDSCAPE': <AspectType.LANDSCAPE: 2>})"
    __name__ = 'AspectType'
    __qualname__ = 'AspectType'
