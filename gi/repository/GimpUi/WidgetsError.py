...
class WidgetsError(__enum.IntEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'WIDGETS_PARSE_ERROR': <WidgetsError.WIDGETS_PARSE_ERROR: 0>})"
    __name__ = 'WidgetsError'
    __qualname__ = 'WidgetsError'
