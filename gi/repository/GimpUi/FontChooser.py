...
class FontChooser(ResourceChooser):
    ...
    @classmethod
    def new(cls, title=None, label=None, font=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, font:Gimp.Font=None) -> Gtk.Widget """
        pass
