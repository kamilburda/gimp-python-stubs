...
class ColorSelection(__gi_overrides_Gtk.Box):
    ...
    def color_changed(self): # real signature unknown; restored from __doc__
        """ color_changed(self) """
        pass
    ...
    def get_old_color(self): # real signature unknown; restored from __doc__
    ...
    def set_old_color(self, color): # real signature unknown; restored from __doc__
