...
class Preview(__gi_overrides_Gtk.Box):
    ...
    def do_draw_buffer(self, *args, **kwargs): # real signature unknown
        """ draw_buffer(self, buffer:list, rowstride:int) """
        pass

    def do_draw_thumb(self, *args, **kwargs): # real signature unknown
    ...
    def do_invalidated(self, *args, **kwargs): # real signature unknown
        """ invalidated(self) """
        pass
    ...
    def do_set_cursor(self, *args, **kwargs): # real signature unknown
        """ set_cursor(self) """
        pass
    ...
    def do_untransform(self, *args, **kwargs): # real signature unknown
    ...
    def draw_buffer(self, buffer, rowstride): # real signature unknown; restored from __doc__
        """ draw_buffer(self, buffer:list, rowstride:int) """
        pass
    ...
    def get_default_cursor(self): # real signature unknown; restored from __doc__
    ...
    def get_grid(self): # real signature unknown; restored from __doc__
    ...
    def get_update(self): # real signature unknown; restored from __doc__
    ...
    def set_bounds(self, xmin, ymin, xmax, ymax): # real signature unknown; restored from __doc__
    ...
    def set_default_cursor(self, cursor): # real signature unknown; restored from __doc__
    ...
    def set_offsets(self, xoff, yoff): # real signature unknown; restored from __doc__
    ...
    def set_update(self, update): # real signature unknown; restored from __doc__
    ...
    def transform(self, src_x, src_y): # real signature unknown; restored from __doc__
        """ transform(self, src_x:int, src_y:int) -> dest_x:int, dest_y:int """
        pass
    ...
    def untransform(self, src_x, src_y): # real signature unknown; restored from __doc__
        """ untransform(self, src_x:int, src_y:int) -> dest_x:int, dest_y:int """
        pass
