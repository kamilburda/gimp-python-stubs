...
class GradientChooser(ResourceChooser):
    ...
    @classmethod
    def new(cls, title=None, label=None, gradient=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, gradient:Gimp.Gradient=None) -> Gtk.Widget """
        pass
