...
class StringComboBox(__gi_overrides_Gtk.ComboBox):
    ...
    @classmethod
    def new(cls, model, id_column, label_column): # real signature unknown; restored from __doc__
        """ new(model:Gtk.TreeModel, id_column:int, label_column:int) -> Gtk.Widget """
        pass
    ...
    def set_active(self, id): # real signature unknown; restored from __doc__
