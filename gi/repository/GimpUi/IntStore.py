...
class IntStore(__gi_overrides_Gtk.ListStore):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000020ee1ce3640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IntStore), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpIntStore (3708066224)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'lookup_by_user_data': <staticmethod(gi.FunctionInfo(lookup_by_user_data))>, 'lookup_by_value': <staticmethod(gi.FunctionInfo(lookup_by_value))>, 'parent_instance': <property object at 0x0000020ee1d27600>})"
    __firstlineno__ = 1074
    __gdoc__ = 'Object GimpIntStore\n\nProperties from GimpIntStore:\n  user-data-type -> GType: User Data Type\n    The GType of the user_data column\n\nSignals from GtkTreeModel:\n  row-changed (GtkTreePath, GtkTreeIter)\n  row-inserted (GtkTreePath, GtkTreeIter)\n  row-has-child-toggled (GtkTreePath, GtkTreeIter)\n  row-deleted (GtkTreePath)\n  rows-reordered (GtkTreePath, GtkTreeIter, gpointer)\n\nSignals from GtkTreeSortable:\n  sort-column-changed ()\n\nSignals from GtkTreeModel:\n  row-changed (GtkTreePath, GtkTreeIter)\n  row-inserted (GtkTreePath, GtkTreeIter)\n  row-has-child-toggled (GtkTreePath, GtkTreeIter)\n  row-deleted (GtkTreePath)\n  rows-reordered (GtkTreePath, GtkTreeIter, gpointer)\n\nSignals from GtkTreeSortable:\n  sort-column-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpIntStore (3708066224)>'
    __info__ = ObjectInfo(IntStore)
