...
class ColorButton(Button):
    ...
    def do_extended_clicked(self, *args, **kwargs): # real signature unknown
    ...
    def do_get_action_type(self, *args, **kwargs): # real signature unknown
    ...
    def extended_clicked(self, modifier_state): # real signature unknown; restored from __doc__
        """ extended_clicked(self, modifier_state:Gdk.ModifierType) """
        pass
    ...
    def get_action_group(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, title, width, height, color, type): # real signature unknown; restored from __doc__
        """ new(title:str, width:int, height:int, color:Gegl.Color, type:GimpUi.ColorAreaType) -> Gtk.Widget """
        pass
    ...
    def set_update(self, continuous): # real signature unknown; restored from __doc__
