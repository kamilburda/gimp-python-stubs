...
class ColorScales(ColorSelector):
    ...
    def get_show_rgb_u8(self): # real signature unknown; restored from __doc__
    ...
    def set_show_rgb_u8(self, show_rgb_u8): # real signature unknown; restored from __doc__
