...
class Selection(Channel):
    ...
    """
    def all(self, image): # real signature unknown; restored from __doc__
    ...
    def border(self, image, radius): # real signature unknown; restored from __doc__
        """ border(image:Gimp.Image, radius:int) -> bool """
        return False

    def bounds(self, image): # real signature unknown; restored from __doc__
    ...
    def feather(self, image, radius): # real signature unknown; restored from __doc__
    ...
    def float(self, image, drawables, offx, offy): # real signature unknown; restored from __doc__
        """ float(image:Gimp.Image, drawables:list, offx:int, offy:int) -> Gimp.Layer """
        pass

    def flood(self, image): # real signature unknown; restored from __doc__
    ...
    def get_by_id(self, selection_id): # real signature unknown; restored from __doc__
    ...
    def grow(self, image, steps): # real signature unknown; restored from __doc__
    ...
    def invert(self, image): # real signature unknown; restored from __doc__
    ...
    def is_empty(self, image): # real signature unknown; restored from __doc__
    ...
    def none(self, image): # real signature unknown; restored from __doc__
    ...
    def save(self, image): # real signature unknown; restored from __doc__
    ...
    def sharpen(self, image): # real signature unknown; restored from __doc__
        """ sharpen(image:Gimp.Image) -> bool """
        return False

    def shrink(self, image, steps): # real signature unknown; restored from __doc__
    ...
    def translate(self, image, offx, offy): # real signature unknown; restored from __doc__
    ...
    def value(self, image, x, y): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f327490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Selection), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpSelection (2359064416)>, '__doc__': None, '__gsignals__': {}, 'all': <staticmethod(gi.FunctionInfo(all))>, 'border': <staticmethod(gi.FunctionInfo(border))>, 'bounds': <staticmethod(gi.FunctionInfo(bounds))>, 'feather': <staticmethod(gi.FunctionInfo(feather))>, 'float': <staticmethod(gi.FunctionInfo(float))>, 'flood': <staticmethod(gi.FunctionInfo(flood))>, 'get_by_id': <staticmethod(gi.FunctionInfo(get_by_id))>, 'grow': <staticmethod(gi.FunctionInfo(grow))>, 'invert': <staticmethod(gi.FunctionInfo(invert))>, 'is_empty': <staticmethod(gi.FunctionInfo(is_empty))>, 'none': <staticmethod(gi.FunctionInfo(none))>, 'save': <staticmethod(gi.FunctionInfo(save))>, 'sharpen': <staticmethod(gi.FunctionInfo(sharpen))>, 'shrink': <staticmethod(gi.FunctionInfo(shrink))>, 'translate': <staticmethod(gi.FunctionInfo(translate))>, 'value': <staticmethod(gi.FunctionInfo(value))>})"
    __firstlineno__ = 651
    __gdoc__ = 'Object GimpSelection\n\nProperties from GimpItem:\n  id -> gint: The item id\n    The item id for internal use\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpSelection (2359064416)>'
