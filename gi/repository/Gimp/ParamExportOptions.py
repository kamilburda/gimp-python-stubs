...
class ParamExportOptions(__gi_repository_GObject.ParamSpecObject):
    """
    :Constructors:
    
    ::
    
        ParamExportOptions(**properties)
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamExportOptions), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamExportOptions (2360847440)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamExportOptions (2360847440)>'
    __info__ = ObjectInfo(ParamExportOptions)
