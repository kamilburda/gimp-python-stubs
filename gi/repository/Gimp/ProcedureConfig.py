...
class ProcedureConfig(__gi_overrides_GObject.Object):
    ...
    def get_procedure(self): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f3ac610>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ProcedureConfig), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpProcedureConfig (2360869792)>, '__doc__': None, '__gsignals__': {}, 'get_choice_id': gi.FunctionInfo(get_choice_id), 'get_color_array': gi.FunctionInfo(get_color_array), 'get_core_object_array': gi.FunctionInfo(get_core_object_array), 'get_procedure': gi.FunctionInfo(get_procedure), 'save_metadata': gi.FunctionInfo(save_metadata), 'set_color_array': gi.FunctionInfo(set_color_array), 'set_core_object_array': gi.FunctionInfo(set_core_object_array), 'parent_instance': <property object at 0x000001268f534a90>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpProcedureConfig (2360869792)>'
