...
class ParamLayer(ParamDrawable):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamLayer), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamLayer (2359069792)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamLayer (2359069792)>'
