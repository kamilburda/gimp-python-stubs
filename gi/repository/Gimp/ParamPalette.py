...
class ParamPalette(ParamResource):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamPalette), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamPalette (2359064032)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamPalette (2359064032)>'
    __info__ = ObjectInfo(ParamPalette)
