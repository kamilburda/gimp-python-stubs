...
class JoinStyle(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'MITER': <JoinStyle.MITER: 0>, 'ROUND': <JoinStyle.ROUND: 1>, 'BEVEL': <JoinStyle.BEVEL: 2>})"
    __name__ = 'JoinStyle'
    __qualname__ = 'JoinStyle'
