...
class ColorTransform(__gi_overrides_GObject.Object):
    ...
    def can_gegl_copy(self, src_profile, dest_profile): # real signature unknown; restored from __doc__
    ...
    def process_buffer(self, src_buffer, src_rect, dest_buffer, dest_rect): # real signature unknown; restored from __doc__
        """ process_buffer(self, src_buffer:Gegl.Buffer, src_rect:Gegl.Rectangle, dest_buffer:Gegl.Buffer, dest_rect:Gegl.Rectangle) """
        pass

    def process_pixels(self, src_format, src_pixels=None, dest_format, dest_pixels=None, length): # real signature unknown; restored from __doc__
