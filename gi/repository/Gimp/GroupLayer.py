...
class GroupLayer(Layer):
    ...
    def merge(self): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f325030>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GroupLayer), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpGroupLayer (2348768256)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_by_id': <staticmethod(gi.FunctionInfo(get_by_id))>, 'merge': gi.FunctionInfo(merge)})"
    __firstlineno__ = 651
    __gdoc__ = 'Object GimpGroupLayer\n\nProperties from GimpItem:\n  id -> gint: The item id\n    The item id for internal use\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpGroupLayer (2348768256)>'
