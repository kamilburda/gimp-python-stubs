...
class ParamRasterizable(ParamDrawable):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamRasterizable), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamRasterizable (2359064160)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamRasterizable (2359064160)>'
    __info__ = ObjectInfo(ParamRasterizable)
