...
class ParamItem(__gi_repository_GObject.ParamSpecObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamItem), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamItem (2360847328)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamItem (2360847328)>'
    __info__ = ObjectInfo(ParamItem)
