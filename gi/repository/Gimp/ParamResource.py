...
class ParamResource(ParamObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamResource), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamResource (2360849904)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamResource (2360849904)>'
    __info__ = ObjectInfo(ParamResource)
