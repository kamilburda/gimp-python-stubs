...
class ParamCoreObjectArray(__gi_repository_GObject.ParamSpecBoxed):
    """
    :Constructors:
    
    ::
    
        ParamCoreObjectArray(**properties)
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamCoreObjectArray), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamCoreObjectArray (2360850576)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamCoreObjectArray (2360850576)>'
    __info__ = ObjectInfo(ParamCoreObjectArray)
