...
class ParamGroupLayer(ParamLayer):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamGroupLayer), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamGroupLayer (2359071200)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamGroupLayer (2359071200)>'
    __info__ = ObjectInfo(ParamGroupLayer)
