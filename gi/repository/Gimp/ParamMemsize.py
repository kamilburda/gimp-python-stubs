...
class ParamMemsize(__gi_repository_GObject.ParamSpecUInt64):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamMemsize), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamMemsize (2360858192)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamMemsize (2360858192)>'
    __info__ = ObjectInfo(ParamMemsize)
