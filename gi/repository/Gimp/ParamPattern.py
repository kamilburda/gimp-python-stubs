...
class ParamPattern(ParamResource):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamPattern), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamPattern (2359066464)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamPattern (2359066464)>'
