...
class LinkLayer(Layer, Rasterizable):
    ...
    @classmethod
    def new(cls, image, file): # real signature unknown; restored from __doc__
        """ new(image:Gimp.Image, file:Gio.File) -> Gimp.LinkLayer """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f3ac370>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LinkLayer), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpLinkLayer (2359068896)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_by_id': <staticmethod(gi.FunctionInfo(get_by_id))>, 'get_file': gi.FunctionInfo(get_file), 'get_mime_type': gi.FunctionInfo(get_mime_type), 'set_file': gi.FunctionInfo(set_file)})"
    __firstlineno__ = 651
    __gdoc__ = 'Object GimpLinkLayer\n\nProperties from GimpItem:\n  id -> gint: The item id\n    The item id for internal use\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpLinkLayer (2359068896)>'
    __info__ = ObjectInfo(LinkLayer)
