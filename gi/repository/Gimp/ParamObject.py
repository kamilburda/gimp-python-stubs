...
class ParamObject(__gi_repository_GObject.ParamSpecObject):
    """
    :Constructors:
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamObject), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamObject (2360848000)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamObject (2360848000)>'
    __info__ = ObjectInfo(ParamObject)
