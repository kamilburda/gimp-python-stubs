...
class ParamMatrix2(__gi_repository_GObject.ParamSpecBoxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamMatrix2), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamMatrix2 (2360852480)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamMatrix2 (2360852480)>'
    __info__ = ObjectInfo(ParamMatrix2)
