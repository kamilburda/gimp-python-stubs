...
class ParamChannel(ParamDrawable):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamChannel), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamChannel (2359065440)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamChannel (2359065440)>'
    __info__ = ObjectInfo(ParamChannel)
