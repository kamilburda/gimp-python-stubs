...
class Vector3(__gi.Boxed):
    ...
    @classmethod
    def new(cls, x, y, z): # real signature unknown; restored from __doc__
        """ new(x:float, y:float, z:float) -> Gimp.Vector3 """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(Vector3), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpVector3 (2360888928)>, '__dict__': <attribute '__dict__' of 'Vector3' objects>, '__weakref__': <attribute '__weakref__' of 'Vector3' objects>, '__doc__': None, 'x': <property object at 0x000001268f548680>, 'y': <property object at 0x000001268f548770>, 'z': <property object at 0x000001268f548860>, 'new': <classmethod(gi.FunctionInfo(new))>, 'add_val': gi.FunctionInfo(add_val), 'cross_product': gi.FunctionInfo(cross_product), 'cross_product_val': gi.FunctionInfo(cross_product_val), 'inner_product': gi.FunctionInfo(inner_product), 'inner_product_val': gi.FunctionInfo(inner_product_val), 'length': gi.FunctionInfo(length), 'length_val': gi.FunctionInfo(length_val), 'mul': gi.FunctionInfo(mul), 'mul_val': gi.FunctionInfo(mul_val), 'neg': gi.FunctionInfo(neg), 'neg_val': gi.FunctionInfo(neg_val), 'normalize': gi.FunctionInfo(normalize), 'normalize_val': gi.FunctionInfo(normalize_val), 'rotate': gi.FunctionInfo(rotate), 'rotate_val': gi.FunctionInfo(rotate_val), 'set': gi.FunctionInfo(set), 'sub_val': gi.FunctionInfo(sub_val), 'add': <staticmethod(gi.FunctionInfo(add))>, 'sub': <staticmethod(gi.FunctionInfo(sub))>})"
    __gtype__ = None # (!) real value is '<GType GimpVector3 (2360888928)>'
