...
class ParamSelection(ParamChannel):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSelection), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamSelection (2359067360)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamSelection (2359067360)>'
