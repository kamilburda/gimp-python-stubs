...
class Unit(__gi_overrides_GObject.Object):
    ...
    @classmethod
    def new(cls, name, factor, digits, symbol, abbreviation): # real signature unknown; restored from __doc__
        """ new(name:str, factor:float, digits:int, symbol:str, abbreviation:str) -> Gimp.Unit """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f3be2c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Unit), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpUnit (2360886048)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'format_string': <staticmethod(gi.FunctionInfo(format_string))>, 'get_by_id': <staticmethod(gi.FunctionInfo(get_by_id))>, 'inch': <staticmethod(gi.FunctionInfo(inch))>, 'mm': <staticmethod(gi.FunctionInfo(mm))>, 'percent': <staticmethod(gi.FunctionInfo(percent))>, 'pica': <staticmethod(gi.FunctionInfo(pica))>, 'pixel': <staticmethod(gi.FunctionInfo(pixel))>, 'point': <staticmethod(gi.FunctionInfo(point))>, 'get_abbreviation': gi.FunctionInfo(get_abbreviation), 'get_deletion_flag': gi.FunctionInfo(get_deletion_flag), 'get_digits': gi.FunctionInfo(get_digits), 'get_factor': gi.FunctionInfo(get_factor), 'get_id': gi.FunctionInfo(get_id), 'get_name': gi.FunctionInfo(get_name), 'get_scaled_digits': gi.FunctionInfo(get_scaled_digits), 'get_symbol': gi.FunctionInfo(get_symbol), 'is_built_in': gi.FunctionInfo(is_built_in), 'is_metric': gi.FunctionInfo(is_metric), 'set_deletion_flag': gi.FunctionInfo(set_deletion_flag)})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpUnit (2360886048)>'
