...
class PathStrokeType(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'BEZIER': <PathStrokeType.BEZIER: 0>})"
    __name__ = 'PathStrokeType'
    __qualname__ = 'PathStrokeType'
