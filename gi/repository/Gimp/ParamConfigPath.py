...
class ParamConfigPath(__gi_repository_GObject.ParamSpecString):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamConfigPath), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamConfigPath (2360844416)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamConfigPath (2360844416)>'
    __info__ = ObjectInfo(ParamConfigPath)
