...
class LayerMask(Channel):
    ...
    def get_by_id(self, layer_mask_id): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f3258d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LayerMask), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpLayerMask (2359068256)>, '__doc__': None, '__gsignals__': {}, 'get_by_id': <staticmethod(gi.FunctionInfo(get_by_id))>})"
    __firstlineno__ = 651
    __gdoc__ = 'Object GimpLayerMask\n\nProperties from GimpItem:\n  id -> gint: The item id\n    The item id for internal use\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpLayerMask (2359068256)>'
