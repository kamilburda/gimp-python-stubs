...
class Procedure(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268d3c3430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Procedure), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpProcedure (2362473248)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'add_boolean_argument': gi.FunctionInfo(add_boolean_argument), 'add_boolean_aux_argument': gi.FunctionInfo(add_boolean_aux_argument), 'add_boolean_return_value': gi.FunctionInfo(add_boolean_return_value), 'add_brush_argument': gi.FunctionInfo(add_brush_argument), 'add_brush_aux_argument': gi.FunctionInfo(add_brush_aux_argument), 'add_brush_return_value': gi.FunctionInfo(add_brush_return_value), 'add_bytes_argument': gi.FunctionInfo(add_bytes_argument), 'add_bytes_aux_argument': gi.FunctionInfo(add_bytes_aux_argument), 'add_bytes_return_value': gi.FunctionInfo(add_bytes_return_value), 'add_channel_argument': gi.FunctionInfo(add_channel_argument), 'add_channel_aux_argument': gi.FunctionInfo(add_channel_aux_argument), 'add_channel_return_value': gi.FunctionInfo(add_channel_return_value), 'add_choice_argument': gi.FunctionInfo(add_choice_argument), 'add_choice_aux_argument': gi.FunctionInfo(add_choice_aux_argument), 'add_choice_return_value': gi.FunctionInfo(add_choice_return_value), 'add_color_argument': gi.FunctionInfo(add_color_argument), 'add_color_aux_argument': gi.FunctionInfo(add_color_aux_argument), 'add_color_from_string_argument': gi.FunctionInfo(add_color_from_string_argument), 'add_color_from_string_aux_argument': gi.FunctionInfo(add_color_from_string_aux_argument), 'add_color_from_string_return_value': gi.FunctionInfo(add_color_from_string_return_value), 'add_color_return_value': gi.FunctionInfo(add_color_return_value), 'add_core_object_array_argument': gi.FunctionInfo(add_core_object_array_argument), 'add_core_object_array_aux_argument': gi.FunctionInfo(add_core_object_array_aux_argument), 'add_core_object_array_return_value': gi.FunctionInfo(add_core_object_array_return_value), 'add_display_argument': gi.FunctionInfo(add_display_argument), 'add_display_aux_argument': gi.FunctionInfo(add_display_aux_argument), 'add_display_return_value': gi.FunctionInfo(add_display_return_value), 'add_double_argument': gi.FunctionInfo(add_double_argument), 'add_double_array_argument': gi.FunctionInfo(add_double_array_argument), 'add_double_array_aux_argument': gi.FunctionInfo(add_double_array_aux_argument), 'add_double_array_return_value': gi.FunctionInfo(add_double_array_return_value), 'add_double_aux_argument': gi.FunctionInfo(add_double_aux_argument), 'add_double_return_value': gi.FunctionInfo(add_double_return_value), 'add_drawable_argument': gi.FunctionInfo(add_drawable_argument), 'add_drawable_aux_argument': gi.FunctionInfo(add_drawable_aux_argument), 'add_drawable_return_value': gi.FunctionInfo(add_drawable_return_value), 'add_enum_argument': gi.FunctionInfo(add_enum_argument), 'add_enum_aux_argument': gi.FunctionInfo(add_enum_aux_argument), 'add_enum_return_value': gi.FunctionInfo(add_enum_return_value), 'add_file_argument': gi.FunctionInfo(add_file_argument), 'add_file_aux_argument': gi.FunctionInfo(add_file_aux_argument), 'add_file_return_value': gi.FunctionInfo(add_file_return_value), 'add_font_argument': gi.FunctionInfo(add_font_argument), 'add_font_aux_argument': gi.FunctionInfo(add_font_aux_argument), 'add_font_return_value': gi.FunctionInfo(add_font_return_value), 'add_gradient_argument': gi.FunctionInfo(add_gradient_argument), 'add_gradient_aux_argument': gi.FunctionInfo(add_gradient_aux_argument), 'add_gradient_return_value': gi.FunctionInfo(add_gradient_return_value), 'add_group_layer_argument': gi.FunctionInfo(add_group_layer_argument), 'add_group_layer_aux_argument': gi.FunctionInfo(add_group_layer_aux_argument), 'add_group_layer_return_value': gi.FunctionInfo(add_group_layer_return_value), 'add_image_argument': gi.FunctionInfo(add_image_argument), 'add_image_aux_argument': gi.FunctionInfo(add_image_aux_argument), 'add_image_return_value': gi.FunctionInfo(add_image_return_value), 'add_int32_array_argument': gi.FunctionInfo(add_int32_array_argument), 'add_int32_array_aux_argument': gi.FunctionInfo(add_int32_array_aux_argument), 'add_int32_array_return_value': gi.FunctionInfo(add_int32_array_return_value), 'add_int_argument': gi.FunctionInfo(add_int_argument), 'add_int_aux_argument': gi.FunctionInfo(add_int_aux_argument), 'add_int_return_value': gi.FunctionInfo(add_int_return_value), 'add_item_argument': gi.FunctionInfo(add_item_argument), 'add_item_aux_argument': gi.FunctionInfo(add_item_aux_argument), 'add_item_return_value': gi.FunctionInfo(add_item_return_value), 'add_layer_argument': gi.FunctionInfo(add_layer_argument), 'add_layer_aux_argument': gi.FunctionInfo(add_layer_aux_argument), 'add_layer_mask_argument': gi.FunctionInfo(add_layer_mask_argument), 'add_layer_mask_aux_argument': gi.FunctionInfo(add_layer_mask_aux_argument), 'add_layer_mask_return_value': gi.FunctionInfo(add_layer_mask_return_value), 'add_layer_return_value': gi.FunctionInfo(add_layer_return_value), 'add_link_layer_argument': gi.FunctionInfo(add_link_layer_argument), 'add_link_layer_aux_argument': gi.FunctionInfo(add_link_layer_aux_argument), 'add_link_layer_return_value': gi.FunctionInfo(add_link_layer_return_value), 'add_menu_path': gi.FunctionInfo(add_menu_path), 'add_palette_argument': gi.FunctionInfo(add_palette_argument), 'add_palette_aux_argument': gi.FunctionInfo(add_palette_aux_argument), 'add_palette_return_value': gi.FunctionInfo(add_palette_return_value), 'add_param_argument': gi.FunctionInfo(add_param_argument), 'add_param_aux_argument': gi.FunctionInfo(add_param_aux_argument), 'add_param_return_value': gi.FunctionInfo(add_param_return_value), 'add_parasite_argument': gi.FunctionInfo(add_parasite_argument), 'add_parasite_aux_argument': gi.FunctionInfo(add_parasite_aux_argument), 'add_parasite_return_value': gi.FunctionInfo(add_parasite_return_value), 'add_path_argument': gi.FunctionInfo(add_path_argument), 'add_path_aux_argument': gi.FunctionInfo(add_path_aux_argument), 'add_path_return_value': gi.FunctionInfo(add_path_return_value), 'add_pattern_argument': gi.FunctionInfo(add_pattern_argument), 'add_pattern_aux_argument': gi.FunctionInfo(add_pattern_aux_argument), 'add_pattern_return_value': gi.FunctionInfo(add_pattern_return_value), 'add_resource_argument': gi.FunctionInfo(add_resource_argument), 'add_resource_aux_argument': gi.FunctionInfo(add_resource_aux_argument), 'add_resource_return_value': gi.FunctionInfo(add_resource_return_value), 'add_selection_argument': gi.FunctionInfo(add_selection_argument), 'add_selection_aux_argument': gi.FunctionInfo(add_selection_aux_argument), 'add_selection_return_value': gi.FunctionInfo(add_selection_return_value), 'add_string_argument': gi.FunctionInfo(add_string_argument), 'add_string_array_argument': gi.FunctionInfo(add_string_array_argument), 'add_string_array_aux_argument': gi.FunctionInfo(add_string_array_aux_argument), 'add_string_array_return_value': gi.FunctionInfo(add_string_array_return_value), 'add_string_aux_argument': gi.FunctionInfo(add_string_aux_argument), 'add_string_return_value': gi.FunctionInfo(add_string_return_value), 'add_text_layer_argument': gi.FunctionInfo(add_text_layer_argument), 'add_text_layer_aux_argument': gi.FunctionInfo(add_text_layer_aux_argument), 'add_text_layer_return_value': gi.FunctionInfo(add_text_layer_return_value), 'add_uint_argument': gi.FunctionInfo(add_uint_argument), 'add_uint_aux_argument': gi.FunctionInfo(add_uint_aux_argument), 'add_uint_return_value': gi.FunctionInfo(add_uint_return_value), 'add_unit_argument': gi.FunctionInfo(add_unit_argument), 'add_unit_aux_argument': gi.FunctionInfo(add_unit_aux_argument), 'add_unit_return_value': gi.FunctionInfo(add_unit_return_value), 'add_vector_layer_argument': gi.FunctionInfo(add_vector_layer_argument), 'add_vector_layer_aux_argument': gi.FunctionInfo(add_vector_layer_aux_argument), 'add_vector_layer_return_value': gi.FunctionInfo(add_vector_layer_return_value), 'create_config': gi.FunctionInfo(create_config), 'find_argument': gi.FunctionInfo(find_argument), 'find_aux_argument': gi.FunctionInfo(find_aux_argument), 'find_return_value': gi.FunctionInfo(find_return_value), 'get_argument_sync': gi.FunctionInfo(get_argument_sync), 'get_arguments': gi.FunctionInfo(get_arguments), 'get_authors': gi.FunctionInfo(get_authors), 'get_aux_arguments': gi.FunctionInfo(get_aux_arguments), 'get_blurb': gi.FunctionInfo(get_blurb), 'get_copyright': gi.FunctionInfo(get_copyright), 'get_date': gi.FunctionInfo(get_date), 'get_help': gi.FunctionInfo(get_help), 'get_help_id': gi.FunctionInfo(get_help_id), 'get_icon_file': gi.FunctionInfo(get_icon_file), 'get_icon_name': gi.FunctionInfo(get_icon_name), 'get_icon_pixbuf': gi.FunctionInfo(get_icon_pixbuf), 'get_icon_type': gi.FunctionInfo(get_icon_type), 'get_image_types': gi.FunctionInfo(get_image_types), 'get_menu_label': gi.FunctionInfo(get_menu_label), 'get_menu_paths': gi.FunctionInfo(get_menu_paths), 'get_name': gi.FunctionInfo(get_name), 'get_plug_in': gi.FunctionInfo(get_plug_in), 'get_proc_type': gi.FunctionInfo(get_proc_type), 'get_return_values': gi.FunctionInfo(get_return_values), 'get_sensitivity_mask': gi.FunctionInfo(get_sensitivity_mask), 'is_internal': gi.FunctionInfo(is_internal), 'new_return_values': gi.FunctionInfo(new_return_values), 'persistent_ready': gi.FunctionInfo(persistent_ready), 'run': gi.FunctionInfo(run), 'set_argument_sync': gi.FunctionInfo(set_argument_sync), 'set_attribution': gi.FunctionInfo(set_attribution), 'set_documentation': gi.FunctionInfo(set_documentation), 'set_icon_file': gi.FunctionInfo(set_icon_file), 'set_icon_name': gi.FunctionInfo(set_icon_name), 'set_icon_pixbuf': gi.FunctionInfo(set_icon_pixbuf), 'set_image_types': gi.FunctionInfo(set_image_types), 'set_menu_label': gi.FunctionInfo(set_menu_label), 'set_sensitivity_mask': gi.FunctionInfo(set_sensitivity_mask), 'do_install': gi.VFuncInfo(install), 'do_run': gi.VFuncInfo(run), 'do_set_sensitivity': gi.VFuncInfo(set_sensitivity), 'do_uninstall': gi.VFuncInfo(uninstall), 'parent_instance': <property object at 0x000001268f32d670>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpProcedure (2362473248)>'
