...
class VectorLayer(Layer, Rasterizable):
    ...
    def get_enable_fill(self): # real signature unknown; restored from __doc__
        """ get_enable_fill(self) -> bool """
        return False

    def get_enable_stroke(self): # real signature unknown; restored from __doc__
    ...
    def get_fill_color(self): # real signature unknown; restored from __doc__
        """ get_fill_color(self) -> Gegl.Color """
        pass

    def get_fill_pattern(self): # real signature unknown; restored from __doc__
    ...
    def get_stroke_cap_style(self): # real signature unknown; restored from __doc__
        """ get_stroke_cap_style(self) -> Gimp.CapStyle """
        pass

    def get_stroke_color(self): # real signature unknown; restored from __doc__
        """ get_stroke_color(self) -> Gegl.Color """
        pass

    def get_stroke_dash_offset(self): # real signature unknown; restored from __doc__
        """ get_stroke_dash_offset(self) -> float """
        return 0.0

    def get_stroke_dash_pattern(self): # real signature unknown; restored from __doc__
        """ get_stroke_dash_pattern(self) -> bool, dashes:list """
        return False

    def get_stroke_join_style(self): # real signature unknown; restored from __doc__
        """ get_stroke_join_style(self) -> Gimp.JoinStyle """
        pass

    def get_stroke_miter_limit(self): # real signature unknown; restored from __doc__
        """ get_stroke_miter_limit(self) -> float """
        return 0.0

    def get_stroke_pattern(self): # real signature unknown; restored from __doc__
        """ get_stroke_pattern(self) -> Gimp.Pattern """
        pass

    def get_stroke_width(self): # real signature unknown; restored from __doc__
        """ get_stroke_width(self) -> float """
        return 0.0

    def get_stroke_width_unit(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, image, path): # real signature unknown; restored from __doc__
        """ new(image:Gimp.Image, path:Gimp.Path) -> Gimp.VectorLayer """
        pass
    ...
    def set_enable_fill(self, enable_fill): # real signature unknown; restored from __doc__
        """ set_enable_fill(self, enable_fill:bool) -> bool """
        return False

    def set_enable_stroke(self, enable_stroke): # real signature unknown; restored from __doc__
    ...
    def set_fill_color(self, color): # real signature unknown; restored from __doc__
    ...
    def set_stroke_cap_style(self, cap_style): # real signature unknown; restored from __doc__
        """ set_stroke_cap_style(self, cap_style:Gimp.CapStyle) -> bool """
        return False

    def set_stroke_color(self, color): # real signature unknown; restored from __doc__
        """ set_stroke_color(self, color:Gegl.Color) -> bool """
        return False

    def set_stroke_dash_offset(self, dash_offset): # real signature unknown; restored from __doc__
        """ set_stroke_dash_offset(self, dash_offset:float) -> bool """
        return False

    def set_stroke_dash_pattern(self, dashes): # real signature unknown; restored from __doc__
        """ set_stroke_dash_pattern(self, dashes:list) -> bool """
        return False

    def set_stroke_join_style(self, join_style): # real signature unknown; restored from __doc__
        """ set_stroke_join_style(self, join_style:Gimp.JoinStyle) -> bool """
        return False

    def set_stroke_miter_limit(self, miter): # real signature unknown; restored from __doc__
        """ set_stroke_miter_limit(self, miter:float) -> bool """
        return False

    def set_stroke_width(self, width): # real signature unknown; restored from __doc__
        """ set_stroke_width(self, width:float) -> bool """
        return False

    def set_stroke_width_unit(self, unit): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f3bbb80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VectorLayer), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpVectorLayer (2359070944)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_by_id': <staticmethod(gi.FunctionInfo(get_by_id))>, 'get_enable_fill': gi.FunctionInfo(get_enable_fill), 'get_enable_stroke': gi.FunctionInfo(get_enable_stroke), 'get_fill_color': gi.FunctionInfo(get_fill_color), 'get_fill_pattern': gi.FunctionInfo(get_fill_pattern), 'get_path': gi.FunctionInfo(get_path), 'get_stroke_cap_style': gi.FunctionInfo(get_stroke_cap_style), 'get_stroke_color': gi.FunctionInfo(get_stroke_color), 'get_stroke_dash_offset': gi.FunctionInfo(get_stroke_dash_offset), 'get_stroke_dash_pattern': gi.FunctionInfo(get_stroke_dash_pattern), 'get_stroke_join_style': gi.FunctionInfo(get_stroke_join_style), 'get_stroke_miter_limit': gi.FunctionInfo(get_stroke_miter_limit), 'get_stroke_pattern': gi.FunctionInfo(get_stroke_pattern), 'get_stroke_width': gi.FunctionInfo(get_stroke_width), 'get_stroke_width_unit': gi.FunctionInfo(get_stroke_width_unit), 'refresh': gi.FunctionInfo(refresh), 'set_enable_fill': gi.FunctionInfo(set_enable_fill), 'set_enable_stroke': gi.FunctionInfo(set_enable_stroke), 'set_fill_color': gi.FunctionInfo(set_fill_color), 'set_stroke_cap_style': gi.FunctionInfo(set_stroke_cap_style), 'set_stroke_color': gi.FunctionInfo(set_stroke_color), 'set_stroke_dash_offset': gi.FunctionInfo(set_stroke_dash_offset), 'set_stroke_dash_pattern': gi.FunctionInfo(set_stroke_dash_pattern), 'set_stroke_join_style': gi.FunctionInfo(set_stroke_join_style), 'set_stroke_miter_limit': gi.FunctionInfo(set_stroke_miter_limit), 'set_stroke_width': gi.FunctionInfo(set_stroke_width), 'set_stroke_width_unit': gi.FunctionInfo(set_stroke_width_unit)})"
    __firstlineno__ = 651
    __gdoc__ = 'Object GimpVectorLayer\n\nProperties from GimpItem:\n  id -> gint: The item id\n    The item id for internal use\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpVectorLayer (2359070944)>'
    __info__ = ObjectInfo(VectorLayer)
