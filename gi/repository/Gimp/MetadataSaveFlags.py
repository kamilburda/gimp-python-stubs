...
class MetadataSaveFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'EXIF': <MetadataSaveFlags.EXIF: 1>, 'XMP': <MetadataSaveFlags.XMP: 2>, 'IPTC': <MetadataSaveFlags.IPTC: 4>, 'THUMBNAIL': <MetadataSaveFlags.THUMBNAIL: 8>, 'COLOR_PROFILE': <MetadataSaveFlags.COLOR_PROFILE: 16>, 'COMMENT': <MetadataSaveFlags.COMMENT: 32>, 'UPDATE': <MetadataSaveFlags.UPDATE: 64>, 'ALL': <MetadataSaveFlags.ALL: 4294967295>})"
    __name__ = 'MetadataSaveFlags'
    __qualname__ = 'MetadataSaveFlags'
