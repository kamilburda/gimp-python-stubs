...
class ParamTextLayer(ParamLayer):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamTextLayer), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamTextLayer (2359071840)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamTextLayer (2359071840)>'
