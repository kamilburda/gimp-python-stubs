...
class Font(Resource):
    ...
    def get_pango_font_description(self): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268d3c0c40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Font), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpFont (2359047232)>, '__doc__': None, '__gsignals__': {}, 'get_by_name': <staticmethod(gi.FunctionInfo(get_by_name))>, 'get_pango_font_description': gi.FunctionInfo(get_pango_font_description)})"
    __firstlineno__ = 651
    __gdoc__ = 'Object GimpFont\n\nProperties from GimpResource:\n  id -> gint: The id\n    The id for internal use\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpFont (2359047232)>'
