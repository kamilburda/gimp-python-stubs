...
class ParamUnit(ParamObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamUnit), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamUnit (2360852704)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamUnit (2360852704)>'
