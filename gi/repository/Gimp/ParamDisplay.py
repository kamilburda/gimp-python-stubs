...
class ParamDisplay(__gi_repository_GObject.ParamSpecObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamDisplay), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamDisplay (2360850800)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamDisplay (2360850800)>'
    __info__ = ObjectInfo(ParamDisplay)
