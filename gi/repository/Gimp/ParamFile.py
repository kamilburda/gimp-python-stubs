...
class ParamFile(ParamObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamFile), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamFile (2360847664)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamFile (2360847664)>'
    __info__ = ObjectInfo(ParamFile)
