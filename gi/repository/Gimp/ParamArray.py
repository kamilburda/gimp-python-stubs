...
class ParamArray(__gi_repository_GObject.ParamSpecBoxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamArray), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamArray (2360846320)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamArray (2360846320)>'
    __info__ = ObjectInfo(ParamArray)
