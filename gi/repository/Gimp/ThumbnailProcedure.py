...
class ThumbnailProcedure(Procedure):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f3b8220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ThumbnailProcedure), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpThumbnailProcedure (2359333984)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>})"
    __firstlineno__ = 651
    __gdoc__ = "Object GimpThumbnailProcedure\n\nProperties from GimpProcedure:\n  plug-in -> GimpPlugIn: Plug-In\n    The GimpPlugIn of this plug-in process\n  name -> gchararray: Name\n    The procedure's name\n  procedure-type -> GimpPDBProcType: Procedure type\n    The procedure's type\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpThumbnailProcedure (2359333984)>'
    __info__ = ObjectInfo(ThumbnailProcedure)
