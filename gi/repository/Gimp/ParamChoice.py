...
class ParamChoice(__gi_repository_GObject.ParamSpecString):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamChoice), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamChoice (2360846656)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamChoice (2360846656)>'
