...
class ParamPath(ParamItem):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamPath), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamPath (2360852144)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamPath (2360852144)>'
