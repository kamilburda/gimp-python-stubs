...
class ModuleError(__enum.IntEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'MODULE_FAILED': <ModuleError.MODULE_FAILED: 0>})"
    __name__ = 'ModuleError'
    __qualname__ = 'ModuleError'
