...
class ParamInt32Array(ParamArray):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamInt32Array), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamInt32Array (2360853152)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamInt32Array (2360853152)>'
    __info__ = ObjectInfo(ParamInt32Array)
