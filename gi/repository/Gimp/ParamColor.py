...
class ParamColor(ParamObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamColor), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamColor (2360850912)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamColor (2360850912)>'
