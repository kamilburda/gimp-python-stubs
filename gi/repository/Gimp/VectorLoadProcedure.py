...
class VectorLoadProcedure(LoadProcedure):
    ...
    def extract_dimensions(self, file): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, plug_in, name, proc_type, extract_func, extract_data=None, run_func, run_data=None): # real signature unknown; restored from __doc__
        """ new(plug_in:Gimp.PlugIn, name:str, proc_type:Gimp.PDBProcType, extract_func:Gimp.ExtractVectorFunc, extract_data=None, run_func:Gimp.RunVectorLoadFunc, run_data=None) -> Gimp.Procedure """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f3b5f60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VectorLoadProcedure), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpVectorLoadProcedure (2348768384)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'extract_dimensions': gi.FunctionInfo(extract_dimensions)})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpVectorLoadProcedure (2348768384)>'
