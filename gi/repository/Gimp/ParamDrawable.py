...
class ParamDrawable(ParamItem):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamDrawable), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamDrawable (2360850352)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamDrawable (2360850352)>'
    __info__ = ObjectInfo(ParamDrawable)
