...
class ParamCurve(__gi_repository_GObject.ParamSpecObject):
    """
    :Constructors:
    
    ::
    
        ParamCurve(**properties)
    """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamCurve), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamCurve (2360844528)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamCurve (2360844528)>'
    __info__ = ObjectInfo(ParamCurve)
