...
class ParamVectorLayer(ParamLayer):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamVectorLayer), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamVectorLayer (2359067872)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamVectorLayer (2359067872)>'
    __info__ = ObjectInfo(ParamVectorLayer)
