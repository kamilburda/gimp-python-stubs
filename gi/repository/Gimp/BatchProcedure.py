...
class BatchProcedure(Procedure):
    ...
    def get_interpreter_name(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, plug_in, name, interpreter_name, proc_type, run_func, run_data=None): # real signature unknown; restored from __doc__
        """ new(plug_in:Gimp.PlugIn, name:str, interpreter_name:str, proc_type:Gimp.PDBProcType, run_func:Gimp.BatchFunc, run_data=None) -> Gimp.Procedure """
        pass
    ...
    def set_interpreter_name(self, interpreter_name): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f2eceb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BatchProcedure), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpBatchProcedure (2362449664)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_interpreter_name': gi.FunctionInfo(get_interpreter_name), 'set_interpreter_name': gi.FunctionInfo(set_interpreter_name)})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpBatchProcedure (2362449664)>'
