...
class FileProcedure(Procedure):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f2f1420>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileProcedure), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpFileProcedure (2362335920)>, '__doc__': None, '__gsignals__': {}, 'get_extensions': gi.FunctionInfo(get_extensions), 'get_format_name': gi.FunctionInfo(get_format_name), 'get_handles_remote': gi.FunctionInfo(get_handles_remote), 'get_magics': gi.FunctionInfo(get_magics), 'get_meta': gi.FunctionInfo(get_meta), 'get_mime_types': gi.FunctionInfo(get_mime_types), 'get_prefixes': gi.FunctionInfo(get_prefixes), 'get_priority': gi.FunctionInfo(get_priority), 'set_extensions': gi.FunctionInfo(set_extensions), 'set_format_name': gi.FunctionInfo(set_format_name), 'set_handles_remote': gi.FunctionInfo(set_handles_remote), 'set_magics': gi.FunctionInfo(set_magics), 'set_meta': gi.FunctionInfo(set_meta), 'set_mime_types': gi.FunctionInfo(set_mime_types), 'set_prefixes': gi.FunctionInfo(set_prefixes), 'set_priority': gi.FunctionInfo(set_priority), 'parent_instance': <property object at 0x000001268f3176f0>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpFileProcedure (2362335920)>'
