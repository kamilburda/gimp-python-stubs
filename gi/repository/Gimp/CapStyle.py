...
class CapStyle(__gi__gi.GEnum):
    ...
    __members__ = None # (!) real value is "mappingproxy({'BUTT': <CapStyle.BUTT: 0>, 'ROUND': <CapStyle.ROUND: 1>, 'SQUARE': <CapStyle.SQUARE: 2>})"
    __name__ = 'CapStyle'
    __qualname__ = 'CapStyle'
