...
class ParamLinkLayer(ParamLayer):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamLinkLayer), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamLinkLayer (2359066592)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamLinkLayer (2359066592)>'
    __info__ = ObjectInfo(ParamLinkLayer)
