...
class Pattern(Resource):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001268f3b2f50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Pattern), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpPattern (2360833776)>, '__doc__': None, '__gsignals__': {}, 'get_by_name': <staticmethod(gi.FunctionInfo(get_by_name))>, 'get_buffer': gi.FunctionInfo(get_buffer), 'get_info': gi.FunctionInfo(get_info)})"
    __firstlineno__ = 651
    __gdoc__ = 'Object GimpPattern\n\nProperties from GimpResource:\n  id -> gint: The id\n    The id for internal use\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpPattern (2360833776)>'
