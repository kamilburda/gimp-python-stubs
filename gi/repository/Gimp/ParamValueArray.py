...
class ParamValueArray(__gi_repository_GObject.ParamSpecBoxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamValueArray), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamValueArray (2360854160)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamValueArray (2360854160)>'
