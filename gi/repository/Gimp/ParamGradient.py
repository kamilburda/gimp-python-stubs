...
class ParamGradient(ParamResource):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamGradient), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamGradient (2359071712)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamGradient (2359071712)>'
