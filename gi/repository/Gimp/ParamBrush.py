...
class ParamBrush(ParamResource):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamBrush), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamBrush (2359069408)>, '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 843
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamBrush (2359069408)>'
    __info__ = ObjectInfo(ParamBrush)
