...
class UnixConnection(SocketConnection):
    ...
    def connect_async(self, address, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
    ...
    def factory_lookup_type(self, family, type, protocol_id): # real signature unknown; restored from __doc__
        """ factory_lookup_type(family:Gio.SocketFamily, type:Gio.SocketType, protocol_id:int) -> GType """
        pass

    def factory_register_type(self, g_type, family, type, protocol): # real signature unknown; restored from __doc__
        """ factory_register_type(g_type:GType, family:Gio.SocketFamily, type:Gio.SocketType, protocol:int) """
        pass
    ...
    def receive_credentials(self, cancellable=None): # real signature unknown; restored from __doc__
        """ receive_credentials(self, cancellable:Gio.Cancellable=None) -> Gio.Credentials """
        pass

    def receive_credentials_async(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ receive_credentials_async(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def receive_credentials_finish(self, result): # real signature unknown; restored from __doc__
        """ receive_credentials_finish(self, result:Gio.AsyncResult) -> Gio.Credentials """
        pass

    def receive_fd(self, cancellable=None): # real signature unknown; restored from __doc__
        """ receive_fd(self, cancellable:Gio.Cancellable=None) -> int """
        return 0
    ...
    def send_credentials(self, cancellable=None): # real signature unknown; restored from __doc__
        """ send_credentials(self, cancellable:Gio.Cancellable=None) -> bool """
        return False

    def send_credentials_async(self, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ send_credentials_async(self, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def send_credentials_finish(self, result): # real signature unknown; restored from __doc__
        """ send_credentials_finish(self, result:Gio.AsyncResult) -> bool """
        return False

    def send_fd(self, fd, cancellable=None): # real signature unknown; restored from __doc__
        """ send_fd(self, fd:int, cancellable:Gio.Cancellable=None) -> bool """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea70870f40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UnixConnection), '__module__': 'gi.repository.Gio', '__gtype__': <GType GUnixConnection (1845577376)>, '__doc__': None, '__gsignals__': {}, 'receive_credentials': gi.FunctionInfo(receive_credentials), 'receive_credentials_async': gi.FunctionInfo(receive_credentials_async), 'receive_credentials_finish': gi.FunctionInfo(receive_credentials_finish), 'receive_fd': gi.FunctionInfo(receive_fd), 'send_credentials': gi.FunctionInfo(send_credentials), 'send_credentials_async': gi.FunctionInfo(send_credentials_async), 'send_credentials_finish': gi.FunctionInfo(send_credentials_finish), 'send_fd': gi.FunctionInfo(send_fd), 'parent_instance': <property object at 0x000001ea709ea930>, 'priv': <property object at 0x000001ea709eaa20>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GUnixConnection (1845577376)>'
