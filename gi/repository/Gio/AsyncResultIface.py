...
class AsyncResultIface(__gi.Struct):
    ...
    get_source_object = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_user_data = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(AsyncResultIface), '__module__': 'gi.repository.Gio', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'AsyncResultIface' objects>, '__weakref__': <attribute '__weakref__' of 'AsyncResultIface' objects>, '__doc__': None, 'g_iface': <property object at 0x000001ea703f6250>, 'get_user_data': <property object at 0x000001ea703f6340>, 'get_source_object': <property object at 0x000001ea703f6430>, 'is_tagged': <property object at 0x000001ea703f6520>})"
