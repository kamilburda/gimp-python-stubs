...
class SimpleIOStream(IOStream):
    ...
    @classmethod
    def new(cls, input_stream, output_stream): # real signature unknown; restored from __doc__
        """ new(input_stream:Gio.InputStream, output_stream:Gio.OutputStream) -> Gio.IOStream """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea70868790>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SimpleIOStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GSimpleIOStream (1845875200)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GSimpleIOStream (1845875200)>'
