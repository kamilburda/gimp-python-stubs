...
class BusNameOwnerFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <BusNameOwnerFlags.NONE: 0>, 'ALLOW_REPLACEMENT': <BusNameOwnerFlags.ALLOW_REPLACEMENT: 1>, 'REPLACE': <BusNameOwnerFlags.REPLACE: 2>, 'DO_NOT_QUEUE': <BusNameOwnerFlags.DO_NOT_QUEUE: 4>})"
    __name__ = 'BusNameOwnerFlags'
    __qualname__ = 'BusNameOwnerFlags'
