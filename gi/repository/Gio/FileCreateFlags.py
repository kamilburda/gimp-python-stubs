...
class FileCreateFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <FileCreateFlags.NONE: 0>, 'PRIVATE': <FileCreateFlags.PRIVATE: 1>, 'REPLACE_DESTINATION': <FileCreateFlags.REPLACE_DESTINATION: 2>})"
    __name__ = 'FileCreateFlags'
    __qualname__ = 'FileCreateFlags'
