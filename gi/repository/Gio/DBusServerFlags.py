...
class DBusServerFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusServerFlags.NONE: 0>, 'RUN_IN_THREAD': <DBusServerFlags.RUN_IN_THREAD: 1>, 'AUTHENTICATION_ALLOW_ANONYMOUS': <DBusServerFlags.AUTHENTICATION_ALLOW_ANONYMOUS: 2>, 'AUTHENTICATION_REQUIRE_SAME_USER': <DBusServerFlags.AUTHENTICATION_REQUIRE_SAME_USER: 4>})"
    __name__ = 'DBusServerFlags'
    __qualname__ = 'DBusServerFlags'
