...
class DBusInterfaceSkeletonFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusInterfaceSkeletonFlags.NONE: 0>, 'HANDLE_METHOD_INVOCATIONS_IN_THREAD': <DBusInterfaceSkeletonFlags.HANDLE_METHOD_INVOCATIONS_IN_THREAD: 1>})"
    __name__ = 'DBusInterfaceSkeletonFlags'
    __qualname__ = 'DBusInterfaceSkeletonFlags'
