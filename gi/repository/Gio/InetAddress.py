...
class InetAddress(__gi_overrides_GObject.Object):
    ...
    def equal(self, other_address): # real signature unknown; restored from __doc__
        """ equal(self, other_address:Gio.InetAddress) -> bool """
        return False
    ...
    def get_is_link_local(self): # real signature unknown; restored from __doc__
        """ get_is_link_local(self) -> bool """
        return False

    def get_is_loopback(self): # real signature unknown; restored from __doc__
        """ get_is_loopback(self) -> bool """
        return False

    def get_is_mc_global(self): # real signature unknown; restored from __doc__
        """ get_is_mc_global(self) -> bool """
        return False

    def get_is_mc_link_local(self): # real signature unknown; restored from __doc__
        """ get_is_mc_link_local(self) -> bool """
        return False

    def get_is_mc_node_local(self): # real signature unknown; restored from __doc__
        """ get_is_mc_node_local(self) -> bool """
        return False

    def get_is_mc_org_local(self): # real signature unknown; restored from __doc__
        """ get_is_mc_org_local(self) -> bool """
        return False

    def get_is_mc_site_local(self): # real signature unknown; restored from __doc__
        """ get_is_mc_site_local(self) -> bool """
        return False

    def get_is_multicast(self): # real signature unknown; restored from __doc__
        """ get_is_multicast(self) -> bool """
        return False

    def get_is_site_local(self): # real signature unknown; restored from __doc__
        """ get_is_site_local(self) -> bool """
        return False
