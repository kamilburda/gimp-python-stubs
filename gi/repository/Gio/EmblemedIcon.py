...
class EmblemedIcon(__gi_overrides_GObject.Object, Icon):
    ...
    @classmethod
    def new(cls, icon, emblem=None): # real signature unknown; restored from __doc__
        """ new(icon:Gio.Icon, emblem:Gio.Emblem=None) -> Gio.EmblemedIcon """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea708558a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EmblemedIcon), '__module__': 'gi.repository.Gio', '__gtype__': <GType GEmblemedIcon (1848619184)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'add_emblem': gi.FunctionInfo(add_emblem), 'clear_emblems': gi.FunctionInfo(clear_emblems), 'get_emblems': gi.FunctionInfo(get_emblems), 'get_icon': gi.FunctionInfo(get_icon), 'parent_instance': <property object at 0x000001ea7094c5e0>, 'priv': <property object at 0x000001ea7094c6d0>})"
    __gdoc__ = 'Object GEmblemedIcon\n\nProperties from GEmblemedIcon:\n  gicon -> GIcon: gicon\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GEmblemedIcon (1848619184)>'
