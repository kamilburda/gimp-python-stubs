...
class FileAttributeMatcher(__gi.Boxed):
    ...
    def enumerate_next(self): # real signature unknown; restored from __doc__
        """ enumerate_next(self) -> str or None """
        return ""
    ...
    def subtract(self, subtract=None): # real signature unknown; restored from __doc__
        """ subtract(self, subtract:Gio.FileAttributeMatcher=None) -> Gio.FileAttributeMatcher or None """
        pass
