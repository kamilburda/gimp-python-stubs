...
class FileCopyFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <FileCopyFlags.NONE: 0>, 'OVERWRITE': <FileCopyFlags.OVERWRITE: 1>, 'BACKUP': <FileCopyFlags.BACKUP: 2>, 'NOFOLLOW_SYMLINKS': <FileCopyFlags.NOFOLLOW_SYMLINKS: 4>, 'ALL_METADATA': <FileCopyFlags.ALL_METADATA: 8>, 'NO_FALLBACK_FOR_MOVE': <FileCopyFlags.NO_FALLBACK_FOR_MOVE: 16>, 'TARGET_DEFAULT_PERMS': <FileCopyFlags.TARGET_DEFAULT_PERMS: 32>, 'TARGET_DEFAULT_MODIFIED_TIME': <FileCopyFlags.TARGET_DEFAULT_MODIFIED_TIME: 64>})"
    __name__ = 'FileCopyFlags'
    __qualname__ = 'FileCopyFlags'
