...
class SocketType(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'INVALID': <SocketType.INVALID: 0>, 'STREAM': <SocketType.STREAM: 1>, 'DATAGRAM': <SocketType.DATAGRAM: 2>, 'SEQPACKET': <SocketType.SEQPACKET: 3>})"
    __name__ = 'SocketType'
