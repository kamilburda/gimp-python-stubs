...
class LoadableIcon(__gobject.GInterface):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': InterfaceInfo(LoadableIcon), '__module__': 'gi.repository.Gio', '__gtype__': <GType GLoadableIcon (1841874048)>, '__dict__': <attribute '__dict__' of 'LoadableIcon' objects>, '__weakref__': <attribute '__weakref__' of 'LoadableIcon' objects>, '__doc__': None, '__gsignals__': {}, 'load': gi.FunctionInfo(load), 'load_async': gi.FunctionInfo(load_async), 'load_finish': gi.FunctionInfo(load_finish)})"
    __gdoc__ = 'Interface GLoadableIcon\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GLoadableIcon (1841874048)>'
