...
class SocketAddressEnumeratorClass(__gi.Struct):
    ...
    next_async = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    next_finish = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __class__ = None # (!) real value is "<class 'gi.types.StructMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SocketAddressEnumeratorClass), '__module__': 'gi.repository.Gio', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SocketAddressEnumeratorClass' objects>, '__weakref__': <attribute '__weakref__' of 'SocketAddressEnumeratorClass' objects>, '__doc__': None, 'parent_class': <property object at 0x000001ea709c62a0>, 'next': <property object at 0x000001ea709c6390>, 'next_async': <property object at 0x000001ea709c6480>, 'next_finish': <property object at 0x000001ea709c6570>})"
