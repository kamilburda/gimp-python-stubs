...
class DBusServer(__gi_overrides_GObject.Object, Initable):
    ...
    def get_client_address(self): # real signature unknown; restored from __doc__
        """ get_client_address(self) -> str """
        return ""
    ...
    def get_flags(self): # real signature unknown; restored from __doc__
        """ get_flags(self) -> Gio.DBusServerFlags """
        pass
    ...
    @classmethod
    def new_sync(cls, address, flags, guid, observer=None, cancellable=None): # real signature unknown; restored from __doc__
        """ new_sync(address:str, flags:Gio.DBusServerFlags, guid:str, observer:Gio.DBusAuthObserver=None, cancellable:Gio.Cancellable=None) -> Gio.DBusServer """
        pass
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDBusServer (1841880384)>'
