...
class NetworkService(__gi_overrides_GObject.Object, SocketConnectable):
    ...
    def get_service(self): # real signature unknown; restored from __doc__
        """ get_service(self) -> str """
        return ""
    ...
    @classmethod
    def new(cls, service, protocol, domain): # real signature unknown; restored from __doc__
        """ new(service:str, protocol:str, domain:str) -> Gio.NetworkService """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea70861120>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NetworkService), '__module__': 'gi.repository.Gio', '__gtype__': <GType GNetworkService (1841604176)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_domain': gi.FunctionInfo(get_domain), 'get_protocol': gi.FunctionInfo(get_protocol), 'get_scheme': gi.FunctionInfo(get_scheme), 'get_service': gi.FunctionInfo(get_service), 'set_scheme': gi.FunctionInfo(set_scheme), 'parent_instance': <property object at 0x000001ea709ac720>, 'priv': <property object at 0x000001ea709ac810>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GNetworkService (1841604176)>'
