...
class ThreadedResolver(Resolver):
    ...
    def set_timeout(self, timeout_ms): # real signature unknown; restored from __doc__
        """ set_timeout(self, timeout_ms:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea7086db40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ThreadedResolver), '__module__': 'gi.repository.Gio', '__gtype__': <GType GThreadedResolver (1845521056)>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object GThreadedResolver\n\nSignals from GResolver:\n  reload ()\n\nProperties from GResolver:\n  timeout -> guint: timeout\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GThreadedResolver (1845521056)>'
    __info__ = ObjectInfo(ThreadedResolver)
