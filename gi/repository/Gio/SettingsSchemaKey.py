...
class SettingsSchemaKey(__gi.Boxed):
    ...
    def get_default_value(self): # real signature unknown; restored from __doc__
        """ get_default_value(self) -> GLib.Variant """
        pass
    ...
    def get_range(self): # real signature unknown; restored from __doc__
        """ get_range(self) -> GLib.Variant """
        pass

    def get_summary(self): # real signature unknown; restored from __doc__
        """ get_summary(self) -> str or None """
        return ""

    def get_value_type(self): # real signature unknown; restored from __doc__
        """ get_value_type(self) -> GLib.VariantType """
        pass

    def range_check(self, value): # real signature unknown; restored from __doc__
        """ range_check(self, value:GLib.Variant) -> bool """
        return False

    def ref(self): # real signature unknown; restored from __doc__
        """ ref(self) -> Gio.SettingsSchemaKey """
        pass
