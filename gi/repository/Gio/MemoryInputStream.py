...
class MemoryInputStream(InputStream, PollableInputStream, Seekable):
    ...
    """
    def add_bytes(self, bytes): # real signature unknown; restored from __doc__
        """ add_bytes(self, bytes:GLib.Bytes) """
        pass

    def add_data(self, data, destroy=None): # real signature unknown; restored from __doc__
        """ add_data(self, data:list, destroy:GLib.DestroyNotify=None) """
        pass
    ...
    def is_readable(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new_from_bytes(cls, bytes): # real signature unknown; restored from __doc__
        """ new_from_bytes(bytes:GLib.Bytes) -> Gio.InputStream """
        pass

    @classmethod
    def new_from_data(cls, data, destroy=None): # real signature unknown; restored from __doc__
        """ new_from_data(data:list, destroy:GLib.DestroyNotify=None) -> Gio.InputStream """
        pass
    ...
    def read_nonblocking(self, cancellable=None): # real signature unknown; restored from __doc__
        """ read_nonblocking(self, cancellable:Gio.Cancellable=None) -> int, buffer:list """
        return 0
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea7085cee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MemoryInputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GMemoryInputStream (1841559328)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'new_from_bytes': <classmethod(gi.FunctionInfo(new_from_bytes))>, 'new_from_data': <classmethod(gi.FunctionInfo(new_from_data))>, 'add_bytes': gi.FunctionInfo(add_bytes), 'add_data': gi.FunctionInfo(add_data), 'parent_instance': <property object at 0x000001ea70925a30>, 'priv': <property object at 0x000001ea70925b20>})"
    __gdoc__ = 'Object GMemoryInputStream\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMemoryInputStream (1841559328)>'
