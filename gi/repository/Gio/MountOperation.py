...
class MountOperation(__gi_overrides_GObject.Object):
    ...
    def set_domain(self, domain=None): # real signature unknown; restored from __doc__
        """ set_domain(self, domain:str=None) """
        pass
    ...
    def set_username(self, username=None): # real signature unknown; restored from __doc__
        """ set_username(self, username:str=None) """
        pass
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMountOperation (1841604944)>'
