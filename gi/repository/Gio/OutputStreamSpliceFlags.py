...
class OutputStreamSpliceFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <OutputStreamSpliceFlags.NONE: 0>, 'CLOSE_SOURCE': <OutputStreamSpliceFlags.CLOSE_SOURCE: 1>, 'CLOSE_TARGET': <OutputStreamSpliceFlags.CLOSE_TARGET: 2>})"
    __name__ = 'OutputStreamSpliceFlags'
    __qualname__ = 'OutputStreamSpliceFlags'
