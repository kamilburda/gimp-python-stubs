...
class BufferedOutputStream(FilterOutputStream, Seekable):
    ...
    def get_auto_grow(self): # real signature unknown; restored from __doc__
        """ get_auto_grow(self) -> bool """
        return False
    ...
    def set_auto_grow(self, auto_grow): # real signature unknown; restored from __doc__
        """ set_auto_grow(self, auto_grow:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea70487f10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BufferedOutputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GBufferedOutputStream (1841853104)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'new_sized': <classmethod(gi.FunctionInfo(new_sized))>, 'get_auto_grow': gi.FunctionInfo(get_auto_grow), 'get_buffer_size': gi.FunctionInfo(get_buffer_size), 'set_auto_grow': gi.FunctionInfo(set_auto_grow), 'set_buffer_size': gi.FunctionInfo(set_buffer_size), 'parent_instance': <property object at 0x000001ea703f71a0>, 'priv': <property object at 0x000001ea703f7290>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GBufferedOutputStream (1841853104)>'
