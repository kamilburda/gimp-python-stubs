...
class FileAttributeInfoList(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(FileAttributeInfoList), '__module__': 'gi.repository.Gio', '__gtype__': <GType GFileAttributeInfoList (1848619376)>, '__dict__': <attribute '__dict__' of 'FileAttributeInfoList' objects>, '__weakref__': <attribute '__weakref__' of 'FileAttributeInfoList' objects>, '__doc__': None, 'infos': <property object at 0x000001ea7094d170>, 'n_infos': <property object at 0x000001ea7094d260>, 'new': <classmethod(gi.FunctionInfo(new))>, 'add': gi.FunctionInfo(add), 'dup': gi.FunctionInfo(dup), 'lookup': gi.FunctionInfo(lookup), 'ref': gi.FunctionInfo(ref), 'unref': gi.FunctionInfo(unref), '__new__': <staticmethod(gi.FunctionInfo(new))>, '__init__': <function nothing at 0x000001ea702ccfe0>})"
    __gtype__ = None # (!) real value is '<GType GFileAttributeInfoList (1848619376)>'
