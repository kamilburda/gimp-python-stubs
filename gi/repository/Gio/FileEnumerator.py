...
class FileEnumerator(FileEnumerator):
    ...
    def do_next_file(self, *args, **kwargs): # real signature unknown
        """ next_file(self, cancellable:Gio.Cancellable=None) -> Gio.FileInfo or None """
        pass

    def do_next_files_async(self, *args, **kwargs): # real signature unknown
    ...
    def do_next_files_finish(self, *args, **kwargs): # real signature unknown
    ...
    def get_child(self, info): # real signature unknown; restored from __doc__
        """ get_child(self, info:Gio.FileInfo) -> Gio.File """
        pass

    def get_container(self): # real signature unknown; restored from __doc__
        """ get_container(self) -> Gio.File """
        pass
    ...
    def iterate(self, cancellable=None): # real signature unknown; restored from __doc__
        """ iterate(self, cancellable:Gio.Cancellable=None) -> bool, out_info:Gio.FileInfo, out_child:Gio.File """
        return False
    ...
    def next_file(self, cancellable=None): # real signature unknown; restored from __doc__
        """ next_file(self, cancellable:Gio.Cancellable=None) -> Gio.FileInfo or None """
        pass

    def next_files_async(self, num_files, io_priority, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ next_files_async(self, num_files:int, io_priority:int, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass
    ...
    def set_pending(self, pending): # real signature unknown; restored from __doc__
        """ set_pending(self, pending:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea708579a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gio', '__iter__': <function FileEnumerator.__iter__ at 0x000001ea7028bd80>, '__next__': <function FileEnumerator.__next__ at 0x000001ea7028be20>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object GFileEnumerator\n\nProperties from GFileEnumerator:\n  container -> GFile: container\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GFileEnumerator (1845786784)>'
