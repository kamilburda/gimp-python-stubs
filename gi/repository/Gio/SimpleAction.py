...
class SimpleAction(__gi_overrides_GObject.Object, Action):
    ...
    def set_state(self, value): # real signature unknown; restored from __doc__
        """ set_state(self, value:GLib.Variant) """
        pass

    def set_state_hint(self, state_hint=None): # real signature unknown; restored from __doc__
        """ set_state_hint(self, state_hint:GLib.Variant=None) """
        pass
