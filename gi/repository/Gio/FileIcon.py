...
class FileIcon(__gi_overrides_GObject.Object, Icon, LoadableIcon):
    ...
    @classmethod
    def new(cls, file): # real signature unknown; restored from __doc__
        """ new(file:Gio.File) -> Gio.FileIcon """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileIcon), '__module__': 'gi.repository.Gio', '__gtype__': <GType GFileIcon (1848621872)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_file': gi.FunctionInfo(get_file)})"
    __gdoc__ = 'Object GFileIcon\n\nProperties from GFileIcon:\n  file -> GFile: file\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GFileIcon (1848621872)>'
