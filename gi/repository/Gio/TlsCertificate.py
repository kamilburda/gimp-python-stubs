...
class TlsCertificate(__gi_overrides_GObject.Object):
    ...
    def get_dns_names(self): # real signature unknown; restored from __doc__
        """ get_dns_names(self) -> list or None """
        return []

    def get_ip_addresses(self): # real signature unknown; restored from __doc__
        """ get_ip_addresses(self) -> list or None """
        return []

    def get_issuer(self): # real signature unknown; restored from __doc__
        """ get_issuer(self) -> Gio.TlsCertificate or None """
        pass

    def get_issuer_name(self): # real signature unknown; restored from __doc__
        """ get_issuer_name(self) -> str or None """
        return ""

    def get_not_valid_after(self): # real signature unknown; restored from __doc__
        """ get_not_valid_after(self) -> GLib.DateTime or None """
        pass

    def get_not_valid_before(self): # real signature unknown; restored from __doc__
        """ get_not_valid_before(self) -> GLib.DateTime or None """
        pass
    ...
    def get_subject_name(self): # real signature unknown; restored from __doc__
        """ get_subject_name(self) -> str or None """
        return ""
    ...
    def is_same(self, cert_two): # real signature unknown; restored from __doc__
        """ is_same(self, cert_two:Gio.TlsCertificate) -> bool """
        return False

    def list_new_from_file(self, file): # real signature unknown; restored from __doc__
        """ list_new_from_file(file:str) -> list """
        return []
    ...
    def verify(self, identity=None, trusted_ca=None): # real signature unknown; restored from __doc__
        """ verify(self, identity:Gio.SocketConnectable=None, trusted_ca:Gio.TlsCertificate=None) -> Gio.TlsCertificateFlags """
        pass
