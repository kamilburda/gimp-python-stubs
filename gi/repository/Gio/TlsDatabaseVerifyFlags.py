...
class TlsDatabaseVerifyFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <TlsDatabaseVerifyFlags.NONE: 0>})"
    __name__ = 'TlsDatabaseVerifyFlags'
    __qualname__ = 'TlsDatabaseVerifyFlags'
