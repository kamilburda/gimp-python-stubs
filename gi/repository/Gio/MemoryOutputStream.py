...
class MemoryOutputStream(OutputStream, PollableOutputStream, Seekable):
    ...
    @classmethod
    def new_resizable(cls): # real signature unknown; restored from __doc__
        """ new_resizable() -> Gio.OutputStream """
        pass
    ...
    def steal_as_bytes(self): # real signature unknown; restored from __doc__
        """ steal_as_bytes(self) -> GLib.Bytes """
        pass

    def steal_data(self): # real signature unknown; restored from __doc__
        """ steal_data(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea70858670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MemoryOutputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GMemoryOutputStream (1841558544)>, '__doc__': None, '__gsignals__': {}, 'new_resizable': <classmethod(gi.FunctionInfo(new_resizable))>, 'get_data': gi.FunctionInfo(get_data), 'get_data_size': gi.FunctionInfo(get_data_size), 'get_size': gi.FunctionInfo(get_size), 'steal_as_bytes': gi.FunctionInfo(steal_as_bytes), 'steal_data': gi.FunctionInfo(steal_data), 'parent_instance': <property object at 0x000001ea70926660>, 'priv': <property object at 0x000001ea70926750>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMemoryOutputStream (1841558544)>'
