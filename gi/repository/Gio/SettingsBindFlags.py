...
class SettingsBindFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <SettingsBindFlags.DEFAULT: 0>, 'GET': <SettingsBindFlags.GET: 1>, 'SET': <SettingsBindFlags.SET: 2>, 'NO_SENSITIVITY': <SettingsBindFlags.NO_SENSITIVITY: 4>, 'GET_NO_CHANGES': <SettingsBindFlags.GET_NO_CHANGES: 8>, 'INVERT_BOOLEAN': <SettingsBindFlags.INVERT_BOOLEAN: 16>})"
    __name__ = 'SettingsBindFlags'
    __qualname__ = 'SettingsBindFlags'
