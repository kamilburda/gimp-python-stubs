...
class DBusObjectProxy(__gi_overrides_GObject.Object, DBusObject):
    ...
    @classmethod
    def new(cls, connection, object_path): # real signature unknown; restored from __doc__
        """ new(connection:Gio.DBusConnection, object_path:str) -> Gio.DBusObjectProxy """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea70853b50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DBusObjectProxy), '__module__': 'gi.repository.Gio', '__gtype__': <GType GDBusObjectProxy (1841879328)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_connection': gi.FunctionInfo(get_connection), 'parent_instance': <property object at 0x000001ea70969c60>, 'priv': <property object at 0x000001ea70969d50>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDBusObjectProxy (1841879328)>'
