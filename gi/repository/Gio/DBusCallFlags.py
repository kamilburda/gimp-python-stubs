...
class DBusCallFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusCallFlags.NONE: 0>, 'NO_AUTO_START': <DBusCallFlags.NO_AUTO_START: 1>, 'ALLOW_INTERACTIVE_AUTHORIZATION': <DBusCallFlags.ALLOW_INTERACTIVE_AUTHORIZATION: 2>})"
    __name__ = 'DBusCallFlags'
    __qualname__ = 'DBusCallFlags'
