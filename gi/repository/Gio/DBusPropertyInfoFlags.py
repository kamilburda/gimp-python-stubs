...
class DBusPropertyInfoFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusPropertyInfoFlags.NONE: 0>, 'READABLE': <DBusPropertyInfoFlags.READABLE: 1>, 'WRITABLE': <DBusPropertyInfoFlags.WRITABLE: 2>})"
    __name__ = 'DBusPropertyInfoFlags'
    __qualname__ = 'DBusPropertyInfoFlags'
