...
class FileMeasureFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <FileMeasureFlags.NONE: 0>, 'REPORT_ANY_ERROR': <FileMeasureFlags.REPORT_ANY_ERROR: 2>, 'APPARENT_SIZE': <FileMeasureFlags.APPARENT_SIZE: 4>, 'NO_XDEV': <FileMeasureFlags.NO_XDEV: 8>})"
    __name__ = 'FileMeasureFlags'
    __qualname__ = 'FileMeasureFlags'
