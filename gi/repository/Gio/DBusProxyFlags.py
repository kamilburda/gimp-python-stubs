...
class DBusProxyFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusProxyFlags.NONE: 0>, 'DO_NOT_LOAD_PROPERTIES': <DBusProxyFlags.DO_NOT_LOAD_PROPERTIES: 1>, 'DO_NOT_CONNECT_SIGNALS': <DBusProxyFlags.DO_NOT_CONNECT_SIGNALS: 2>, 'DO_NOT_AUTO_START': <DBusProxyFlags.DO_NOT_AUTO_START: 4>, 'GET_INVALIDATED_PROPERTIES': <DBusProxyFlags.GET_INVALIDATED_PROPERTIES: 8>, 'DO_NOT_AUTO_START_AT_CONSTRUCTION': <DBusProxyFlags.DO_NOT_AUTO_START_AT_CONSTRUCTION: 16>, 'NO_MATCH_RULE': <DBusProxyFlags.NO_MATCH_RULE: 32>})"
    __name__ = 'DBusProxyFlags'
    __qualname__ = 'DBusProxyFlags'
