...
class ConverterFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <ConverterFlags.NONE: 0>, 'INPUT_AT_END': <ConverterFlags.INPUT_AT_END: 1>, 'FLUSH': <ConverterFlags.FLUSH: 2>})"
    __name__ = 'ConverterFlags'
    __qualname__ = 'ConverterFlags'
