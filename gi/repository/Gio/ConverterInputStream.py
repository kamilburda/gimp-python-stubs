...
class ConverterInputStream(FilterInputStream, PollableInputStream):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea708499f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ConverterInputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GConverterInputStream (1841856912)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_converter': gi.FunctionInfo(get_converter), 'parent_instance': <property object at 0x000001ea703ec950>, 'priv': <property object at 0x000001ea703eca40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GConverterInputStream (1841856912)>'
