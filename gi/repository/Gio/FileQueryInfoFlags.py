...
class FileQueryInfoFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <FileQueryInfoFlags.NONE: 0>, 'NOFOLLOW_SYMLINKS': <FileQueryInfoFlags.NOFOLLOW_SYMLINKS: 1>})"
    __name__ = 'FileQueryInfoFlags'
    __qualname__ = 'FileQueryInfoFlags'
