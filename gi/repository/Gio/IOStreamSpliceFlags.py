...
class IOStreamSpliceFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <IOStreamSpliceFlags.NONE: 0>, 'CLOSE_STREAM1': <IOStreamSpliceFlags.CLOSE_STREAM1: 1>, 'CLOSE_STREAM2': <IOStreamSpliceFlags.CLOSE_STREAM2: 2>, 'WAIT_FOR_BOTH': <IOStreamSpliceFlags.WAIT_FOR_BOTH: 4>})"
    __name__ = 'IOStreamSpliceFlags'
    __qualname__ = 'IOStreamSpliceFlags'
