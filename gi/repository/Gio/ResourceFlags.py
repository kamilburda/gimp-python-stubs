...
class ResourceFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <ResourceFlags.NONE: 0>, 'COMPRESSED': <ResourceFlags.COMPRESSED: 1>})"
    __name__ = 'ResourceFlags'
    __qualname__ = 'ResourceFlags'
