...
class DBusCapabilityFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusCapabilityFlags.NONE: 0>, 'UNIX_FD_PASSING': <DBusCapabilityFlags.UNIX_FD_PASSING: 1>})"
    __name__ = 'DBusCapabilityFlags'
    __qualname__ = 'DBusCapabilityFlags'
