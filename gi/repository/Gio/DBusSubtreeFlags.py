...
class DBusSubtreeFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusSubtreeFlags.NONE: 0>, 'DISPATCH_TO_UNENUMERATED_NODES': <DBusSubtreeFlags.DISPATCH_TO_UNENUMERATED_NODES: 1>})"
    __name__ = 'DBusSubtreeFlags'
    __qualname__ = 'DBusSubtreeFlags'
