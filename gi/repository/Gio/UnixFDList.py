...
class UnixFDList(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    """
    def append(self, fd): # real signature unknown; restored from __doc__
        """ append(self, fd:int) -> int """
        return 0
    ...
    def peek_fds(self): # real signature unknown; restored from __doc__
        """ peek_fds(self) -> list """
        return []
    ...
    def steal_fds(self): # real signature unknown; restored from __doc__
        """ steal_fds(self) -> list """
        return []
