...
class DBusArgInfo(DBusArgInfo):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gio', '__init__': <function _warn_init.<locals>.new_init at 0x000001ea7028b740>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GDBusArgInfo (1845788896)>'
    __info__ = StructInfo(DBusArgInfo)
