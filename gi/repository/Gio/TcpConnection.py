...
class TcpConnection(SocketConnection):
    ...
    def get_graceful_disconnect(self): # real signature unknown; restored from __doc__
        """ get_graceful_disconnect(self) -> bool """
        return False
    ...
    def set_graceful_disconnect(self, graceful_disconnect): # real signature unknown; restored from __doc__
        """ set_graceful_disconnect(self, graceful_disconnect:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea7086d570>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TcpConnection), '__module__': 'gi.repository.Gio', '__gtype__': <GType GTcpConnection (1846055904)>, '__doc__': None, '__gsignals__': {}, 'get_graceful_disconnect': gi.FunctionInfo(get_graceful_disconnect), 'set_graceful_disconnect': gi.FunctionInfo(set_graceful_disconnect), 'parent_instance': <property object at 0x000001ea709d3a10>, 'priv': <property object at 0x000001ea709d3b00>})"
    __gdoc__ = 'Object GTcpConnection\n\nProperties from GTcpConnection:\n  graceful-disconnect -> gboolean: graceful-disconnect\n\nProperties from GSocketConnection:\n  socket -> GSocket: socket\n\nProperties from GIOStream:\n  input-stream -> GInputStream: input-stream\n  output-stream -> GOutputStream: output-stream\n  closed -> gboolean: closed\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GTcpConnection (1846055904)>'
    __info__ = ObjectInfo(TcpConnection)
