...
class AppInfoCreateFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <AppInfoCreateFlags.NONE: 0>, 'NEEDS_TERMINAL': <AppInfoCreateFlags.NEEDS_TERMINAL: 1>, 'SUPPORTS_URIS': <AppInfoCreateFlags.SUPPORTS_URIS: 2>, 'SUPPORTS_STARTUP_NOTIFICATION': <AppInfoCreateFlags.SUPPORTS_STARTUP_NOTIFICATION: 4>})"
    __name__ = 'AppInfoCreateFlags'
    __qualname__ = 'AppInfoCreateFlags'
