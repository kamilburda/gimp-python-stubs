...
class FileEnumeratorClass(__gi.Struct):
    ...
    next_file = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    next_files_async = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    next_files_finish = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
