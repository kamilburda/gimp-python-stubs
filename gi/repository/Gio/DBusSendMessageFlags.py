...
class DBusSendMessageFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusSendMessageFlags.NONE: 0>, 'PRESERVE_SERIAL': <DBusSendMessageFlags.PRESERVE_SERIAL: 1>})"
    __name__ = 'DBusSendMessageFlags'
    __qualname__ = 'DBusSendMessageFlags'
