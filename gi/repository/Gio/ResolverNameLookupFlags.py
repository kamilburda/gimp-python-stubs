...
class ResolverNameLookupFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <ResolverNameLookupFlags.DEFAULT: 0>, 'IPV4_ONLY': <ResolverNameLookupFlags.IPV4_ONLY: 1>, 'IPV6_ONLY': <ResolverNameLookupFlags.IPV6_ONLY: 2>})"
    __name__ = 'ResolverNameLookupFlags'
    __qualname__ = 'ResolverNameLookupFlags'
