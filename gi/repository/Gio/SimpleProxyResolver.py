...
class SimpleProxyResolver(__gi_overrides_GObject.Object, ProxyResolver):
    ...
    def new(self, default_proxy=None, ignore_hosts=None): # real signature unknown; restored from __doc__
        """ new(default_proxy:str=None, ignore_hosts:list=None) -> Gio.ProxyResolver """
        pass
    ...
    def set_default_proxy(self, default_proxy=None): # real signature unknown; restored from __doc__
        """ set_default_proxy(self, default_proxy:str=None) """
        pass

    def set_ignore_hosts(self, ignore_hosts): # real signature unknown; restored from __doc__
        """ set_ignore_hosts(self, ignore_hosts:list) """
        pass
    ...
    def set_uri_proxy(self, uri_scheme, proxy): # real signature unknown; restored from __doc__
        """ set_uri_proxy(self, uri_scheme:str, proxy:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea70869a80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SimpleProxyResolver), '__module__': 'gi.repository.Gio', '__gtype__': <GType GSimpleProxyResolver (1841599952)>, '__doc__': None, '__gsignals__': {}, 'new': <staticmethod(gi.FunctionInfo(new))>, 'set_default_proxy': gi.FunctionInfo(set_default_proxy), 'set_ignore_hosts': gi.FunctionInfo(set_ignore_hosts), 'set_uri_proxy': gi.FunctionInfo(set_uri_proxy), 'parent_instance': <property object at 0x000001ea709c5120>, 'priv': <property object at 0x000001ea709c5210>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GSimpleProxyResolver (1841599952)>'
