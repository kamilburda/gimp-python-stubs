...
class ApplicationFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'FLAGS_NONE': <ApplicationFlags.FLAGS_NONE: 0>, 'DEFAULT_FLAGS': <ApplicationFlags.FLAGS_NONE: 0>, 'IS_SERVICE': <ApplicationFlags.IS_SERVICE: 1>, 'IS_LAUNCHER': <ApplicationFlags.IS_LAUNCHER: 2>, 'HANDLES_OPEN': <ApplicationFlags.HANDLES_OPEN: 4>, 'HANDLES_COMMAND_LINE': <ApplicationFlags.HANDLES_COMMAND_LINE: 8>, 'SEND_ENVIRONMENT': <ApplicationFlags.SEND_ENVIRONMENT: 16>, 'NON_UNIQUE': <ApplicationFlags.NON_UNIQUE: 32>, 'CAN_OVERRIDE_APP_ID': <ApplicationFlags.CAN_OVERRIDE_APP_ID: 64>, 'ALLOW_REPLACEMENT': <ApplicationFlags.ALLOW_REPLACEMENT: 128>, 'REPLACE': <ApplicationFlags.REPLACE: 256>})"
    __name__ = 'ApplicationFlags'
    __qualname__ = 'ApplicationFlags'
