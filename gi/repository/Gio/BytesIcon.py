...
class BytesIcon(__gi_overrides_GObject.Object, Icon, LoadableIcon):
    ...
    @classmethod
    def new(cls, bytes): # real signature unknown; restored from __doc__
        """ new(bytes:GLib.Bytes) -> Gio.BytesIcon """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea704872b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BytesIcon), '__module__': 'gi.repository.Gio', '__gtype__': <GType GBytesIcon (1841875200)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_bytes': gi.FunctionInfo(get_bytes)})"
    __gdoc__ = 'Object GBytesIcon\n\nProperties from GBytesIcon:\n  bytes -> GBytes: bytes\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GBytesIcon (1841875200)>'
