...
class DBusObjectManagerIface(__gi.Struct):
    ...
    object_added = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    object_removed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
