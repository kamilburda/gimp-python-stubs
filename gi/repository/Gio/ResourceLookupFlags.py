...
class ResourceLookupFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <ResourceLookupFlags.NONE: 0>})"
    __name__ = 'ResourceLookupFlags'
    __qualname__ = 'ResourceLookupFlags'
