...
class DBusSignalFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusSignalFlags.NONE: 0>, 'NO_MATCH_RULE': <DBusSignalFlags.NO_MATCH_RULE: 1>, 'MATCH_ARG0_NAMESPACE': <DBusSignalFlags.MATCH_ARG0_NAMESPACE: 2>, 'MATCH_ARG0_PATH': <DBusSignalFlags.MATCH_ARG0_PATH: 4>})"
    __name__ = 'DBusSignalFlags'
    __qualname__ = 'DBusSignalFlags'
