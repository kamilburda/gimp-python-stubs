...
class DBusActionGroup(__gi_overrides_GObject.Object, ActionGroup, RemoteActionGroup):
    ...
    def activate_action_full(self, action_name, parameter=None, platform_data): # real signature unknown; restored from __doc__
        """ activate_action_full(self, action_name:str, parameter:GLib.Variant=None, platform_data:GLib.Variant) """
        pass
    ...
    def change_action_state_full(self, action_name, value, platform_data): # real signature unknown; restored from __doc__
        """ change_action_state_full(self, action_name:str, value:GLib.Variant, platform_data:GLib.Variant) """
        pass
    ...
    def get(self, connection, bus_name=None, object_path): # real signature unknown; restored from __doc__
        """ get(connection:Gio.DBusConnection, bus_name:str=None, object_path:str) -> Gio.DBusActionGroup """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea7084bc70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DBusActionGroup), '__module__': 'gi.repository.Gio', '__gtype__': <GType GDBusActionGroup (1841875488)>, '__doc__': None, '__gsignals__': {}, 'get': <staticmethod(gi.FunctionInfo(get))>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDBusActionGroup (1841875488)>'
