...
class BusNameWatcherFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <BusNameWatcherFlags.NONE: 0>, 'AUTO_START': <BusNameWatcherFlags.AUTO_START: 1>})"
    __name__ = 'BusNameWatcherFlags'
    __qualname__ = 'BusNameWatcherFlags'
