...
class MountMountFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <MountMountFlags.NONE: 0>})"
    __name__ = 'MountMountFlags'
    __qualname__ = 'MountMountFlags'
