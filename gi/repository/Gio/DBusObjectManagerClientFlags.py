...
class DBusObjectManagerClientFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusObjectManagerClientFlags.NONE: 0>, 'DO_NOT_AUTO_START': <DBusObjectManagerClientFlags.DO_NOT_AUTO_START: 1>})"
    __name__ = 'DBusObjectManagerClientFlags'
    __qualname__ = 'DBusObjectManagerClientFlags'
