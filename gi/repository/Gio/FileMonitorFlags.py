...
class FileMonitorFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <FileMonitorFlags.NONE: 0>, 'WATCH_MOUNTS': <FileMonitorFlags.WATCH_MOUNTS: 1>, 'SEND_MOVED': <FileMonitorFlags.SEND_MOVED: 2>, 'WATCH_HARD_LINKS': <FileMonitorFlags.WATCH_HARD_LINKS: 4>, 'WATCH_MOVES': <FileMonitorFlags.WATCH_MOVES: 8>})"
    __name__ = 'FileMonitorFlags'
    __qualname__ = 'FileMonitorFlags'
