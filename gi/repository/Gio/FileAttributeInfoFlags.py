...
class FileAttributeInfoFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <FileAttributeInfoFlags.NONE: 0>, 'COPY_WITH_FILE': <FileAttributeInfoFlags.COPY_WITH_FILE: 1>, 'COPY_WHEN_MOVED': <FileAttributeInfoFlags.COPY_WHEN_MOVED: 2>})"
    __name__ = 'FileAttributeInfoFlags'
    __qualname__ = 'FileAttributeInfoFlags'
