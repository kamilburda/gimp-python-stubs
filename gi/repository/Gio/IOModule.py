...
class IOModule(__gi_repository_GObject.TypeModule):
    ...
    @classmethod
    def new(cls, filename): # real signature unknown; restored from __doc__
        """ new(filename:str) -> Gio.IOModule """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea7085d9f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IOModule), '__module__': 'gi.repository.Gio', '__gtype__': <GType GIOModule (1841541632)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'query': <staticmethod(gi.FunctionInfo(query))>})"
    __gdoc__ = 'Object GIOModule\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GIOModule (1841541632)>'
