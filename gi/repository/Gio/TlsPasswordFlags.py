...
class TlsPasswordFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <TlsPasswordFlags.NONE: 0>, 'RETRY': <TlsPasswordFlags.RETRY: 2>, 'MANY_TRIES': <TlsPasswordFlags.MANY_TRIES: 4>, 'FINAL_TRY': <TlsPasswordFlags.FINAL_TRY: 8>, 'PKCS11_USER': <TlsPasswordFlags.PKCS11_USER: 16>, 'PKCS11_SECURITY_OFFICER': <TlsPasswordFlags.PKCS11_SECURITY_OFFICER: 32>, 'PKCS11_CONTEXT_SPECIFIC': <TlsPasswordFlags.PKCS11_CONTEXT_SPECIFIC: 64>})"
    __name__ = 'TlsPasswordFlags'
    __qualname__ = 'TlsPasswordFlags'
