...
class SubprocessFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <SubprocessFlags.NONE: 0>, 'STDIN_PIPE': <SubprocessFlags.STDIN_PIPE: 1>, 'STDIN_INHERIT': <SubprocessFlags.STDIN_INHERIT: 2>, 'STDOUT_PIPE': <SubprocessFlags.STDOUT_PIPE: 4>, 'STDOUT_SILENCE': <SubprocessFlags.STDOUT_SILENCE: 8>, 'STDERR_PIPE': <SubprocessFlags.STDERR_PIPE: 16>, 'STDERR_SILENCE': <SubprocessFlags.STDERR_SILENCE: 32>, 'STDERR_MERGE': <SubprocessFlags.STDERR_MERGE: 64>, 'INHERIT_FDS': <SubprocessFlags.INHERIT_FDS: 128>, 'SEARCH_PATH_FROM_ENVP': <SubprocessFlags.SEARCH_PATH_FROM_ENVP: 256>})"
    __name__ = 'SubprocessFlags'
    __qualname__ = 'SubprocessFlags'
