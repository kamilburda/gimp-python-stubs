...
class Emblem(__gi_overrides_GObject.Object, Icon):
    ...
    def get_origin(self): # real signature unknown; restored from __doc__
        """ get_origin(self) -> Gio.EmblemOrigin """
        pass
    ...
    @classmethod
    def new(cls, icon): # real signature unknown; restored from __doc__
        """ new(icon:Gio.Icon) -> Gio.Emblem """
        pass
    ...
    @classmethod
    def new_with_origin(cls, icon, origin): # real signature unknown; restored from __doc__
        """ new_with_origin(icon:Gio.Icon, origin:Gio.EmblemOrigin) -> Gio.Emblem """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea708547f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Emblem), '__module__': 'gi.repository.Gio', '__gtype__': <GType GEmblem (1848623792)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'new_with_origin': <classmethod(gi.FunctionInfo(new_with_origin))>, 'get_icon': gi.FunctionInfo(get_icon), 'get_origin': gi.FunctionInfo(get_origin)})"
    __gdoc__ = 'Object GEmblem\n\nProperties from GEmblem:\n  icon -> GObject: icon\n  origin -> GEmblemOrigin: origin\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GEmblem (1848623792)>'
