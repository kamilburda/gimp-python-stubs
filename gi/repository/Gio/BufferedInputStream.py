...
class BufferedInputStream(FilterInputStream, Seekable):
    ...
    @classmethod
    def new(cls, base_stream): # real signature unknown; restored from __doc__
        """ new(base_stream:Gio.InputStream) -> Gio.InputStream """
        pass
    ...
    @classmethod
    def new_sized(cls, base_stream, size): # real signature unknown; restored from __doc__
        """ new_sized(base_stream:Gio.InputStream, size:int) -> Gio.InputStream """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea708492d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BufferedInputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GBufferedInputStream (1844878464)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'new_sized': <classmethod(gi.FunctionInfo(new_sized))>, 'fill': gi.FunctionInfo(fill), 'fill_async': gi.FunctionInfo(fill_async), 'fill_finish': gi.FunctionInfo(fill_finish), 'get_available': gi.FunctionInfo(get_available), 'get_buffer_size': gi.FunctionInfo(get_buffer_size), 'peek': gi.FunctionInfo(peek), 'peek_buffer': gi.FunctionInfo(peek_buffer), 'read_byte': gi.FunctionInfo(read_byte), 'set_buffer_size': gi.FunctionInfo(set_buffer_size), 'do_fill': gi.VFuncInfo(fill), 'do_fill_async': gi.VFuncInfo(fill_async), 'do_fill_finish': gi.VFuncInfo(fill_finish), 'parent_instance': <property object at 0x000001ea7030d1c0>, 'priv': <property object at 0x000001ea7030d2b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GBufferedInputStream (1844878464)>'
