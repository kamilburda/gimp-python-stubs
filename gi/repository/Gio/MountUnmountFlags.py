...
class MountUnmountFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <MountUnmountFlags.NONE: 0>, 'FORCE': <MountUnmountFlags.FORCE: 1>})"
    __name__ = 'MountUnmountFlags'
    __qualname__ = 'MountUnmountFlags'
