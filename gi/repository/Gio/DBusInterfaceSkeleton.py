...
class DBusInterfaceSkeleton(__gi_overrides_GObject.Object, DBusInterface):
    ...
    def do_get_vtable(self, *args, **kwargs): # real signature unknown
    ...
    def get_object_path(self): # real signature unknown; restored from __doc__
        """ get_object_path(self) -> str or None """
        return ""
    ...
    def get_vtable(self): # real signature unknown; restored from __doc__
        """ get_vtable(self) -> Gio.DBusInterfaceVTable """
        pass
