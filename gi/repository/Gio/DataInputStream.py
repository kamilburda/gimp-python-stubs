...
class DataInputStream(DataInputStream):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ea6e9257e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gio', '__iter__': <function DataInputStream.__iter__ at 0x000001ea703094e0>, '__next__': <function DataInputStream.__next__ at 0x000001ea70309580>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object GDataInputStream\n\nProperties from GDataInputStream:\n  byte-order -> GDataStreamByteOrder: byte-order\n  newline-type -> GDataStreamNewlineType: newline-type\n\nProperties from GBufferedInputStream:\n  buffer-size -> guint: buffer-size\n\nProperties from GFilterInputStream:\n  base-stream -> GInputStream: base-stream\n  close-base-stream -> gboolean: close-base-stream\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataInputStream (1834753232)>'
    __info__ = ObjectInfo(DataInputStream)
