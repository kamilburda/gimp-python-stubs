...
class DriveStartFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DriveStartFlags.NONE: 0>})"
    __name__ = 'DriveStartFlags'
    __qualname__ = 'DriveStartFlags'
