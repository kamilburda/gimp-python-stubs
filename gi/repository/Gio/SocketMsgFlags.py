...
class SocketMsgFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <SocketMsgFlags.NONE: 0>, 'OOB': <SocketMsgFlags.OOB: 1>, 'PEEK': <SocketMsgFlags.PEEK: 2>, 'DONTROUTE': <SocketMsgFlags.DONTROUTE: 4>})"
    __name__ = 'SocketMsgFlags'
    __qualname__ = 'SocketMsgFlags'
