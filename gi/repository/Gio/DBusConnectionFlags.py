...
class DBusConnectionFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusConnectionFlags.NONE: 0>, 'AUTHENTICATION_CLIENT': <DBusConnectionFlags.AUTHENTICATION_CLIENT: 1>, 'AUTHENTICATION_SERVER': <DBusConnectionFlags.AUTHENTICATION_SERVER: 2>, 'AUTHENTICATION_ALLOW_ANONYMOUS': <DBusConnectionFlags.AUTHENTICATION_ALLOW_ANONYMOUS: 4>, 'MESSAGE_BUS_CONNECTION': <DBusConnectionFlags.MESSAGE_BUS_CONNECTION: 8>, 'DELAY_MESSAGE_PROCESSING': <DBusConnectionFlags.DELAY_MESSAGE_PROCESSING: 16>, 'AUTHENTICATION_REQUIRE_SAME_USER': <DBusConnectionFlags.AUTHENTICATION_REQUIRE_SAME_USER: 32>, 'CROSS_NAMESPACE': <DBusConnectionFlags.CROSS_NAMESPACE: 64>})"
    __name__ = 'DBusConnectionFlags'
    __qualname__ = 'DBusConnectionFlags'
