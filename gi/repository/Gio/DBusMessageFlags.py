...
class DBusMessageFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DBusMessageFlags.NONE: 0>, 'NO_REPLY_EXPECTED': <DBusMessageFlags.NO_REPLY_EXPECTED: 1>, 'NO_AUTO_START': <DBusMessageFlags.NO_AUTO_START: 2>, 'ALLOW_INTERACTIVE_AUTHORIZATION': <DBusMessageFlags.ALLOW_INTERACTIVE_AUTHORIZATION: 4>})"
    __name__ = 'DBusMessageFlags'
    __qualname__ = 'DBusMessageFlags'
