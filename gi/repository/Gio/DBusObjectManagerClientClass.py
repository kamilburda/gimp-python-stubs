...
class DBusObjectManagerClientClass(__gi.Struct):
    ...
    interface_proxy_properties_changed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    interface_proxy_signal = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
