...
class ot_math_glyph_part_flags_t(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'OT_MATH_GLYPH_PART_FLAG_EXTENDER': <ot_math_glyph_part_flags_t.OT_MATH_GLYPH_PART_FLAG_EXTENDER: 1>})"
    __name__ = 'ot_math_glyph_part_flags_t'
    __qualname__ = 'ot_math_glyph_part_flags_t'
