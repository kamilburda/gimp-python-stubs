...
class glyph_flags_t(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNSAFE_TO_BREAK': <glyph_flags_t.UNSAFE_TO_BREAK: 1>, 'UNSAFE_TO_CONCAT': <glyph_flags_t.UNSAFE_TO_CONCAT: 2>, 'SAFE_TO_INSERT_TATWEEL': <glyph_flags_t.SAFE_TO_INSERT_TATWEEL: 4>, 'DEFINED': <glyph_flags_t.DEFINED: 7>})"
    __name__ = 'glyph_flags_t'
    __qualname__ = 'glyph_flags_t'
