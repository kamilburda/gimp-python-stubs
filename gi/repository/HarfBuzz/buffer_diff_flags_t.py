...
class buffer_diff_flags_t(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'EQUAL': <buffer_diff_flags_t.EQUAL: 0>, 'CONTENT_TYPE_MISMATCH': <buffer_diff_flags_t.CONTENT_TYPE_MISMATCH: 1>, 'LENGTH_MISMATCH': <buffer_diff_flags_t.LENGTH_MISMATCH: 2>, 'NOTDEF_PRESENT': <buffer_diff_flags_t.NOTDEF_PRESENT: 4>, 'DOTTED_CIRCLE_PRESENT': <buffer_diff_flags_t.DOTTED_CIRCLE_PRESENT: 8>, 'CODEPOINT_MISMATCH': <buffer_diff_flags_t.CODEPOINT_MISMATCH: 16>, 'CLUSTER_MISMATCH': <buffer_diff_flags_t.CLUSTER_MISMATCH: 32>, 'GLYPH_FLAGS_MISMATCH': <buffer_diff_flags_t.GLYPH_FLAGS_MISMATCH: 64>, 'POSITION_MISMATCH': <buffer_diff_flags_t.POSITION_MISMATCH: 128>})"
    __name__ = 'buffer_diff_flags_t'
    __qualname__ = 'buffer_diff_flags_t'
