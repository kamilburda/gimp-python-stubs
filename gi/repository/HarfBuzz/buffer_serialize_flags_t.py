...
class buffer_serialize_flags_t(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <buffer_serialize_flags_t.DEFAULT: 0>, 'NO_CLUSTERS': <buffer_serialize_flags_t.NO_CLUSTERS: 1>, 'NO_POSITIONS': <buffer_serialize_flags_t.NO_POSITIONS: 2>, 'NO_GLYPH_NAMES': <buffer_serialize_flags_t.NO_GLYPH_NAMES: 4>, 'GLYPH_EXTENTS': <buffer_serialize_flags_t.GLYPH_EXTENTS: 8>, 'GLYPH_FLAGS': <buffer_serialize_flags_t.GLYPH_FLAGS: 16>, 'NO_ADVANCES': <buffer_serialize_flags_t.NO_ADVANCES: 32>, 'DEFINED': <buffer_serialize_flags_t.DEFINED: 63>})"
    __name__ = 'buffer_serialize_flags_t'
    __qualname__ = 'buffer_serialize_flags_t'
