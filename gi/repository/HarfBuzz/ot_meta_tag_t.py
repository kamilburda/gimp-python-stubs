...
class ot_meta_tag_t(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'B_OT_META_TAG_DESIGN_LANGUAGES': <ot_meta_tag_t.B_OT_META_TAG_DESIGN_LANGUAGES: 1684827751>, 'B_OT_META_TAG_SUPPORTED_LANGUAGES': <ot_meta_tag_t.B_OT_META_TAG_SUPPORTED_LANGUAGES: 1936485991>})"
    __name__ = 'ot_meta_tag_t'
    __qualname__ = 'ot_meta_tag_t'
