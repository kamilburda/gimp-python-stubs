...
class ot_color_palette_flags_t(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'DEFAULT': <ot_color_palette_flags_t.DEFAULT: 0>, 'USABLE_WITH_LIGHT_BACKGROUND': <ot_color_palette_flags_t.USABLE_WITH_LIGHT_BACKGROUND: 1>, 'USABLE_WITH_DARK_BACKGROUND': <ot_color_palette_flags_t.USABLE_WITH_DARK_BACKGROUND: 2>})"
    __name__ = 'ot_color_palette_flags_t'
    __qualname__ = 'ot_color_palette_flags_t'
