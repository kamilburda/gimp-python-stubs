...
class ot_var_axis_flags_t(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'B_OT_VAR_AXIS_FLAG_HIDDEN': <ot_var_axis_flags_t.B_OT_VAR_AXIS_FLAG_HIDDEN: 1>})"
    __name__ = 'ot_var_axis_flags_t'
    __qualname__ = 'ot_var_axis_flags_t'
