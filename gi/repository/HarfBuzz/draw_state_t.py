...
class draw_state_t(__gi.Struct):
    ...
    current_x = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    current_y = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    path_open = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    path_start_x = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    path_start_y = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
