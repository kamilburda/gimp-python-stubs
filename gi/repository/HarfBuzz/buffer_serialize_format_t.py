...
class buffer_serialize_format_t(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'TEXT': <buffer_serialize_format_t.TEXT: 1413830740>, 'JSON': <buffer_serialize_format_t.JSON: 1246973774>, 'INVALID': <buffer_serialize_format_t.INVALID: 0>})"
    __name__ = 'buffer_serialize_format_t'
    __qualname__ = 'buffer_serialize_format_t'
