...
class Action(Action):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e73a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 221, '__init__': <function deprecated_init.<locals>.new_init at 0x000002bfce4d61f0>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 221
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAction (3425468400)>'
