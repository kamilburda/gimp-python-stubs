...
class DrawingArea(__gi_overrides_Gtk.Widget):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17f0550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DrawingArea), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkDrawingArea (3428586960)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'widget': <property object at 0x000002bfd1770680>, 'dummy': <property object at 0x000002bfd17708b0>})"
    __firstlineno__ = 104
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkDrawingArea (3428586960)>'
    __info__ = ObjectInfo(DrawingArea)
