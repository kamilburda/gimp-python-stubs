...
class FontSelectionDialog(FontSelectionDialog):
    """
    :Constructors:
    
    ::
    
        FontSelectionDialog(**properties)
    ...
    def get_cancel_button(self): # real signature unknown; restored from __doc__
        """ get_cancel_button(self) -> Gtk.Widget """
        pass
    ...
    def get_font_selection(self): # real signature unknown; restored from __doc__
        """ get_font_selection(self) -> Gtk.Widget """
        pass
    ...
    def get_ok_button(self): # real signature unknown; restored from __doc__
        """ get_ok_button(self) -> Gtk.Widget """
        pass
    ...
    def new(self, title): # real signature unknown; restored from __doc__
        """ new(title:str) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17f2e00>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
