...
class VBox(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    @classmethod
    def new(cls, homogeneous, spacing): # real signature unknown; restored from __doc__
        """ new(homogeneous:bool, spacing:int) -> Gtk.Widget """
        pass
