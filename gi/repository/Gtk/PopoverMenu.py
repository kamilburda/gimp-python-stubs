...
class PopoverMenu(Popover):
    ...
    def new_from_model(self, relative_to=None, model): # real signature unknown; restored from __doc__
    ...
    def open_submenu(self, name): # real signature unknown; restored from __doc__
