...
class EventControllerMotion(EventController):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17efeb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventControllerMotion), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventControllerMotion (3537633152)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventControllerMotion (3537633152)>'
