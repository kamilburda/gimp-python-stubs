...
class LinkButtonClass(__gi.Struct):
    """
    :Constructors:
    ...
    _gtk_padding1 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _gtk_padding2 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _gtk_padding3 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _gtk_padding4 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
