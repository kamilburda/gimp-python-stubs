...
class DialogFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'MODAL': <DialogFlags.MODAL: 1>, 'DESTROY_WITH_PARENT': <DialogFlags.DESTROY_WITH_PARENT: 2>, 'USE_HEADER_BAR': <DialogFlags.USE_HEADER_BAR: 4>})"
    __name__ = 'DialogFlags'
    __qualname__ = 'DialogFlags'
