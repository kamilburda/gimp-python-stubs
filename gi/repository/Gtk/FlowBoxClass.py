...
class FlowBoxClass(__gi.Struct):
    """
    :Constructors:
    ...
    activate_cursor_child = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    child_activated = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    move_cursor = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    selected_children_changed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    select_all = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    toggle_cursor_child = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
