...
class MenuToolButton(__gi_overrides_Gtk.ToolButton):
    """
    :Constructors:
    
    ::
    
        MenuToolButton(**properties)
    ...
    def do_show_menu(self, *args, **kwargs): # real signature unknown
        """ show_menu(self) """
        pass
    ...
    def get_icon_widget(self): # real signature unknown; restored from __doc__
        """ get_icon_widget(self) -> Gtk.Widget or None """
        pass
    ...
    def get_label_widget(self): # real signature unknown; restored from __doc__
    ...
    def get_menu(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, icon_widget=None, label=None): # real signature unknown; restored from __doc__
        """ new(icon_widget:Gtk.Widget=None, label:str=None) -> Gtk.ToolItem """
        pass
    ...
    def set_arrow_tooltip_markup(self, markup): # real signature unknown; restored from __doc__
        """ set_arrow_tooltip_markup(self, markup:str) """
        pass

    def set_arrow_tooltip_text(self, text): # real signature unknown; restored from __doc__
    ...
    def set_icon_widget(self, icon_widget=None): # real signature unknown; restored from __doc__
    ...
    def set_label_widget(self, label_widget=None): # real signature unknown; restored from __doc__
    ...
    def set_menu(self, menu): # real signature unknown; restored from __doc__
    ...
    def set_stock_id(self, stock_id=None): # real signature unknown; restored from __doc__
