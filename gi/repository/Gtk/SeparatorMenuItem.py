...
class SeparatorMenuItem(__gi_overrides_Gtk.MenuItem):
    """
    :Constructors:
    
    ::
    
        SeparatorMenuItem(**properties)
        new() -> Gtk.Widget
    """
