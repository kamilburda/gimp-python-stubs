...
class EntryAccessible(WidgetAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.EditableText, __gi_repository_Atk.Text):
    """
    :Constructors:
    
    ::
    
        EntryAccessible(**properties)
    """
