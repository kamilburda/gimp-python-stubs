...
class RcFlags(__gi__gi.GFlags):
    ...
    __members__ = None # (!) real value is "mappingproxy({'FG': <RcFlags.FG: 1>, 'BG': <RcFlags.BG: 2>, 'TEXT': <RcFlags.TEXT: 4>, 'BASE': <RcFlags.BASE: 8>})"
    __name__ = 'RcFlags'
    __qualname__ = 'RcFlags'
