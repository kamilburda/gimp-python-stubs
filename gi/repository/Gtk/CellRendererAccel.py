...
class CellRendererAccel(CellRendererText):
    ...
    def do_accel_cleared(self, *args, **kwargs): # real signature unknown
        """ accel_cleared(self, path_string:str) """
        pass

    def do_accel_edited(self, *args, **kwargs): # real signature unknown
        """ accel_edited(self, path_string:str, accel_key:int, accel_mods:Gdk.ModifierType, hardware_keycode:int) """
        pass
