...
class ArrowAccessible(WidgetAccessible, __gi_repository_Atk.Image):
    """
    :Constructors:
    
    ::
    
        ArrowAccessible(**properties)
    """
