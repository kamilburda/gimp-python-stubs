...
class TreeModelFilter(TreeModelFilter):
    """
    :Constructors:
    ...
    def convert_iter_to_child_iter(self, filter_iter): # real signature unknown; restored from __doc__
        """ convert_iter_to_child_iter(self, filter_iter:Gtk.TreeIter) -> child_iter:Gtk.TreeIter """
        pass

    def convert_path_to_child_path(self, filter_path): # real signature unknown; restored from __doc__
        """ convert_path_to_child_path(self, filter_path:Gtk.TreePath) -> Gtk.TreePath or None """
        pass
    ...
    def do_modify(self, *args, **kwargs): # real signature unknown
        """ modify(self, child_model:Gtk.TreeModel, iter:Gtk.TreeIter, value:GObject.Value, column:int) """
        pass

    def do_visible(self, *args, **kwargs): # real signature unknown
    ...
    def refilter(self): # real signature unknown; restored from __doc__
        """ refilter(self) """
        pass
    ...
    def set_modify_func(self, types, func, data=None): # real signature unknown; restored from __doc__
    ...
    def set_value(self, iter, column, value): # reliably restored by inspect
        # no doc
        pass

    def set_visible_column(self, column): # real signature unknown; restored from __doc__
        """ set_visible_column(self, column:int) """
        pass

    def set_visible_func(self, func, data=None): # reliably restored by inspect
        # no doc
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1922b00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 1780, 'set_visible_func': <function TreeModelFilter.set_visible_func at 0x000002bfce476820>, 'set_value': <function TreeModelFilter.set_value at 0x000002bfcebc9430>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 1780
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTreeModelFilter (3426610096)>'
