...
class PlacesOpenFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NORMAL': <PlacesOpenFlags.NORMAL: 1>, 'NEW_TAB': <PlacesOpenFlags.NEW_TAB: 2>, 'NEW_WINDOW': <PlacesOpenFlags.NEW_WINDOW: 4>})"
    __name__ = 'PlacesOpenFlags'
    __qualname__ = 'PlacesOpenFlags'
