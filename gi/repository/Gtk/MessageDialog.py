...
class MessageDialog(MessageDialog, __gi_overrides_Gtk.Dialog):
    """
    :Constructors:
    ...
    def format_secondary_markup(self, message_format): # reliably restored by inspect
        # no doc
        pass

    def format_secondary_text(self, message_format): # reliably restored by inspect
        # no doc
        pass
    ...
    def set_image(self, image): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1800520>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
