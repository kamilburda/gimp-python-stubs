...
class AboutDialog(__gi_overrides_Gtk.Dialog):
    """
    :Constructors:
    ...
    def add_credit_section(self, section_name, people): # real signature unknown; restored from __doc__
    ...
    def do_activate_link(self, *args, **kwargs): # real signature unknown
    ...
    def get_documenters(self): # real signature unknown; restored from __doc__
    ...
    def get_license_type(self): # real signature unknown; restored from __doc__
    ...
    def get_logo_icon_name(self): # real signature unknown; restored from __doc__
    ...
    def get_program_name(self): # real signature unknown; restored from __doc__
    ...
    def get_translator_credits(self): # real signature unknown; restored from __doc__
    ...
    def get_website(self): # real signature unknown; restored from __doc__
        """ get_website(self) -> str """
        return ""

    def get_website_label(self): # real signature unknown; restored from __doc__
    ...
    def get_wrap_license(self): # real signature unknown; restored from __doc__
    ...
    def set_artists(self, artists): # real signature unknown; restored from __doc__
    ...
    def set_authors(self, authors): # real signature unknown; restored from __doc__
    ...
    def set_comments(self, comments=None): # real signature unknown; restored from __doc__
    ...
    def set_copyright(self, copyright=None): # real signature unknown; restored from __doc__
    ...
    def set_documenters(self, documenters): # real signature unknown; restored from __doc__
    ...
    def set_license_type(self, license_type): # real signature unknown; restored from __doc__
        """ set_license_type(self, license_type:Gtk.License) """
        pass

    def set_logo(self, logo=None): # real signature unknown; restored from __doc__
        """ set_logo(self, logo:GdkPixbuf.Pixbuf=None) """
        pass

    def set_logo_icon_name(self, icon_name=None): # real signature unknown; restored from __doc__
    ...
    def set_program_name(self, name): # real signature unknown; restored from __doc__
    ...
    def set_translator_credits(self, translator_credits=None): # real signature unknown; restored from __doc__
    ...
    def set_website(self, website=None): # real signature unknown; restored from __doc__
        """ set_website(self, website:str=None) """
        pass

    def set_website_label(self, website_label): # real signature unknown; restored from __doc__
    ...
    def set_wrap_license(self, wrap_license): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e1990>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
