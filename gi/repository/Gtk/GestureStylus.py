...
class GestureStylus(GestureSingle):
    ...
    def get_axes(self, axes): # real signature unknown; restored from __doc__
        """ get_axes(self, axes:list) -> bool, values:list """
        return False

    def get_axis(self, axis): # real signature unknown; restored from __doc__
        """ get_axis(self, axis:Gdk.AxisUse) -> bool, value:float """
        return False
    ...
    def get_device_tool(self): # real signature unknown; restored from __doc__
        """ get_device_tool(self) -> Gdk.DeviceTool or None """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1905b70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureStylus), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureStylus (3427463232)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_axes': gi.FunctionInfo(get_axes), 'get_axis': gi.FunctionInfo(get_axis), 'get_device_tool': gi.FunctionInfo(get_device_tool)})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureStylus (3427463232)>'
