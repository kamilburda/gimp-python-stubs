...
class TreeModelFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'ITERS_PERSIST': <TreeModelFlags.ITERS_PERSIST: 1>, 'LIST_ONLY': <TreeModelFlags.LIST_ONLY: 2>})"
    __name__ = 'TreeModelFlags'
    __qualname__ = 'TreeModelFlags'
