...
class EventController(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17efc10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventController), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventController (3537893360)>, '__doc__': None, '__gsignals__': {}, 'get_propagation_phase': gi.FunctionInfo(get_propagation_phase), 'get_widget': gi.FunctionInfo(get_widget), 'handle_event': gi.FunctionInfo(handle_event), 'reset': gi.FunctionInfo(reset), 'set_propagation_phase': gi.FunctionInfo(set_propagation_phase)})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventController (3537893360)>'
