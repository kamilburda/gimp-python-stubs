...
class NumerableIcon(__gi_repository_Gio.EmblemedIcon):
    """
    :Constructors:
    
    ::
    
        NumerableIcon(**properties)
    """
    def add_emblem(self, emblem): # real signature unknown; restored from __doc__
        """ add_emblem(self, emblem:Gio.Emblem) """
        pass
    ...
    def get_background_gicon(self): # real signature unknown; restored from __doc__
        """ get_background_gicon(self) -> Gio.Icon or None """
        pass

    def get_background_icon_name(self): # real signature unknown; restored from __doc__
        """ get_background_icon_name(self) -> str or None """
        return ""
    ...
    def get_emblems(self): # real signature unknown; restored from __doc__
        """ get_emblems(self) -> list """
        return []
    ...
    def get_style_context(self): # real signature unknown; restored from __doc__
        """ get_style_context(self) -> Gtk.StyleContext or None """
        pass
    ...
    def new(self, base_icon): # real signature unknown; restored from __doc__
    ...
    def new_with_style_context(self, base_icon, context): # real signature unknown; restored from __doc__
        """ new_with_style_context(base_icon:Gio.Icon, context:Gtk.StyleContext) -> Gio.Icon """
        pass
    ...
    def set_background_gicon(self, icon=None): # real signature unknown; restored from __doc__
        """ set_background_gicon(self, icon:Gio.Icon=None) """
        pass

    def set_background_icon_name(self, icon_name=None): # real signature unknown; restored from __doc__
        """ set_background_icon_name(self, icon_name:str=None) """
        pass
    ...
    def set_style_context(self, style): # real signature unknown; restored from __doc__
        """ set_style_context(self, style:Gtk.StyleContext) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1803b20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NumerableIcon), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkNumerableIcon (3413962832)>, '__doc__': None, '__gsignals__': {}, 'new': <staticmethod(gi.FunctionInfo(new))>, 'new_with_style_context': <staticmethod(gi.FunctionInfo(new_with_style_context))>, 'get_background_gicon': gi.FunctionInfo(get_background_gicon), 'get_background_icon_name': gi.FunctionInfo(get_background_icon_name), 'get_count': gi.FunctionInfo(get_count), 'get_label': gi.FunctionInfo(get_label), 'get_style_context': gi.FunctionInfo(get_style_context), 'set_background_gicon': gi.FunctionInfo(set_background_gicon), 'set_background_icon_name': gi.FunctionInfo(set_background_icon_name), 'set_count': gi.FunctionInfo(set_count), 'set_label': gi.FunctionInfo(set_label), 'set_style_context': gi.FunctionInfo(set_style_context), 'parent': <property object at 0x000002bfd18a09f0>, 'priv': <property object at 0x000002bfd18a0ae0>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkNumerableIcon (3413962832)>'
