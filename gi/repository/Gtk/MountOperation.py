...
class MountOperation(__gi_repository_Gio.MountOperation):
    """
    :Constructors:
    ...
    def is_showing(self): # real signature unknown; restored from __doc__
        """ is_showing(self) -> bool """
        return False
    ...
    def set_parent(self, parent=None): # real signature unknown; restored from __doc__
        """ set_parent(self, parent:Gtk.Window=None) """
        pass
