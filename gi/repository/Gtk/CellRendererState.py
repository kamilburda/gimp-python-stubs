...
class CellRendererState(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'SELECTED': <CellRendererState.SELECTED: 1>, 'PRELIT': <CellRendererState.PRELIT: 2>, 'INSENSITIVE': <CellRendererState.INSENSITIVE: 4>, 'SORTED': <CellRendererState.SORTED: 8>, 'FOCUSED': <CellRendererState.FOCUSED: 16>, 'EXPANDABLE': <CellRendererState.EXPANDABLE: 32>, 'EXPANDED': <CellRendererState.EXPANDED: 64>})"
    __name__ = 'CellRendererState'
    __qualname__ = 'CellRendererState'
