...
class RecentFilterFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'URI': <RecentFilterFlags.URI: 1>, 'DISPLAY_NAME': <RecentFilterFlags.DISPLAY_NAME: 2>, 'MIME_TYPE': <RecentFilterFlags.MIME_TYPE: 4>, 'APPLICATION': <RecentFilterFlags.APPLICATION: 8>, 'GROUP': <RecentFilterFlags.GROUP: 16>, 'AGE': <RecentFilterFlags.AGE: 32>})"
    __name__ = 'RecentFilterFlags'
    __qualname__ = 'RecentFilterFlags'
