...
class Frame(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17f0c70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Frame), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFrame (3417836960)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_label': gi.FunctionInfo(get_label), 'get_label_align': gi.FunctionInfo(get_label_align), 'get_label_widget': gi.FunctionInfo(get_label_widget), 'get_shadow_type': gi.FunctionInfo(get_shadow_type), 'set_label': gi.FunctionInfo(set_label), 'set_label_align': gi.FunctionInfo(set_label_align), 'set_label_widget': gi.FunctionInfo(set_label_widget), 'set_shadow_type': gi.FunctionInfo(set_shadow_type), 'do_compute_child_allocation': gi.VFuncInfo(compute_child_allocation), 'bin': <property object at 0x000002bfd17b0360>, 'priv': <property object at 0x000002bfd17b0630>})"
    __firstlineno__ = 163
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFrame (3417836960)>'
    __info__ = ObjectInfo(Frame)
