...
class RecentManager(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    """
    def add_full(self, uri, recent_data): # real signature unknown; restored from __doc__
        """ add_full(self, uri:str, recent_data:Gtk.RecentData) -> bool """
        return False

    def add_item(self, uri): # real signature unknown; restored from __doc__
    ...
    def lookup_item(self, uri): # real signature unknown; restored from __doc__
        """ lookup_item(self, uri:str) -> Gtk.RecentInfo or None """
        pass

    def move_item(self, uri, new_uri=None): # real signature unknown; restored from __doc__
    ...
    def purge_items(self): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1801630>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecentManager), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRecentManager (3540060640)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_default': <staticmethod(gi.FunctionInfo(get_default))>, 'add_full': gi.FunctionInfo(add_full), 'add_item': gi.FunctionInfo(add_item), 'get_items': gi.FunctionInfo(get_items), 'has_item': gi.FunctionInfo(has_item), 'lookup_item': gi.FunctionInfo(lookup_item), 'move_item': gi.FunctionInfo(move_item), 'purge_items': gi.FunctionInfo(purge_items), 'remove_item': gi.FunctionInfo(remove_item), 'do_changed': gi.VFuncInfo(changed), 'parent_instance': <property object at 0x000002bfd1867010>, 'priv': <property object at 0x000002bfd1867100>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRecentManager (3540060640)>'
