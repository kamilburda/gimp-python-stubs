...
class DestDefaults(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'MOTION': <DestDefaults.MOTION: 1>, 'HIGHLIGHT': <DestDefaults.HIGHLIGHT: 2>, 'DROP': <DestDefaults.DROP: 4>, 'ALL': <DestDefaults.ALL: 7>})"
    __name__ = 'DestDefaults'
    __qualname__ = 'DestDefaults'
