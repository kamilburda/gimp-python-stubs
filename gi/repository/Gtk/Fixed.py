...
class Fixed(__gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    def move(self, widget, x, y): # real signature unknown; restored from __doc__
    ...
    def put(self, widget, x, y): # real signature unknown; restored from __doc__
