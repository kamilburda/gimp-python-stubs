...
class TextCellAccessible(RendererCellAccessible, __gi_repository_Atk.Text):
    """
    :Constructors:
    
    ::
    
        TextCellAccessible(**properties)
    """
