...
class SocketAccessible(ContainerAccessible):
    ...
    def embed(self, path): # real signature unknown; restored from __doc__
        """ embed(self, path:str) """
        pass
