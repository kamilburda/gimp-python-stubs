...
class HandleBox(Bin):
    ...
    def do_child_attached(self, *args, **kwargs): # real signature unknown
        """ child_attached(self, child:Gtk.Widget) """
        pass

    def do_child_detached(self, *args, **kwargs): # real signature unknown
        """ child_detached(self, child:Gtk.Widget) """
        pass
    ...
    def get_child_detached(self): # real signature unknown; restored from __doc__
        """ get_child_detached(self) -> bool """
        return False
    ...
    def get_handle_position(self): # real signature unknown; restored from __doc__
        """ get_handle_position(self) -> Gtk.PositionType """
        pass
    ...
    def get_snap_edge(self): # real signature unknown; restored from __doc__
        """ get_snap_edge(self) -> Gtk.PositionType """
        pass
    ...
    def set_handle_position(self, position): # real signature unknown; restored from __doc__
        """ set_handle_position(self, position:Gtk.PositionType) """
        pass
    ...
    def set_snap_edge(self, edge): # real signature unknown; restored from __doc__
        """ set_snap_edge(self, edge:Gtk.PositionType) """
        pass
