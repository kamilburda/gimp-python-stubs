...
class ColorButton(__gi_overrides_Gtk.Button, ColorChooser):
    """
    :Constructors:
    ...
    def do_color_set(self, *args, **kwargs): # real signature unknown
        """ color_set(self) """
        pass
    ...
    @classmethod
    def new_with_color(cls, color): # real signature unknown; restored from __doc__
        """ new_with_color(color:Gdk.Color) -> Gtk.Widget """
        pass
    ...
    @classmethod
    def new_with_rgba(cls, rgba): # real signature unknown; restored from __doc__
        """ new_with_rgba(rgba:Gdk.RGBA) -> Gtk.Widget """
        pass
