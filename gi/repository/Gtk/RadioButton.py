...
class RadioButton(CheckButton):
    ...
    @classmethod
    def new_from_widget(cls, radio_group_member=None): # real signature unknown; restored from __doc__
        """ new_from_widget(radio_group_member:Gtk.RadioButton=None) -> Gtk.Widget """
        pass
    ...
    @classmethod
    def new_with_label_from_widget(cls, radio_group_member=None, label): # real signature unknown; restored from __doc__
        """ new_with_label_from_widget(radio_group_member:Gtk.RadioButton=None, label:str) -> Gtk.Widget """
        pass
    ...
    @classmethod
    def new_with_mnemonic_from_widget(cls, radio_group_member=None, label): # real signature unknown; restored from __doc__
        """ new_with_mnemonic_from_widget(radio_group_member:Gtk.RadioButton=None, label:str) -> Gtk.Widget """
        pass
    ...
    check_button = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    toggle_button = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
