...
class ScrolledWindowClass(__gi.Struct):
    """
    :Constructors:
    ...
    scrollbar_spacing = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    scroll_child = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
