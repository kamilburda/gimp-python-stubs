...
class Alignment(Bin):
    ...
    ::
        ...
        new(xalign:float, yalign:float, xscale:float, yscale:float) -> Gtk.Widget
    """
    ...
    def get_padding(self): # real signature unknown; restored from __doc__
        """ get_padding(self) -> padding_top:int, padding_bottom:int, padding_left:int, padding_right:int """
        pass
    ...
    @classmethod
    def new(cls, xalign, yalign, xscale, yscale): # real signature unknown; restored from __doc__
        """ new(xalign:float, yalign:float, xscale:float, yscale:float) -> Gtk.Widget """
        pass
    ...
    def set(self, xalign, yalign, xscale, yscale): # real signature unknown; restored from __doc__
        """ set(self, xalign:float, yalign:float, xscale:float, yscale:float) """
        pass
    ...
    def set_padding(self, padding_top, padding_bottom, padding_left, padding_right): # real signature unknown; restored from __doc__
        """ set_padding(self, padding_top:int, padding_bottom:int, padding_left:int, padding_right:int) """
        pass
