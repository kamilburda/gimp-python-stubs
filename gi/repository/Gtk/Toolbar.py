...
class Toolbar(__gi_overrides_Gtk.Container, Orientable, ToolShell):
    """
    :Constructors:
    ...
    def do_orientation_changed(self, *args, **kwargs): # real signature unknown
        """ orientation_changed(self, orientation:Gtk.Orientation) """
        pass
    ...
    def do_popup_context_menu(self, *args, **kwargs): # real signature unknown
        """ popup_context_menu(self, x:int, y:int, button_number:int) -> bool """
        pass
    ...
    def do_style_changed(self, *args, **kwargs): # real signature unknown
        """ style_changed(self, style:Gtk.ToolbarStyle) """
        pass
    ...
    def get_drop_index(self, x, y): # real signature unknown; restored from __doc__
    ...
    def get_item_index(self, item): # real signature unknown; restored from __doc__
    ...
    def get_nth_item(self, n): # real signature unknown; restored from __doc__
        """ get_nth_item(self, n:int) -> Gtk.ToolItem or None """
        pass
    ...
    def get_show_arrow(self): # real signature unknown; restored from __doc__
    ...
    def insert(self, item, pos): # real signature unknown; restored from __doc__
    ...
    def set_drop_highlight_item(self, tool_item=None, index_): # real signature unknown; restored from __doc__
    ...
    def set_show_arrow(self, show_arrow): # real signature unknown; restored from __doc__
