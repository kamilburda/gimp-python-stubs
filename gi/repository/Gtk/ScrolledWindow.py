...
class ScrolledWindow(ScrolledWindow):
    ...
    def new(self, hadjustment=None, vadjustment=None): # real signature unknown; restored from __doc__
        """ new(hadjustment:Gtk.Adjustment=None, vadjustment:Gtk.Adjustment=None) -> Gtk.Widget """
        pass
