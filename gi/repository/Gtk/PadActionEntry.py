...
class PadActionEntry(__gi.Struct):
    """
    :Constructors:
    ...
    action_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
