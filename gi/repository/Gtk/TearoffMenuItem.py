...
class TearoffMenuItem(__gi_overrides_Gtk.MenuItem):
    """
    :Constructors:
    
    ::
    
        TearoffMenuItem(**properties)
        new() -> Gtk.Widget
    """
