...
class Revealer(Bin):
    ...
    def get_child_revealed(self): # real signature unknown; restored from __doc__
    ...
    def get_reveal_child(self): # real signature unknown; restored from __doc__
    ...
    def set_reveal_child(self, reveal_child): # real signature unknown; restored from __doc__
