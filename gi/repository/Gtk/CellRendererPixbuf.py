...
class CellRendererPixbuf(CellRenderer):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e8ac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererPixbuf), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererPixbuf (3428545184)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'parent': <property object at 0x000002bfd178c1d0>, 'priv': <property object at 0x000002bfd178c400>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererPixbuf (3428545184)>'
