...
class ListBoxClass(__gi.Struct):
    """
    :Constructors:
    ...
    activate_cursor_row = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    row_selected = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    selected_rows_changed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
