...
class RecentChooserDialog(RecentChooserDialog):
    """
    :Constructors:
    
    ::
    
        RecentChooserDialog(**properties)
    """
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd190a2f0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
