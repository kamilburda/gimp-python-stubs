...
class Scale(Range):
    ...
    def add_mark(self, value, position, markup=None): # real signature unknown; restored from __doc__
    ...
    def clear_marks(self): # real signature unknown; restored from __doc__
        """ clear_marks(self) """
        pass
    ...
    def do_adjust_bounds(self, *args, **kwargs): # real signature unknown
    ...
    def do_draw_value(self, *args, **kwargs): # real signature unknown
        """ draw_value(self) """
        pass
    ...
    def do_format_value(self, *args, **kwargs): # real signature unknown
    ...
    def do_get_layout_offsets(self, *args, **kwargs): # real signature unknown
    ...
    def do_get_range_border(self, *args, **kwargs): # real signature unknown
        """ get_range_border(self, border_:Gtk.Border) """
        pass

    def do_get_range_size_request(self, *args, **kwargs): # real signature unknown
    ...
    def do_move_slider(self, *args, **kwargs): # real signature unknown
    ...
    def get_draw_value(self): # real signature unknown; restored from __doc__
    ...
    def get_fill_level(self): # real signature unknown; restored from __doc__
        """ get_fill_level(self) -> float """
        return 0.0

    def get_flippable(self): # real signature unknown; restored from __doc__
    ...
    def get_has_origin(self): # real signature unknown; restored from __doc__
    ...
    def get_inverted(self): # real signature unknown; restored from __doc__
    ...
    def get_lower_stepper_sensitivity(self): # real signature unknown; restored from __doc__
    ...
    def get_min_slider_size(self): # real signature unknown; restored from __doc__
    ...
    def get_range_rect(self): # real signature unknown; restored from __doc__
    ...
    def get_restrict_to_fill_level(self): # real signature unknown; restored from __doc__
    ...
    def get_round_digits(self): # real signature unknown; restored from __doc__
    ...
    def get_show_fill_level(self): # real signature unknown; restored from __doc__
    ...
    def get_slider_range(self): # real signature unknown; restored from __doc__
        """ get_slider_range(self) -> slider_start:int, slider_end:int """
        pass

    def get_slider_size_fixed(self): # real signature unknown; restored from __doc__
    ...
    def get_upper_stepper_sensitivity(self): # real signature unknown; restored from __doc__
    ...
    def get_value_pos(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, orientation, adjustment=None): # real signature unknown; restored from __doc__
        """ new(orientation:Gtk.Orientation, adjustment:Gtk.Adjustment=None) -> Gtk.Widget """
        pass
    ...
    @classmethod
    def new_with_range(cls, orientation, min, max, step): # real signature unknown; restored from __doc__
        """ new_with_range(orientation:Gtk.Orientation, min:float, max:float, step:float) -> Gtk.Widget """
        pass
    ...
    def set_draw_value(self, draw_value): # real signature unknown; restored from __doc__
    ...
    def set_fill_level(self, fill_level): # real signature unknown; restored from __doc__
        """ set_fill_level(self, fill_level:float) """
        pass

    def set_flippable(self, flippable): # real signature unknown; restored from __doc__
    ...
    def set_has_origin(self, has_origin): # real signature unknown; restored from __doc__
    ...
    def set_inverted(self, setting): # real signature unknown; restored from __doc__
        """ set_inverted(self, setting:bool) """
        pass

    def set_lower_stepper_sensitivity(self, sensitivity): # real signature unknown; restored from __doc__
    ...
    def set_min_slider_size(self, min_size): # real signature unknown; restored from __doc__
    ...
    def set_restrict_to_fill_level(self, restrict_to_fill_level): # real signature unknown; restored from __doc__
        """ set_restrict_to_fill_level(self, restrict_to_fill_level:bool) """
        pass

    def set_round_digits(self, round_digits): # real signature unknown; restored from __doc__
    ...
    def set_show_fill_level(self, show_fill_level): # real signature unknown; restored from __doc__
    ...
    def set_slider_size_fixed(self, size_fixed): # real signature unknown; restored from __doc__
    ...
    def set_upper_stepper_sensitivity(self, sensitivity): # real signature unknown; restored from __doc__
    ...
    def set_value_pos(self, pos): # real signature unknown; restored from __doc__
