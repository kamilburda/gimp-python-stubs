...
class PadController(EventController):
    ...
    ::
        ...
        new(window:Gtk.Window, group:Gio.ActionGroup, pad:Gdk.Device=None) -> Gtk.PadController
    """
    ...
    @classmethod
    def new(cls, window, group, pad=None): # real signature unknown; restored from __doc__
        """ new(window:Gtk.Window, group:Gio.ActionGroup, pad:Gdk.Device=None) -> Gtk.PadController """
        pass
    ...
    def set_action(self, type, index, mode, label, action_name): # real signature unknown; restored from __doc__
        """ set_action(self, type:Gtk.PadActionType, index:int, mode:int, label:str, action_name:str) """
        pass

    def set_action_entries(self, entries): # real signature unknown; restored from __doc__
        """ set_action_entries(self, entries:list) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd19105b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PadController), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPadController (3413970784)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'set_action': gi.FunctionInfo(set_action), 'set_action_entries': gi.FunctionInfo(set_action_entries)})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPadController (3413970784)>'
