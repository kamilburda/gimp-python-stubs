...
class Adjustment(Adjustment):
    ...
    def clamp_page(self, lower, upper): # real signature unknown; restored from __doc__
    ...
    def configure(self, value, lower, upper, step_increment, page_increment, page_size): # real signature unknown; restored from __doc__
    ...
    def get_lower(self): # real signature unknown; restored from __doc__
    ...
    def get_page_increment(self): # real signature unknown; restored from __doc__
        """ get_page_increment(self) -> float """
        return 0.0

    def get_page_size(self): # real signature unknown; restored from __doc__
    ...
    def get_step_increment(self): # real signature unknown; restored from __doc__
        """ get_step_increment(self) -> float """
        return 0.0

    def get_upper(self): # real signature unknown; restored from __doc__
    ...
    def new(self, value, lower, upper, step_increment, page_increment, page_size): # real signature unknown; restored from __doc__
        """ new(value:float, lower:float, upper:float, step_increment:float, page_increment:float, page_size:float) -> Gtk.Adjustment """
        pass
    ...
    def set_lower(self, lower): # real signature unknown; restored from __doc__
        """ set_lower(self, lower:float) """
        pass

    def set_page_increment(self, page_increment): # real signature unknown; restored from __doc__
        """ set_page_increment(self, page_increment:float) """
        pass

    def set_page_size(self, page_size): # real signature unknown; restored from __doc__
    ...
    def set_step_increment(self, step_increment): # real signature unknown; restored from __doc__
        """ set_step_increment(self, step_increment:float) """
        pass

    def set_upper(self, upper): # real signature unknown; restored from __doc__
    ...
    def value_changed(self): # real signature unknown; restored from __doc__
        """ value_changed(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e6710>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 1608, '_init': <function deprecated_init.<locals>.new_init at 0x000002bfcebc89e0>, '__init__': <function Adjustment.__init__ at 0x000002bfcebc8a90>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 1608
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAdjustment (3426563344)>'
