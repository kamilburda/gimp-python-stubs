...
class RendererCellAccessible(CellAccessible):
    ...
    ::
        ...
        RendererCellAccessible(**properties)
    ...
    @classmethod
    def new(cls, renderer): # real signature unknown; restored from __doc__
        """ new(renderer:Gtk.CellRenderer) -> Atk.Object """
        pass
