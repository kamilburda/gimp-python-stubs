...
class SeparatorToolItem(ToolItem):
    ...
    def get_draw(self): # real signature unknown; restored from __doc__
        """ get_draw(self) -> bool """
        return False
