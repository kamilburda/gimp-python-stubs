...
class FlowBox(__gi_overrides_Gtk.Container, Orientable):
    """
    :Constructors:
    ...
    def bind_model(self, model=None, create_widget_func, user_data=None): # real signature unknown; restored from __doc__
        """ bind_model(self, model:Gio.ListModel=None, create_widget_func:Gtk.FlowBoxCreateWidgetFunc, user_data=None) """
        pass
    ...
    def do_activate_cursor_child(self, *args, **kwargs): # real signature unknown
        """ activate_cursor_child(self) """
        pass
    ...
    def do_child_activated(self, *args, **kwargs): # real signature unknown
        """ child_activated(self, child:Gtk.FlowBoxChild) """
        pass
    ...
    def do_selected_children_changed(self, *args, **kwargs): # real signature unknown
        """ selected_children_changed(self) """
        pass
    ...
    def do_toggle_cursor_child(self, *args, **kwargs): # real signature unknown
        """ toggle_cursor_child(self) """
        pass
    ...
    def get_child_at_index(self, idx): # real signature unknown; restored from __doc__
        """ get_child_at_index(self, idx:int) -> Gtk.FlowBoxChild or None """
        pass

    def get_child_at_pos(self, x, y): # real signature unknown; restored from __doc__
        """ get_child_at_pos(self, x:int, y:int) -> Gtk.FlowBoxChild or None """
        pass
    ...
    def get_max_children_per_line(self): # real signature unknown; restored from __doc__
        """ get_max_children_per_line(self) -> int """
        return 0

    def get_min_children_per_line(self): # real signature unknown; restored from __doc__
    ...
    def get_selected_children(self): # real signature unknown; restored from __doc__
    ...
    def insert(self, widget, position): # real signature unknown; restored from __doc__
    ...
    def invalidate_filter(self): # real signature unknown; restored from __doc__
        """ invalidate_filter(self) """
        pass

    def invalidate_sort(self): # real signature unknown; restored from __doc__
    ...
    def selected_foreach(self, func, data=None): # real signature unknown; restored from __doc__
    ...
    def select_child(self, child): # real signature unknown; restored from __doc__
    ...
    def set_filter_func(self, filter_func=None, user_data=None): # real signature unknown; restored from __doc__
    ...
    def set_hadjustment(self, adjustment): # real signature unknown; restored from __doc__
    ...
    def set_max_children_per_line(self, n_children): # real signature unknown; restored from __doc__
        """ set_max_children_per_line(self, n_children:int) """
        pass

    def set_min_children_per_line(self, n_children): # real signature unknown; restored from __doc__
    ...
    def set_selection_mode(self, mode): # real signature unknown; restored from __doc__
    ...
    def set_sort_func(self, sort_func=None, user_data=None): # real signature unknown; restored from __doc__
    ...
    def set_vadjustment(self, adjustment): # real signature unknown; restored from __doc__
    ...
    def unselect_child(self, child): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17f5240>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FlowBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFlowBox (3427457088)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'bind_model': gi.FunctionInfo(bind_model), 'get_activate_on_single_click': gi.FunctionInfo(get_activate_on_single_click), 'get_child_at_index': gi.FunctionInfo(get_child_at_index), 'get_child_at_pos': gi.FunctionInfo(get_child_at_pos), 'get_column_spacing': gi.FunctionInfo(get_column_spacing), 'get_homogeneous': gi.FunctionInfo(get_homogeneous), 'get_max_children_per_line': gi.FunctionInfo(get_max_children_per_line), 'get_min_children_per_line': gi.FunctionInfo(get_min_children_per_line), 'get_row_spacing': gi.FunctionInfo(get_row_spacing), 'get_selected_children': gi.FunctionInfo(get_selected_children), 'get_selection_mode': gi.FunctionInfo(get_selection_mode), 'insert': gi.FunctionInfo(insert), 'invalidate_filter': gi.FunctionInfo(invalidate_filter), 'invalidate_sort': gi.FunctionInfo(invalidate_sort), 'select_all': gi.FunctionInfo(select_all), 'select_child': gi.FunctionInfo(select_child), 'selected_foreach': gi.FunctionInfo(selected_foreach), 'set_activate_on_single_click': gi.FunctionInfo(set_activate_on_single_click), 'set_column_spacing': gi.FunctionInfo(set_column_spacing), 'set_filter_func': gi.FunctionInfo(set_filter_func), 'set_hadjustment': gi.FunctionInfo(set_hadjustment), 'set_homogeneous': gi.FunctionInfo(set_homogeneous), 'set_max_children_per_line': gi.FunctionInfo(set_max_children_per_line), 'set_min_children_per_line': gi.FunctionInfo(set_min_children_per_line), 'set_row_spacing': gi.FunctionInfo(set_row_spacing), 'set_selection_mode': gi.FunctionInfo(set_selection_mode), 'set_sort_func': gi.FunctionInfo(set_sort_func), 'set_vadjustment': gi.FunctionInfo(set_vadjustment), 'unselect_all': gi.FunctionInfo(unselect_all), 'unselect_child': gi.FunctionInfo(unselect_child), 'do_activate_cursor_child': gi.VFuncInfo(activate_cursor_child), 'do_child_activated': gi.VFuncInfo(child_activated), 'do_move_cursor': gi.VFuncInfo(move_cursor), 'do_select_all': gi.VFuncInfo(select_all), 'do_selected_children_changed': gi.VFuncInfo(selected_children_changed), 'do_toggle_cursor_child': gi.VFuncInfo(toggle_cursor_child), 'do_unselect_all': gi.VFuncInfo(unselect_all), 'container': <property object at 0x000002bfd18fe660>})"
    __firstlineno__ = 163
    __gdoc__ = "Object GtkFlowBox\n\nSignals from GtkFlowBox:\n  move-cursor (GtkMovementStep, gint) -> gboolean\n  child-activated (GtkFlowBoxChild)\n  selected-children-changed ()\n  activate-cursor-child ()\n  toggle-cursor-child ()\n  select-all ()\n  unselect-all ()\n\nProperties from GtkFlowBox:\n  homogeneous -> gboolean: Homogeneous\n    Whether the children should all be the same size\n  column-spacing -> guint: Horizontal spacing\n    The amount of horizontal space between two children\n  row-spacing -> guint: Vertical spacing\n    The amount of vertical space between two children\n  min-children-per-line -> guint: Minimum Children Per Line\n    The minimum number of children to allocate consecutively in the given orientation.\n  max-children-per-line -> guint: Maximum Children Per Line\n    The maximum amount of children to request space for consecutively in the given orientation.\n  selection-mode -> GtkSelectionMode: Selection mode\n    The selection mode\n  activate-on-single-click -> gboolean: Activate on Single Click\n    Activate row on a single click\n\nSignals from GtkContainer:\n  add (GtkWidget)\n  remove (GtkWidget)\n  check-resize ()\n  set-focus-child (GtkWidget)\n\nProperties from GtkContainer:\n  border-width -> guint: Border width\n    The width of the empty border outside the containers children\n  resize-mode -> GtkResizeMode: Resize mode\n    Specify how resize events are handled\n  child -> GtkWidget: Child\n    Can be used to add a new child to the container\n\nSignals from GtkWidget:\n  direction-changed (GtkTextDirection)\n  state-changed (GtkStateType)\n  composited-changed ()\n  destroy ()\n  show ()\n  hide ()\n  map ()\n  unmap ()\n  realize ()\n  unrealize ()\n  size-allocate (GdkRectangle)\n  state-flags-changed (GtkStateFlags)\n  parent-set (GtkWidget)\n  hierarchy-changed (GtkWidget)\n  style-set (GtkStyle)\n  style-updated ()\n  grab-notify (gboolean)\n  child-notify (GParam)\n  draw (CairoContext) -> gboolean\n  mnemonic-activate (gboolean) -> gboolean\n  grab-focus ()\n  focus (GtkDirectionType) -> gboolean\n  move-focus (GtkDirectionType)\n  keynav-failed (GtkDirectionType) -> gboolean\n  event (GdkEvent) -> gboolean\n  event-after (GdkEvent)\n  button-press-event (GdkEvent) -> gboolean\n  button-release-event (GdkEvent) -> gboolean\n  touch-event (GdkEvent) -> gboolean\n  scroll-event (GdkEvent) -> gboolean\n  motion-notify-event (GdkEvent) -> gboolean\n  delete-event (GdkEvent) -> gboolean\n  destroy-event (GdkEvent) -> gboolean\n  key-press-event (GdkEvent) -> gboolean\n  key-release-event (GdkEvent) -> gboolean\n  enter-notify-event (GdkEvent) -> gboolean\n  leave-notify-event (GdkEvent) -> gboolean\n  configure-event (GdkEvent) -> gboolean\n  focus-in-event (GdkEvent) -> gboolean\n  focus-out-event (GdkEvent) -> gboolean\n  map-event (GdkEvent) -> gboolean\n  unmap-event (GdkEvent) -> gboolean\n  property-notify-event (GdkEvent) -> gboolean\n  selection-clear-event (GdkEvent) -> gboolean\n  selection-request-event (GdkEvent) -> gboolean\n  selection-notify-event (GdkEvent) -> gboolean\n  selection-received (GtkSelectionData, guint)\n  selection-get (GtkSelectionData, guint, guint)\n  proximity-in-event (GdkEvent) -> gboolean\n  proximity-out-event (GdkEvent) -> gboolean\n  drag-leave (GdkDragContext, guint)\n  drag-begin (GdkDragContext)\n  drag-end (GdkDragContext)\n  drag-data-delete (GdkDragContext)\n  drag-failed (GdkDragContext, GtkDragResult) -> gboolean\n  drag-motion (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-drop (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-data-get (GdkDragContext, GtkSelectionData, guint, guint)\n  drag-data-received (GdkDragContext, gint, gint, GtkSelectionData, guint, guint)\n  visibility-notify-event (GdkEvent) -> gboolean\n  window-state-event (GdkEvent) -> gboolean\n  damage-event (GdkEvent) -> gboolean\n  grab-broken-event (GdkEvent) -> gboolean\n  query-tooltip (gint, gint, gboolean, GtkTooltip) -> gboolean\n  popup-menu () -> gboolean\n  show-help (GtkWidgetHelpType) -> gboolean\n  accel-closures-changed ()\n  screen-changed (GdkScreen)\n  can-activate-accel (guint) -> gboolean\n\nProperties from GtkWidget:\n  name -> gchararray: Widget name\n    The name of the widget\n  parent -> GtkContainer: Parent widget\n    The parent widget of this widget. Must be a Container widget\n  width-request -> gint: Width request\n    Override for width request of the widget, or -1 if natural request should be used\n  height-request -> gint: Height request\n    Override for height request of the widget, or -1 if natural request should be used\n  visible -> gboolean: Visible\n    Whether the widget is visible\n  sensitive -> gboolean: Sensitive\n    Whether the widget responds to input\n  app-paintable -> gboolean: Application paintable\n    Whether the application will paint directly on the widget\n  can-focus -> gboolean: Can focus\n    Whether the widget can accept the input focus\n  has-focus -> gboolean: Has focus\n    Whether the widget has the input focus\n  is-focus -> gboolean: Is focus\n    Whether the widget is the focus widget within the toplevel\n  focus-on-click -> gboolean: Focus on click\n    Whether the widget should grab focus when it is clicked with the mouse\n  can-default -> gboolean: Can default\n    Whether the widget can be the default widget\n  has-default -> gboolean: Has default\n    Whether the widget is the default widget\n  receives-default -> gboolean: Receives default\n    If TRUE, the widget will receive the default action when it is focused\n  composite-child -> gboolean: Composite child\n    Whether the widget is part of a composite widget\n  style -> GtkStyle: Style\n    The style of the widget, which contains information about how it will look (colors etc)\n  events -> GdkEventMask: Events\n    The event mask that decides what kind of GdkEvents this widget gets\n  no-show-all -> gboolean: No show all\n    Whether gtk_widget_show_all() should not affect this widget\n  has-tooltip -> gboolean: Has tooltip\n    Whether this widget has a tooltip\n  tooltip-markup -> gchararray: Tooltip markup\n    The contents of the tooltip for this widget\n  tooltip-text -> gchararray: Tooltip Text\n    The contents of the tooltip for this widget\n  window -> GdkWindow: Window\n    The widget's window if it is realized\n  opacity -> gdouble: Opacity for Widget\n    The opacity of the widget, from 0 to 1\n  double-buffered -> gboolean: Double Buffered\n    Whether the widget is double buffered\n  halign -> GtkAlign: Horizontal Alignment\n    How to position in extra horizontal space\n  valign -> GtkAlign: Vertical Alignment\n    How to position in extra vertical space\n  margin-left -> gint: Margin on Left\n    Pixels of extra space on the left side\n  margin-right -> gint: Margin on Right\n    Pixels of extra space on the right side\n  margin-start -> gint: Margin on Start\n    Pixels of extra space on the start\n  margin-end -> gint: Margin on End\n    Pixels of extra space on the end\n  margin-top -> gint: Margin on Top\n    Pixels of extra space on the top side\n  margin-bottom -> gint: Margin on Bottom\n    Pixels of extra space on the bottom side\n  margin -> gint: All Margins\n    Pixels of extra space on all four sides\n  hexpand -> gboolean: Horizontal Expand\n    Whether widget wants more horizontal space\n  vexpand -> gboolean: Vertical Expand\n    Whether widget wants more vertical space\n  hexpand-set -> gboolean: Horizontal Expand Set\n    Whether to use the hexpand property\n  vexpand-set -> gboolean: Vertical Expand Set\n    Whether to use the vexpand property\n  expand -> gboolean: Expand Both\n    Whether widget wants to expand in both directions\n  scale-factor -> gint: Scale factor\n    The scaling factor of the window\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFlowBox (3427457088)>'
    __info__ = ObjectInfo(FlowBox)
