...
class RecentAction(__gi_overrides_Gtk.Action, RecentChooser):
    ...
    @classmethod
    def new_for_manager(cls, name, label=None, tooltip=None, stock_id=None, manager=None): # real signature unknown; restored from __doc__
        """ new_for_manager(name:str, label:str=None, tooltip:str=None, stock_id:str=None, manager:Gtk.RecentManager=None) -> Gtk.Action """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1918190>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecentAction), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRecentAction (3537592384)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'new_for_manager': <classmethod(gi.FunctionInfo(new_for_manager))>, 'get_show_numbers': gi.FunctionInfo(get_show_numbers), 'set_show_numbers': gi.FunctionInfo(set_show_numbers), 'parent_instance': <property object at 0x000002bfd18731f0>, 'priv': <property object at 0x000002bfd1873dd0>})"
    __firstlineno__ = 221
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRecentAction (3537592384)>'
