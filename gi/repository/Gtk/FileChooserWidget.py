...
class FileChooserWidget(__gi_overrides_Gtk.Box, FileChooser):
    """
    :Constructors:
    ...
    @classmethod
    def new(cls, action): # real signature unknown; restored from __doc__
        """ new(action:Gtk.FileChooserAction) -> Gtk.Widget """
        pass
