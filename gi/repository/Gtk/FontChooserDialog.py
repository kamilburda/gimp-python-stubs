...
class FontChooserDialog(__gi_overrides_Gtk.Dialog, FontChooser):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e5630>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
