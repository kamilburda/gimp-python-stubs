...
class EditableInterface(__gi.Struct):
    """
    :Constructors:
    ...
    do_delete_text = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    do_insert_text = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_chars = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_position = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_selection_bounds = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    set_selection_bounds = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
