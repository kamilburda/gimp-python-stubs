...
class SizeGroup(SizeGroup):
    ...
    def add_widget(self, widget): # real signature unknown; restored from __doc__
    ...
    def get_ignore_hidden(self): # real signature unknown; restored from __doc__
    ...
    def get_widgets(self): # real signature unknown; restored from __doc__
    ...
    def new(self, mode): # real signature unknown; restored from __doc__
        """ new(mode:Gtk.SizeGroupMode) -> Gtk.SizeGroup """
        pass
    ...
    def remove_widget(self, widget): # real signature unknown; restored from __doc__
    ...
    def set_ignore_hidden(self, ignore_hidden): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd190c130>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 474, '__init__': <function deprecated_init.<locals>.new_init at 0x000002bfce4d68d0>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 474
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSizeGroup (3416384400)>'
