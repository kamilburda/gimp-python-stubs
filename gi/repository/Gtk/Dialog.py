...
class Dialog(Dialog, __gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e3550>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 582, '_old_arg_names': ('title', 'parent', 'flags', 'buttons', '_buttons_property'), '_init': <function deprecated_init.<locals>.new_init at 0x000002bfce4d6e50>, '__init__': <function Dialog.__init__ at 0x000002bfce4d6f00>, 'run': <function Dialog.run at 0x000002bfce4d6fb0>, 'action_area': <property object at 0x000002bfcebdee80>, 'vbox': <property object at 0x000002bfcebdeed0>, 'add_buttons': <function Dialog.add_buttons at 0x000002bfce4d71c0>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 582
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkDialog (3425520080)>'
