...
class FontSelection(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        FontSelection(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_face_list(self): # real signature unknown; restored from __doc__
        """ get_face_list(self) -> Gtk.Widget """
        pass
    ...
    def get_family_list(self): # real signature unknown; restored from __doc__
        """ get_family_list(self) -> Gtk.Widget """
        pass
    ...
    def get_preview_entry(self): # real signature unknown; restored from __doc__
        """ get_preview_entry(self) -> Gtk.Widget """
        pass
    ...
    def get_size_entry(self): # real signature unknown; restored from __doc__
        """ get_size_entry(self) -> Gtk.Widget """
        pass

    def get_size_list(self): # real signature unknown; restored from __doc__
        """ get_size_list(self) -> Gtk.Widget """
        pass
