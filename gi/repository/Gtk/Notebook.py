...
class Notebook(__gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1908700>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Notebook), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkNotebook (3417829920)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'append_page': gi.FunctionInfo(append_page), 'append_page_menu': gi.FunctionInfo(append_page_menu), 'detach_tab': gi.FunctionInfo(detach_tab), 'get_action_widget': gi.FunctionInfo(get_action_widget), 'get_current_page': gi.FunctionInfo(get_current_page), 'get_group_name': gi.FunctionInfo(get_group_name), 'get_menu_label': gi.FunctionInfo(get_menu_label), 'get_menu_label_text': gi.FunctionInfo(get_menu_label_text), 'get_n_pages': gi.FunctionInfo(get_n_pages), 'get_nth_page': gi.FunctionInfo(get_nth_page), 'get_scrollable': gi.FunctionInfo(get_scrollable), 'get_show_border': gi.FunctionInfo(get_show_border), 'get_show_tabs': gi.FunctionInfo(get_show_tabs), 'get_tab_detachable': gi.FunctionInfo(get_tab_detachable), 'get_tab_hborder': gi.FunctionInfo(get_tab_hborder), 'get_tab_label': gi.FunctionInfo(get_tab_label), 'get_tab_label_text': gi.FunctionInfo(get_tab_label_text), 'get_tab_pos': gi.FunctionInfo(get_tab_pos), 'get_tab_reorderable': gi.FunctionInfo(get_tab_reorderable), 'get_tab_vborder': gi.FunctionInfo(get_tab_vborder), 'insert_page': gi.FunctionInfo(insert_page), 'insert_page_menu': gi.FunctionInfo(insert_page_menu), 'next_page': gi.FunctionInfo(next_page), 'page_num': gi.FunctionInfo(page_num), 'popup_disable': gi.FunctionInfo(popup_disable), 'popup_enable': gi.FunctionInfo(popup_enable), 'prepend_page': gi.FunctionInfo(prepend_page), 'prepend_page_menu': gi.FunctionInfo(prepend_page_menu), 'prev_page': gi.FunctionInfo(prev_page), 'remove_page': gi.FunctionInfo(remove_page), 'reorder_child': gi.FunctionInfo(reorder_child), 'set_action_widget': gi.FunctionInfo(set_action_widget), 'set_current_page': gi.FunctionInfo(set_current_page), 'set_group_name': gi.FunctionInfo(set_group_name), 'set_menu_label': gi.FunctionInfo(set_menu_label), 'set_menu_label_text': gi.FunctionInfo(set_menu_label_text), 'set_scrollable': gi.FunctionInfo(set_scrollable), 'set_show_border': gi.FunctionInfo(set_show_border), 'set_show_tabs': gi.FunctionInfo(set_show_tabs), 'set_tab_detachable': gi.FunctionInfo(set_tab_detachable), 'set_tab_label': gi.FunctionInfo(set_tab_label), 'set_tab_label_text': gi.FunctionInfo(set_tab_label_text), 'set_tab_pos': gi.FunctionInfo(set_tab_pos), 'set_tab_reorderable': gi.FunctionInfo(set_tab_reorderable), 'do_change_current_page': gi.VFuncInfo(change_current_page), 'do_focus_tab': gi.VFuncInfo(focus_tab), 'do_insert_page': gi.VFuncInfo(insert_page), 'do_move_focus_out': gi.VFuncInfo(move_focus_out), 'do_page_added': gi.VFuncInfo(page_added), 'do_page_removed': gi.VFuncInfo(page_removed), 'do_page_reordered': gi.VFuncInfo(page_reordered), 'do_reorder_tab': gi.VFuncInfo(reorder_tab), 'do_select_page': gi.VFuncInfo(select_page), 'do_switch_page': gi.VFuncInfo(switch_page), 'container': <property object at 0x000002bfd18aa660>, 'priv': <property object at 0x000002bfd18aa750>})"
    __firstlineno__ = 163
    __gdoc__ = "Object GtkNotebook\n\nSignals from GtkNotebook:\n  switch-page (GtkWidget, guint)\n  focus-tab (GtkNotebookTab) -> gboolean\n  select-page (gboolean) -> gboolean\n  change-current-page (gint) -> gboolean\n  move-focus-out (GtkDirectionType)\n  reorder-tab (GtkDirectionType, gboolean) -> gboolean\n  page-reordered (GtkWidget, guint)\n  page-removed (GtkWidget, guint)\n  page-added (GtkWidget, guint)\n  create-window (GtkWidget, gint, gint) -> GtkNotebook\n\nProperties from GtkNotebook:\n  tab-pos -> GtkPositionType: Tab Position\n    Which side of the notebook holds the tabs\n  show-tabs -> gboolean: Show Tabs\n    Whether tabs should be shown\n  show-border -> gboolean: Show Border\n    Whether the border should be shown\n  scrollable -> gboolean: Scrollable\n    If TRUE, scroll arrows are added if there are too many tabs to fit\n  page -> gint: Page\n    The index of the current page\n  enable-popup -> gboolean: Enable Popup\n    If TRUE, pressing the right mouse button on the notebook pops up a menu that you can use to go to a page\n  group-name -> gchararray: Group Name\n    Group name for tab drag and drop\n\nSignals from GtkContainer:\n  add (GtkWidget)\n  remove (GtkWidget)\n  check-resize ()\n  set-focus-child (GtkWidget)\n\nProperties from GtkContainer:\n  border-width -> guint: Border width\n    The width of the empty border outside the containers children\n  resize-mode -> GtkResizeMode: Resize mode\n    Specify how resize events are handled\n  child -> GtkWidget: Child\n    Can be used to add a new child to the container\n\nSignals from GtkWidget:\n  direction-changed (GtkTextDirection)\n  state-changed (GtkStateType)\n  composited-changed ()\n  destroy ()\n  show ()\n  hide ()\n  map ()\n  unmap ()\n  realize ()\n  unrealize ()\n  size-allocate (GdkRectangle)\n  state-flags-changed (GtkStateFlags)\n  parent-set (GtkWidget)\n  hierarchy-changed (GtkWidget)\n  style-set (GtkStyle)\n  style-updated ()\n  grab-notify (gboolean)\n  child-notify (GParam)\n  draw (CairoContext) -> gboolean\n  mnemonic-activate (gboolean) -> gboolean\n  grab-focus ()\n  focus (GtkDirectionType) -> gboolean\n  move-focus (GtkDirectionType)\n  keynav-failed (GtkDirectionType) -> gboolean\n  event (GdkEvent) -> gboolean\n  event-after (GdkEvent)\n  button-press-event (GdkEvent) -> gboolean\n  button-release-event (GdkEvent) -> gboolean\n  touch-event (GdkEvent) -> gboolean\n  scroll-event (GdkEvent) -> gboolean\n  motion-notify-event (GdkEvent) -> gboolean\n  delete-event (GdkEvent) -> gboolean\n  destroy-event (GdkEvent) -> gboolean\n  key-press-event (GdkEvent) -> gboolean\n  key-release-event (GdkEvent) -> gboolean\n  enter-notify-event (GdkEvent) -> gboolean\n  leave-notify-event (GdkEvent) -> gboolean\n  configure-event (GdkEvent) -> gboolean\n  focus-in-event (GdkEvent) -> gboolean\n  focus-out-event (GdkEvent) -> gboolean\n  map-event (GdkEvent) -> gboolean\n  unmap-event (GdkEvent) -> gboolean\n  property-notify-event (GdkEvent) -> gboolean\n  selection-clear-event (GdkEvent) -> gboolean\n  selection-request-event (GdkEvent) -> gboolean\n  selection-notify-event (GdkEvent) -> gboolean\n  selection-received (GtkSelectionData, guint)\n  selection-get (GtkSelectionData, guint, guint)\n  proximity-in-event (GdkEvent) -> gboolean\n  proximity-out-event (GdkEvent) -> gboolean\n  drag-leave (GdkDragContext, guint)\n  drag-begin (GdkDragContext)\n  drag-end (GdkDragContext)\n  drag-data-delete (GdkDragContext)\n  drag-failed (GdkDragContext, GtkDragResult) -> gboolean\n  drag-motion (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-drop (GdkDragContext, gint, gint, guint) -> gboolean\n  drag-data-get (GdkDragContext, GtkSelectionData, guint, guint)\n  drag-data-received (GdkDragContext, gint, gint, GtkSelectionData, guint, guint)\n  visibility-notify-event (GdkEvent) -> gboolean\n  window-state-event (GdkEvent) -> gboolean\n  damage-event (GdkEvent) -> gboolean\n  grab-broken-event (GdkEvent) -> gboolean\n  query-tooltip (gint, gint, gboolean, GtkTooltip) -> gboolean\n  popup-menu () -> gboolean\n  show-help (GtkWidgetHelpType) -> gboolean\n  accel-closures-changed ()\n  screen-changed (GdkScreen)\n  can-activate-accel (guint) -> gboolean\n\nProperties from GtkWidget:\n  name -> gchararray: Widget name\n    The name of the widget\n  parent -> GtkContainer: Parent widget\n    The parent widget of this widget. Must be a Container widget\n  width-request -> gint: Width request\n    Override for width request of the widget, or -1 if natural request should be used\n  height-request -> gint: Height request\n    Override for height request of the widget, or -1 if natural request should be used\n  visible -> gboolean: Visible\n    Whether the widget is visible\n  sensitive -> gboolean: Sensitive\n    Whether the widget responds to input\n  app-paintable -> gboolean: Application paintable\n    Whether the application will paint directly on the widget\n  can-focus -> gboolean: Can focus\n    Whether the widget can accept the input focus\n  has-focus -> gboolean: Has focus\n    Whether the widget has the input focus\n  is-focus -> gboolean: Is focus\n    Whether the widget is the focus widget within the toplevel\n  focus-on-click -> gboolean: Focus on click\n    Whether the widget should grab focus when it is clicked with the mouse\n  can-default -> gboolean: Can default\n    Whether the widget can be the default widget\n  has-default -> gboolean: Has default\n    Whether the widget is the default widget\n  receives-default -> gboolean: Receives default\n    If TRUE, the widget will receive the default action when it is focused\n  composite-child -> gboolean: Composite child\n    Whether the widget is part of a composite widget\n  style -> GtkStyle: Style\n    The style of the widget, which contains information about how it will look (colors etc)\n  events -> GdkEventMask: Events\n    The event mask that decides what kind of GdkEvents this widget gets\n  no-show-all -> gboolean: No show all\n    Whether gtk_widget_show_all() should not affect this widget\n  has-tooltip -> gboolean: Has tooltip\n    Whether this widget has a tooltip\n  tooltip-markup -> gchararray: Tooltip markup\n    The contents of the tooltip for this widget\n  tooltip-text -> gchararray: Tooltip Text\n    The contents of the tooltip for this widget\n  window -> GdkWindow: Window\n    The widget's window if it is realized\n  opacity -> gdouble: Opacity for Widget\n    The opacity of the widget, from 0 to 1\n  double-buffered -> gboolean: Double Buffered\n    Whether the widget is double buffered\n  halign -> GtkAlign: Horizontal Alignment\n    How to position in extra horizontal space\n  valign -> GtkAlign: Vertical Alignment\n    How to position in extra vertical space\n  margin-left -> gint: Margin on Left\n    Pixels of extra space on the left side\n  margin-right -> gint: Margin on Right\n    Pixels of extra space on the right side\n  margin-start -> gint: Margin on Start\n    Pixels of extra space on the start\n  margin-end -> gint: Margin on End\n    Pixels of extra space on the end\n  margin-top -> gint: Margin on Top\n    Pixels of extra space on the top side\n  margin-bottom -> gint: Margin on Bottom\n    Pixels of extra space on the bottom side\n  margin -> gint: All Margins\n    Pixels of extra space on all four sides\n  hexpand -> gboolean: Horizontal Expand\n    Whether widget wants more horizontal space\n  vexpand -> gboolean: Vertical Expand\n    Whether widget wants more vertical space\n  hexpand-set -> gboolean: Horizontal Expand Set\n    Whether to use the hexpand property\n  vexpand-set -> gboolean: Vertical Expand Set\n    Whether to use the vexpand property\n  expand -> gboolean: Expand Both\n    Whether widget wants to expand in both directions\n  scale-factor -> gint: Scale factor\n    The scaling factor of the window\n\nSignals from GObject:\n  notify (GParam)\n\n"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkNotebook (3417829920)>'
    __info__ = ObjectInfo(Notebook)
