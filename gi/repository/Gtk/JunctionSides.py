...
class JunctionSides(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <JunctionSides.NONE: 0>, 'CORNER_TOPLEFT': <JunctionSides.CORNER_TOPLEFT: 1>, 'CORNER_TOPRIGHT': <JunctionSides.CORNER_TOPRIGHT: 2>, 'CORNER_BOTTOMLEFT': <JunctionSides.CORNER_BOTTOMLEFT: 4>, 'CORNER_BOTTOMRIGHT': <JunctionSides.CORNER_BOTTOMRIGHT: 8>, 'TOP': <JunctionSides.TOP: 3>, 'BOTTOM': <JunctionSides.BOTTOM: 12>, 'LEFT': <JunctionSides.LEFT: 5>, 'RIGHT': <JunctionSides.RIGHT: 10>})"
    __name__ = 'JunctionSides'
    __qualname__ = 'JunctionSides'
