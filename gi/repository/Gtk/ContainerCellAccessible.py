...
class ContainerCellAccessible(CellAccessible):
    ...
    ::
        ...
        ContainerCellAccessible(**properties)
        new() -> Gtk.ContainerCellAccessible
    """
    def add_child(self, child): # real signature unknown; restored from __doc__
        """ add_child(self, child:Gtk.CellAccessible) """
        pass
    ...
    def remove_child(self, child): # real signature unknown; restored from __doc__
        """ remove_child(self, child:Gtk.CellAccessible) """
        pass
