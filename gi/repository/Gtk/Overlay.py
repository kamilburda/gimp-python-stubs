...
class Overlay(Bin):
    ...
    def add_overlay(self, widget): # real signature unknown; restored from __doc__
    ...
    def do_get_child_position(self, *args, **kwargs): # real signature unknown
        """ get_child_position(self, widget:Gtk.Widget, allocation:Gdk.Rectangle) -> bool """
        pass
    ...
    def get_overlay_pass_through(self, widget): # real signature unknown; restored from __doc__
    ...
    def reorder_overlay(self, child, index_): # real signature unknown; restored from __doc__
        """ reorder_overlay(self, child:Gtk.Widget, index_:int) """
        pass
    ...
    def set_overlay_pass_through(self, widget, pass_through): # real signature unknown; restored from __doc__
