...
class AttachOptions(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'EXPAND': <AttachOptions.EXPAND: 1>, 'SHRINK': <AttachOptions.SHRINK: 2>, 'FILL': <AttachOptions.FILL: 4>})"
    __name__ = 'AttachOptions'
    __qualname__ = 'AttachOptions'
