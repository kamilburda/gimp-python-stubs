...
class RegionFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'EVEN': <RegionFlags.EVEN: 1>, 'ODD': <RegionFlags.ODD: 2>, 'FIRST': <RegionFlags.FIRST: 4>, 'LAST': <RegionFlags.LAST: 8>, 'ONLY': <RegionFlags.ONLY: 16>, 'SORTED': <RegionFlags.SORTED: 32>})"
    __name__ = 'RegionFlags'
    __qualname__ = 'RegionFlags'
