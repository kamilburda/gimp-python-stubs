...
class GesturePan(GestureDrag):
    ...
    def get_start_point(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, widget, orientation): # real signature unknown; restored from __doc__
        """ new(widget:Gtk.Widget, orientation:Gtk.Orientation) -> Gtk.Gesture """
        pass
