...
class Window(Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e1ab0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 568, '__init__': <function Window.__init__ at 0x000002bfce4d6da0>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 568
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkWindow (3415956432)>'
