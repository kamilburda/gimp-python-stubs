...
class HBox(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17fdb70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHBox (3427459392)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'box': <property object at 0x000002bfd18f22a0>})"
    __firstlineno__ = 461
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHBox (3427459392)>'
    __info__ = ObjectInfo(HBox)
