...
class ColorSelection(__gi_overrides_Gtk.Box):
    ...
    def do_color_changed(self, *args, **kwargs): # real signature unknown
        """ color_changed(self) """
        pass
    ...
    def get_current_alpha(self): # real signature unknown; restored from __doc__
        """ get_current_alpha(self) -> int """
        return 0

    def get_current_color(self): # real signature unknown; restored from __doc__
        """ get_current_color(self) -> color:Gdk.Color """
        pass

    def get_current_rgba(self): # real signature unknown; restored from __doc__
        """ get_current_rgba(self) -> rgba:Gdk.RGBA """
        pass
    ...
    def get_has_opacity_control(self): # real signature unknown; restored from __doc__
        """ get_has_opacity_control(self) -> bool """
        return False

    def get_has_palette(self): # real signature unknown; restored from __doc__
        """ get_has_palette(self) -> bool """
        return False
    ...
    def get_previous_alpha(self): # real signature unknown; restored from __doc__
        """ get_previous_alpha(self) -> int """
        return 0

    def get_previous_color(self): # real signature unknown; restored from __doc__
        """ get_previous_color(self) -> color:Gdk.Color """
        pass

    def get_previous_rgba(self): # real signature unknown; restored from __doc__
        """ get_previous_rgba(self) -> rgba:Gdk.RGBA """
        pass
    ...
    def is_adjusting(self): # real signature unknown; restored from __doc__
        """ is_adjusting(self) -> bool """
        return False
    ...
    def palette_from_string(self, p_str): # real signature unknown; restored from __doc__
        """ palette_from_string(str:str) -> bool, colors:list """
        return False

    def palette_to_string(self, colors): # real signature unknown; restored from __doc__
        """ palette_to_string(colors:list) -> str """
        return ""
    ...
    def set_current_alpha(self, alpha): # real signature unknown; restored from __doc__
        """ set_current_alpha(self, alpha:int) """
        pass

    def set_current_color(self, color): # real signature unknown; restored from __doc__
        """ set_current_color(self, color:Gdk.Color) """
        pass

    def set_current_rgba(self, rgba): # real signature unknown; restored from __doc__
        """ set_current_rgba(self, rgba:Gdk.RGBA) """
        pass
    ...
    def set_has_opacity_control(self, has_opacity): # real signature unknown; restored from __doc__
        """ set_has_opacity_control(self, has_opacity:bool) """
        pass

    def set_has_palette(self, has_palette): # real signature unknown; restored from __doc__
        """ set_has_palette(self, has_palette:bool) """
        pass
    ...
    def set_previous_alpha(self, alpha): # real signature unknown; restored from __doc__
        """ set_previous_alpha(self, alpha:int) """
        pass

    def set_previous_color(self, color): # real signature unknown; restored from __doc__
        """ set_previous_color(self, color:Gdk.Color) """
        pass

    def set_previous_rgba(self, rgba): # real signature unknown; restored from __doc__
        """ set_previous_rgba(self, rgba:Gdk.RGBA) """
        pass
