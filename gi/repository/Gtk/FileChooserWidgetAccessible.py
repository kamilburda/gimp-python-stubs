...
class FileChooserWidgetAccessible(ContainerAccessible, __gi_repository_Atk.Action):
    """
    :Constructors:
    
    ::
    
        FileChooserWidgetAccessible(**properties)
    """
