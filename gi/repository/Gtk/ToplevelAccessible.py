...
class ToplevelAccessible(__gi_repository_Atk.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1920520>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToplevelAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToplevelAccessible (3426672048)>, '__doc__': None, '__gsignals__': {}, 'get_children': gi.FunctionInfo(get_children), 'parent': <property object at 0x000002bfd3a2c270>, 'priv': <property object at 0x000002bfd3a2c4a0>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToplevelAccessible (3426672048)>'
