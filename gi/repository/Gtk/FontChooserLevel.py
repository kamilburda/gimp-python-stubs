...
class FontChooserLevel(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'FAMILY': <FontChooserLevel.FAMILY: 0>, 'STYLE': <FontChooserLevel.STYLE: 1>, 'SIZE': <FontChooserLevel.SIZE: 2>, 'VARIATIONS': <FontChooserLevel.VARIATIONS: 4>, 'FEATURES': <FontChooserLevel.FEATURES: 8>})"
    __name__ = 'FontChooserLevel'
    __qualname__ = 'FontChooserLevel'
