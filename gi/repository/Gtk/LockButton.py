...
class LockButton(__gi_overrides_Gtk.Button):
    """
    :Constructors:
    ...
    @classmethod
    def new(cls, permission=None): # real signature unknown; restored from __doc__
        """ new(permission:Gio.Permission=None) -> Gtk.Widget """
        pass
    ...
    def set_permission(self, permission=None): # real signature unknown; restored from __doc__
