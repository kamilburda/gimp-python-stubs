...
class TargetFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'SAME_APP': <TargetFlags.SAME_APP: 1>, 'SAME_WIDGET': <TargetFlags.SAME_WIDGET: 2>, 'OTHER_APP': <TargetFlags.OTHER_APP: 4>, 'OTHER_WIDGET': <TargetFlags.OTHER_WIDGET: 8>})"
    __name__ = 'TargetFlags'
    __qualname__ = 'TargetFlags'
