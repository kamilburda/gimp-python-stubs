...
class RecentFilter(__gi_repository_GObject.InitiallyUnowned, Buildable):
    """
    :Constructors:
    
    ::
    
        RecentFilter(**properties)
        new() -> Gtk.RecentFilter
    """
    def add_age(self, days): # real signature unknown; restored from __doc__
        """ add_age(self, days:int) """
        pass

    def add_application(self, application): # real signature unknown; restored from __doc__
    ...
    def add_custom(self, needed, func, data=None): # real signature unknown; restored from __doc__
    ...
    def add_mime_type(self, mime_type): # real signature unknown; restored from __doc__
        """ add_mime_type(self, mime_type:str) """
        pass

    def add_pattern(self, pattern): # real signature unknown; restored from __doc__
        """ add_pattern(self, pattern:str) """
        pass

    def add_pixbuf_formats(self): # real signature unknown; restored from __doc__
    ...
    def filter(self, filter_info): # real signature unknown; restored from __doc__
    ...
    def get_needed(self): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17fd450>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecentFilter), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRecentFilter (3414091168)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'add_age': gi.FunctionInfo(add_age), 'add_application': gi.FunctionInfo(add_application), 'add_custom': gi.FunctionInfo(add_custom), 'add_group': gi.FunctionInfo(add_group), 'add_mime_type': gi.FunctionInfo(add_mime_type), 'add_pattern': gi.FunctionInfo(add_pattern), 'add_pixbuf_formats': gi.FunctionInfo(add_pixbuf_formats), 'filter': gi.FunctionInfo(filter), 'get_name': gi.FunctionInfo(get_name), 'get_needed': gi.FunctionInfo(get_needed), 'set_name': gi.FunctionInfo(set_name)})"
    __firstlineno__ = 651
    __gdoc__ = 'Object GtkRecentFilter\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRecentFilter (3414091168)>'
