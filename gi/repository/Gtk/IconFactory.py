...
class IconFactory(__gi_overrides_GObject.Object, Buildable):
    """
    :Constructors:
    
    ::
    
        IconFactory(**properties)
        new() -> Gtk.IconFactory
    """
    def add(self, stock_id, icon_set): # real signature unknown; restored from __doc__
        """ add(self, stock_id:str, icon_set:Gtk.IconSet) """
        pass
    ...
    def add_default(self): # real signature unknown; restored from __doc__
        """ add_default(self) """
        pass
    ...
    def lookup(self, stock_id): # real signature unknown; restored from __doc__
        """ lookup(self, stock_id:str) -> Gtk.IconSet """
        pass

    def lookup_default(self, stock_id): # real signature unknown; restored from __doc__
        """ lookup_default(stock_id:str) -> Gtk.IconSet """
        pass
    ...
    def remove_default(self): # real signature unknown; restored from __doc__
        """ remove_default(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1907760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IconFactory), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkIconFactory (3538512704)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'lookup_default': <staticmethod(gi.FunctionInfo(lookup_default))>, 'add': gi.FunctionInfo(add), 'add_default': gi.FunctionInfo(add_default), 'lookup': gi.FunctionInfo(lookup), 'remove_default': gi.FunctionInfo(remove_default), 'parent_instance': <property object at 0x000002bfd18dfe20>, 'priv': <property object at 0x000002bfd18d8090>})"
    __firstlineno__ = 651
    __gdoc__ = 'Object GtkIconFactory\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkIconFactory (3538512704)>'
