...
class InputHints(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <InputHints.NONE: 0>, 'SPELLCHECK': <InputHints.SPELLCHECK: 1>, 'NO_SPELLCHECK': <InputHints.NO_SPELLCHECK: 2>, 'WORD_COMPLETION': <InputHints.WORD_COMPLETION: 4>, 'LOWERCASE': <InputHints.LOWERCASE: 8>, 'UPPERCASE_CHARS': <InputHints.UPPERCASE_CHARS: 16>, 'UPPERCASE_WORDS': <InputHints.UPPERCASE_WORDS: 32>, 'UPPERCASE_SENTENCES': <InputHints.UPPERCASE_SENTENCES: 64>, 'INHIBIT_OSK': <InputHints.INHIBIT_OSK: 128>, 'VERTICAL_WRITING': <InputHints.VERTICAL_WRITING: 256>, 'EMOJI': <InputHints.EMOJI: 512>, 'NO_EMOJI': <InputHints.NO_EMOJI: 1024>})"
    __name__ = 'InputHints'
    __qualname__ = 'InputHints'
