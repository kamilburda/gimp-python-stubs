...
class EventControllerScroll(EventController):
    ...
    ::
        ...
        new(widget:Gtk.Widget, flags:Gtk.EventControllerScrollFlags) -> Gtk.EventController
    """
    ...
    def get_flags(self): # real signature unknown; restored from __doc__
        """ get_flags(self) -> Gtk.EventControllerScrollFlags """
        pass
    ...
    @classmethod
    def new(cls, widget, flags): # real signature unknown; restored from __doc__
        """ new(widget:Gtk.Widget, flags:Gtk.EventControllerScrollFlags) -> Gtk.EventController """
        pass
    ...
    def set_flags(self, flags): # real signature unknown; restored from __doc__
        """ set_flags(self, flags:Gtk.EventControllerScrollFlags) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17ef4c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventControllerScroll), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventControllerScroll (3537632368)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_flags': gi.FunctionInfo(get_flags), 'set_flags': gi.FunctionInfo(set_flags)})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventControllerScroll (3537632368)>'
