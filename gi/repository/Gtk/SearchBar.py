...
class SearchBar(Bin):
    ...
    def connect_entry(self, entry): # real signature unknown; restored from __doc__
    ...
    def get_search_mode(self): # real signature unknown; restored from __doc__
    ...
    def set_search_mode(self, search_mode): # real signature unknown; restored from __doc__
    ...
    def set_show_close_button(self, visible): # real signature unknown; restored from __doc__
