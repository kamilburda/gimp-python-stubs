...
class UIManager(UIManager):
    ...
    def add_ui(self, merge_id, path, name, action=None, type, top): # real signature unknown; restored from __doc__
        """ add_ui(self, merge_id:int, path:str, name:str, action:str=None, type:Gtk.UIManagerItemType, top:bool) """
        pass

    def add_ui_from_file(self, filename): # real signature unknown; restored from __doc__
        """ add_ui_from_file(self, filename:str) -> int """
        return 0

    def add_ui_from_resource(self, resource_path): # real signature unknown; restored from __doc__
        """ add_ui_from_resource(self, resource_path:str) -> int """
        return 0

    def add_ui_from_string(self, buffer): # reliably restored by inspect
        # no doc
        pass
    ...
    def do_actions_changed(self, *args, **kwargs): # real signature unknown
        """ actions_changed(self) """
        pass

    def do_add_widget(self, *args, **kwargs): # real signature unknown
        """ add_widget(self, widget:Gtk.Widget) """
        pass

    def do_connect_proxy(self, *args, **kwargs): # real signature unknown
        """ connect_proxy(self, action:Gtk.Action, proxy:Gtk.Widget) """
        pass
    ...
    def do_disconnect_proxy(self, *args, **kwargs): # real signature unknown
        """ disconnect_proxy(self, action:Gtk.Action, proxy:Gtk.Widget) """
        pass
    ...
    def do_get_action(self, *args, **kwargs): # real signature unknown
        """ get_action(self, path:str) -> Gtk.Action """
        pass

    def do_get_widget(self, *args, **kwargs): # real signature unknown
        """ get_widget(self, path:str) -> Gtk.Widget """
        pass

    def do_post_activate(self, *args, **kwargs): # real signature unknown
        """ post_activate(self, action:Gtk.Action) """
        pass

    def do_pre_activate(self, *args, **kwargs): # real signature unknown
        """ pre_activate(self, action:Gtk.Action) """
        pass
    ...
    def ensure_update(self): # real signature unknown; restored from __doc__
        """ ensure_update(self) """
        pass
    ...
    def get_action(self, path): # real signature unknown; restored from __doc__
        """ get_action(self, path:str) -> Gtk.Action """
        pass

    def get_action_groups(self): # real signature unknown; restored from __doc__
        """ get_action_groups(self) -> list """
        return []
    ...
    def get_toplevels(self, types): # real signature unknown; restored from __doc__
        """ get_toplevels(self, types:Gtk.UIManagerItemType) -> list """
        return []

    def get_ui(self): # real signature unknown; restored from __doc__
        """ get_ui(self) -> str """
        return ""

    def get_widget(self, path): # real signature unknown; restored from __doc__
        """ get_widget(self, path:str) -> Gtk.Widget """
        pass
    ...
    def insert_action_group(self, buffer, length=-1): # reliably restored by inspect
        # no doc
        pass
    ...
    def new_merge_id(self): # real signature unknown; restored from __doc__
        """ new_merge_id(self) -> int """
        return 0
    ...
    def remove_action_group(self, action_group): # real signature unknown; restored from __doc__
        """ remove_action_group(self, action_group:Gtk.ActionGroup) """
        pass

    def remove_ui(self, merge_id): # real signature unknown; restored from __doc__
        """ remove_ui(self, merge_id:int) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd190f010>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 435, 'add_ui_from_string': <function UIManager.add_ui_from_string at 0x000002bfce4d6610>, 'insert_action_group': <function UIManager.insert_action_group at 0x000002bfce4d66c0>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 435
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkUIManager (3425866688)>'
