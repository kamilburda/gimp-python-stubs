...
class FileChooserButton(__gi_overrides_Gtk.Box, FileChooser):
    """
    :Constructors:
    ...
    def do_file_set(self, *args, **kwargs): # real signature unknown
        """ file_set(self) """
        pass
    ...
    @classmethod
    def new(cls, title, action): # real signature unknown; restored from __doc__
        """ new(title:str, action:Gtk.FileChooserAction) -> Gtk.Widget """
        pass
    ...
    @classmethod
    def new_with_dialog(cls, dialog): # real signature unknown; restored from __doc__
        """ new_with_dialog(dialog:Gtk.Dialog) -> Gtk.Widget """
        pass
