...
class StyleContextPrintFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <StyleContextPrintFlags.NONE: 0>, 'RECURSE': <StyleContextPrintFlags.RECURSE: 1>, 'SHOW_STYLE': <StyleContextPrintFlags.SHOW_STYLE: 2>})"
    __name__ = 'StyleContextPrintFlags'
    __qualname__ = 'StyleContextPrintFlags'
