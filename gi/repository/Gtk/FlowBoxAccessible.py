...
class FlowBoxAccessible(ContainerAccessible, __gi_repository_Atk.Selection):
    """
    :Constructors:
    
    ::
    
        FlowBoxAccessible(**properties)
    """
