...
class HScale(Scale):
    ...
    ::
        ...
        HScale(**properties)
        new(adjustment:Gtk.Adjustment=None) -> Gtk.Widget
    ...
    @classmethod
    def new(cls, adjustment=None): # real signature unknown; restored from __doc__
        """ new(adjustment:Gtk.Adjustment=None) -> Gtk.Widget """
        pass
