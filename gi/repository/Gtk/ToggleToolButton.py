...
class ToggleToolButton(__gi_overrides_Gtk.ToolButton):
    """
    :Constructors:
    
    ::
    
        ToggleToolButton(**properties)
        new() -> Gtk.ToolItem
