...
class TableRowCol(__gi.Struct):
    ...
    expand = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    need_expand = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    need_shrink = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
