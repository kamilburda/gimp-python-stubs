...
class NativeDialog(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e68f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NativeDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkNativeDialog (3537895376)>, '__doc__': None, '__gsignals__': {}, 'destroy': gi.FunctionInfo(destroy), 'get_modal': gi.FunctionInfo(get_modal), 'get_title': gi.FunctionInfo(get_title), 'get_transient_for': gi.FunctionInfo(get_transient_for), 'get_visible': gi.FunctionInfo(get_visible), 'hide': gi.FunctionInfo(hide), 'run': gi.FunctionInfo(run), 'set_modal': gi.FunctionInfo(set_modal), 'set_title': gi.FunctionInfo(set_title), 'set_transient_for': gi.FunctionInfo(set_transient_for), 'show': gi.FunctionInfo(show), 'do_hide': gi.VFuncInfo(hide), 'do_response': gi.VFuncInfo(response), 'do_show': gi.VFuncInfo(show), 'parent_instance': <property object at 0x000002bfd18fc400>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkNativeDialog (3537895376)>'
