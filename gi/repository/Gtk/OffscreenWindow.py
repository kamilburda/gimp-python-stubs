...
class OffscreenWindow(__gi_overrides_Gtk.Window):
    """
    :Constructors:
    
    ::
    
        OffscreenWindow(**properties)
        new() -> Gtk.Widget
    """
    ...
    def get_surface(self): # real signature unknown; restored from __doc__
        """ get_surface(self) -> cairo.Surface or None """
        pass
