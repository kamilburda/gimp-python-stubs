...
class ImageMenuItem(__gi_overrides_Gtk.MenuItem):
    """
    :Constructors:
    
    ::
    
        ImageMenuItem(**properties)
        new() -> Gtk.Widget
        new_from_stock(stock_id:str, accel_group:Gtk.AccelGroup=None) -> Gtk.Widget
    ...
    @classmethod
    def new_from_stock(cls, stock_id, accel_group=None): # real signature unknown; restored from __doc__
        """ new_from_stock(stock_id:str, accel_group:Gtk.AccelGroup=None) -> Gtk.Widget """
        pass

    @classmethod
    def new_with_label(cls, label): # real signature unknown; restored from __doc__
        """ new_with_label(label:str) -> Gtk.Widget """
        pass

    @classmethod
    def new_with_mnemonic(cls, label): # real signature unknown; restored from __doc__
        """ new_with_mnemonic(label:str) -> Gtk.Widget """
        pass
    ...
    def set_accel_group(self, accel_group): # real signature unknown; restored from __doc__
        """ set_accel_group(self, accel_group:Gtk.AccelGroup) """
        pass
