...
class ListBox(__gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    def bind_model(self, model=None, create_widget_func=None, user_data=None): # real signature unknown; restored from __doc__
    ...
    def do_activate_cursor_row(self, *args, **kwargs): # real signature unknown
        """ activate_cursor_row(self) """
        pass
    ...
    def do_move_cursor(self, *args, **kwargs): # real signature unknown
        """ move_cursor(self, step:Gtk.MovementStep, count:int) """
        pass
    ...
    def do_row_activated(self, *args, **kwargs): # real signature unknown
        """ row_activated(self, row:Gtk.ListBoxRow) """
        pass

    def do_row_selected(self, *args, **kwargs): # real signature unknown
        """ row_selected(self, row:Gtk.ListBoxRow) """
        pass
    ...
    def do_selected_rows_changed(self, *args, **kwargs): # real signature unknown
        """ selected_rows_changed(self) """
        pass
    ...
    def drag_highlight_row(self, row): # real signature unknown; restored from __doc__
    ...
    def drag_unhighlight_row(self): # real signature unknown; restored from __doc__
    ...
    def get_row_at_y(self, y): # real signature unknown; restored from __doc__
    ...
    def get_selected_row(self): # real signature unknown; restored from __doc__
    ...
    def invalidate_headers(self): # real signature unknown; restored from __doc__
    ...
    def select_row(self, row=None): # real signature unknown; restored from __doc__
    ...
    def set_adjustment(self, adjustment=None): # real signature unknown; restored from __doc__
    ...
    def set_header_func(self, update_header=None, user_data=None): # real signature unknown; restored from __doc__
    ...
    def set_placeholder(self, placeholder=None): # real signature unknown; restored from __doc__
    ...
    def unselect_row(self, row): # real signature unknown; restored from __doc__
