...
class ToolButton(ToolButton):
    ...
    def new(self, icon_widget=None, label=None): # real signature unknown; restored from __doc__
        """ new(icon_widget:Gtk.Widget=None, label:str=None) -> Gtk.ToolItem """
        pass
