...
class ToolPaletteDragTargets(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'ITEMS': <ToolPaletteDragTargets.ITEMS: 1>, 'GROUPS': <ToolPaletteDragTargets.GROUPS: 2>})"
    __name__ = 'ToolPaletteDragTargets'
    __qualname__ = 'ToolPaletteDragTargets'
