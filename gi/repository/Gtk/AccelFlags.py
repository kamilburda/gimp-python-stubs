...
class AccelFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'VISIBLE': <AccelFlags.VISIBLE: 1>, 'LOCKED': <AccelFlags.LOCKED: 2>, 'MASK': <AccelFlags.MASK: 7>})"
    __name__ = 'AccelFlags'
    __qualname__ = 'AccelFlags'
