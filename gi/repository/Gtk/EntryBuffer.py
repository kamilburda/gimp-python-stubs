...
class EntryBuffer(__gi_overrides_GObject.Object):
    ...
    def delete_text(self, position, n_chars): # real signature unknown; restored from __doc__
    ...
    def do_deleted_text(self, *args, **kwargs): # real signature unknown
        """ deleted_text(self, position:int, n_chars:int) """
        pass

    def do_delete_text(self, *args, **kwargs): # real signature unknown
        """ delete_text(self, position:int, n_chars:int) -> int """
        pass
    ...
    def do_get_length(self, *args, **kwargs): # real signature unknown
        """ get_length(self) -> int """
        pass

    def do_get_text(self, *args, **kwargs): # real signature unknown
        """ get_text(self, n_bytes:int) -> str """
        pass

    def do_inserted_text(self, *args, **kwargs): # real signature unknown
    ...
    def emit_deleted_text(self, position, n_chars): # real signature unknown; restored from __doc__
        """ emit_deleted_text(self, position:int, n_chars:int) """
        pass

    def emit_inserted_text(self, position, chars, n_chars): # real signature unknown; restored from __doc__
    ...
    def insert_text(self, position, chars, n_chars): # real signature unknown; restored from __doc__
        """ insert_text(self, position:int, chars:str, n_chars:int) -> int """
        return 0
    ...
    @classmethod
    def new(cls, initial_chars=None, n_initial_chars): # real signature unknown; restored from __doc__
        """ new(initial_chars:str=None, n_initial_chars:int) -> Gtk.EntryBuffer """
        pass
    ...
    def set_max_length(self, max_length): # real signature unknown; restored from __doc__
    ...
    def set_text(self, chars, n_chars): # real signature unknown; restored from __doc__
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEntryBuffer (3537893936)>'
