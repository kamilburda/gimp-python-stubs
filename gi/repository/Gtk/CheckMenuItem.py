...
class CheckMenuItem(__gi_overrides_Gtk.MenuItem):
    """
    :Constructors:
    
    ::
    
        CheckMenuItem(**properties)
        new() -> Gtk.Widget
