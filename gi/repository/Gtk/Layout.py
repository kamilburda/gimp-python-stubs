...
class Layout(__gi_overrides_Gtk.Container, Scrollable):
    """
    :Constructors:
    ...
    def move(self, child_widget, x, y): # real signature unknown; restored from __doc__
        """ move(self, child_widget:Gtk.Widget, x:int, y:int) """
        pass

    @classmethod
    def new(cls, hadjustment=None, vadjustment=None): # real signature unknown; restored from __doc__
        """ new(hadjustment:Gtk.Adjustment=None, vadjustment:Gtk.Adjustment=None) -> Gtk.Widget """
        pass
    ...
    def put(self, child_widget, x, y): # real signature unknown; restored from __doc__
