...
class BuildableIface(__gi.Struct):
    """
    :Constructors:
    ...
    construct_child = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    custom_finished = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    custom_tag_end = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    custom_tag_start = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    parser_finished = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    set_buildable_property = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
