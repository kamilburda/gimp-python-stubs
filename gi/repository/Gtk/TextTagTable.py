...
class TextTagTable(__gi_overrides_GObject.Object, Buildable):
    """
    :Constructors:
    ...
    """
    def add(self, tag): # real signature unknown; restored from __doc__
    ...
    def do_tag_added(self, *args, **kwargs): # real signature unknown
        """ tag_added(self, tag:Gtk.TextTag) """
        pass

    def do_tag_changed(self, *args, **kwargs): # real signature unknown
        """ tag_changed(self, tag:Gtk.TextTag, size_changed:bool) """
        pass

    def do_tag_removed(self, *args, **kwargs): # real signature unknown
        """ tag_removed(self, tag:Gtk.TextTag) """
        pass
    ...
    def foreach(self, func, data=None): # real signature unknown; restored from __doc__
    ...
    def lookup(self, name): # real signature unknown; restored from __doc__
        """ lookup(self, name:str) -> Gtk.TextTag or None """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1909e40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TextTagTable), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTextTagTable (3414248880)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'add': gi.FunctionInfo(add), 'foreach': gi.FunctionInfo(foreach), 'get_size': gi.FunctionInfo(get_size), 'lookup': gi.FunctionInfo(lookup), 'remove': gi.FunctionInfo(remove), 'do_tag_added': gi.VFuncInfo(tag_added), 'do_tag_changed': gi.VFuncInfo(tag_changed), 'do_tag_removed': gi.VFuncInfo(tag_removed), 'parent_instance': <property object at 0x000002bfd3a17150>, 'priv': <property object at 0x000002bfd3a17240>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTextTagTable (3414248880)>'
