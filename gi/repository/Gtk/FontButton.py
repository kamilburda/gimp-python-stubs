...
class FontButton(__gi_overrides_Gtk.Button, FontChooser):
    """
    :Constructors:
    ...
    def do_font_set(self, *args, **kwargs): # real signature unknown
        """ font_set(self) """
        pass
    ...
    def get_show_size(self): # real signature unknown; restored from __doc__
        """ get_show_size(self) -> bool """
        return False

    def get_show_style(self): # real signature unknown; restored from __doc__
    ...
    def get_use_font(self): # real signature unknown; restored from __doc__
        """ get_use_font(self) -> bool """
        return False

    def get_use_size(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new_with_font(cls, fontname): # real signature unknown; restored from __doc__
        """ new_with_font(fontname:str) -> Gtk.Widget """
        pass
    ...
    def set_font_name(self, fontname): # real signature unknown; restored from __doc__
    ...
    def set_show_size(self, show_size): # real signature unknown; restored from __doc__
        """ set_show_size(self, show_size:bool) """
        pass

    def set_show_style(self, show_style): # real signature unknown; restored from __doc__
    ...
    def set_use_font(self, use_font): # real signature unknown; restored from __doc__
        """ set_use_font(self, use_font:bool) """
        pass

    def set_use_size(self, use_size): # real signature unknown; restored from __doc__
