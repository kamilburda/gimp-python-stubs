...
class ProgressBar(__gi_overrides_Gtk.Widget, Orientable):
    """
    :Constructors:
    ...
    def get_fraction(self): # real signature unknown; restored from __doc__
    ...
    def get_pulse_step(self): # real signature unknown; restored from __doc__
    ...
    def get_show_text(self): # real signature unknown; restored from __doc__
    ...
    def pulse(self): # real signature unknown; restored from __doc__
        """ pulse(self) """
        pass
    ...
    def set_fraction(self, fraction): # real signature unknown; restored from __doc__
    ...
    def set_pulse_step(self, fraction): # real signature unknown; restored from __doc__
    ...
    def set_show_text(self, show_text): # real signature unknown; restored from __doc__
