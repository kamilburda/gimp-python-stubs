...
class NotebookPageAccessible(__gi_repository_Atk.Object, __gi_repository_Atk.Component):
    """
    :Constructors:
    
    ::
    
        NotebookPageAccessible(**properties)
        new(notebook:Gtk.NotebookAccessible, child:Gtk.Widget) -> Atk.Object
    """
    ...
    @classmethod
    def new(cls, notebook, child): # real signature unknown; restored from __doc__
        """ new(notebook:Gtk.NotebookAccessible, child:Gtk.Widget) -> Atk.Object """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd190fd30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NotebookPageAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkNotebookPageAccessible (3413963056)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'invalidate': gi.FunctionInfo(invalidate), 'parent': <property object at 0x000002bfd18a0040>, 'priv': <property object at 0x000002bfd18a0180>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkNotebookPageAccessible (3413963056)>'
