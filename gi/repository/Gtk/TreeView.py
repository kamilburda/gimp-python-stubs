...
class TreeView(TreeView, __gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    def append_column(self, column): # real signature unknown; restored from __doc__
    ...
    def collapse_all(self): # real signature unknown; restored from __doc__
        """ collapse_all(self) """
        pass

    def collapse_row(self, path): # real signature unknown; restored from __doc__
        """ collapse_row(self, path:Gtk.TreePath) -> bool """
        return False

    def columns_autosize(self): # real signature unknown; restored from __doc__
    ...
    def convert_bin_window_to_tree_coords(self, bx, by): # real signature unknown; restored from __doc__
        """ convert_bin_window_to_tree_coords(self, bx:int, by:int) -> tx:int, ty:int """
        pass

    def convert_bin_window_to_widget_coords(self, bx, by): # real signature unknown; restored from __doc__
        """ convert_bin_window_to_widget_coords(self, bx:int, by:int) -> wx:int, wy:int """
        pass

    def convert_tree_to_bin_window_coords(self, tx, ty): # real signature unknown; restored from __doc__
        """ convert_tree_to_bin_window_coords(self, tx:int, ty:int) -> bx:int, by:int """
        pass

    def convert_tree_to_widget_coords(self, tx, ty): # real signature unknown; restored from __doc__
        """ convert_tree_to_widget_coords(self, tx:int, ty:int) -> wx:int, wy:int """
        pass

    def convert_widget_to_bin_window_coords(self, wx, wy): # real signature unknown; restored from __doc__
        """ convert_widget_to_bin_window_coords(self, wx:int, wy:int) -> bx:int, by:int """
        pass

    def convert_widget_to_tree_coords(self, wx, wy): # real signature unknown; restored from __doc__
    ...
    def create_row_drag_icon(self, path): # real signature unknown; restored from __doc__
    ...
    def do_columns_changed(self, *args, **kwargs): # real signature unknown
    ...
    def do_cursor_changed(self, *args, **kwargs): # real signature unknown
        """ cursor_changed(self) """
        pass
    ...
    def do_expand_collapse_cursor_row(self, *args, **kwargs): # real signature unknown
    ...
    def do_move_cursor(self, *args, **kwargs): # real signature unknown
        """ move_cursor(self, step:Gtk.MovementStep, count:int) -> bool """
        pass
    ...
    def do_row_activated(self, *args, **kwargs): # real signature unknown
        """ row_activated(self, path:Gtk.TreePath, column:Gtk.TreeViewColumn) """
        pass

    def do_row_collapsed(self, *args, **kwargs): # real signature unknown
        """ row_collapsed(self, iter:Gtk.TreeIter, path:Gtk.TreePath) """
        pass

    def do_row_expanded(self, *args, **kwargs): # real signature unknown
    ...
    def do_select_all(self, *args, **kwargs): # real signature unknown
        """ select_all(self) -> bool """
        pass

    def do_select_cursor_parent(self, *args, **kwargs): # real signature unknown
        """ select_cursor_parent(self) -> bool """
        pass

    def do_select_cursor_row(self, *args, **kwargs): # real signature unknown
    ...
    def do_start_interactive_search(self, *args, **kwargs): # real signature unknown
    ...
    def do_test_collapse_row(self, *args, **kwargs): # real signature unknown
        """ test_collapse_row(self, iter:Gtk.TreeIter, path:Gtk.TreePath) -> bool """
        pass

    def do_test_expand_row(self, *args, **kwargs): # real signature unknown
        """ test_expand_row(self, iter:Gtk.TreeIter, path:Gtk.TreePath) -> bool """
        pass

    def do_toggle_cursor_row(self, *args, **kwargs): # real signature unknown
    ...
    def do_unselect_all(self, *args, **kwargs): # real signature unknown
    ...
    def enable_model_drag_dest(self, targets, actions): # reliably restored by inspect
        # no doc
        pass

    def enable_model_drag_source(self, start_button_mask, targets, actions): # reliably restored by inspect
        # no doc
        pass
    ...
    def expand_all(self): # real signature unknown; restored from __doc__
        """ expand_all(self) """
        pass

    def expand_row(self, path, open_all): # real signature unknown; restored from __doc__
        """ expand_row(self, path:Gtk.TreePath, open_all:bool) -> bool """
        return False

    def expand_to_path(self, path): # real signature unknown; restored from __doc__
    ...
    def get_activate_on_single_click(self): # real signature unknown; restored from __doc__
    ...
    def get_background_area(self, path=None, column=None): # real signature unknown; restored from __doc__
        """ get_background_area(self, path:Gtk.TreePath=None, column:Gtk.TreeViewColumn=None) -> rect:Gdk.Rectangle """
        pass

    def get_bin_window(self): # real signature unknown; restored from __doc__
        """ get_bin_window(self) -> Gdk.Window or None """
        pass
    ...
    def get_cell_area(self, path, column=None): # reliably restored by inspect
        # no doc
        pass
    ...
    def get_column(self, n): # real signature unknown; restored from __doc__
        """ get_column(self, n:int) -> Gtk.TreeViewColumn or None """
        pass
    ...
    def get_dest_row_at_pos(*args, **kwargs): # reliably restored by inspect
    ...
    def get_drag_dest_row(self): # real signature unknown; restored from __doc__
        """ get_drag_dest_row(self) -> path:Gtk.TreePath, pos:Gtk.TreeViewDropPosition """
        pass

    def get_enable_search(self): # real signature unknown; restored from __doc__
        """ get_enable_search(self) -> bool """
        return False

    def get_enable_tree_lines(self): # real signature unknown; restored from __doc__
    ...
    def get_expander_column(self): # real signature unknown; restored from __doc__
        """ get_expander_column(self) -> Gtk.TreeViewColumn """
        pass

    def get_fixed_height_mode(self): # real signature unknown; restored from __doc__
    ...
    def get_grid_lines(self): # real signature unknown; restored from __doc__
    ...
    def get_headers_clickable(self): # real signature unknown; restored from __doc__
        """ get_headers_clickable(self) -> bool """
        return False

    def get_headers_visible(self): # real signature unknown; restored from __doc__
    ...
    def get_hover_expand(self): # real signature unknown; restored from __doc__
        """ get_hover_expand(self) -> bool """
        return False

    def get_hover_selection(self): # real signature unknown; restored from __doc__
    ...
    def get_level_indentation(self): # real signature unknown; restored from __doc__
    ...
    def get_path_at_pos(*args, **kwargs): # reliably restored by inspect
    ...
    def get_rubber_banding(self): # real signature unknown; restored from __doc__
        """ get_rubber_banding(self) -> bool """
        return False

    def get_rules_hint(self): # real signature unknown; restored from __doc__
    ...
    def get_search_column(self): # real signature unknown; restored from __doc__
        """ get_search_column(self) -> int """
        return 0

    def get_search_entry(self): # real signature unknown; restored from __doc__
    ...
    def get_show_expanders(self): # real signature unknown; restored from __doc__
    ...
    def get_tooltip_column(self): # real signature unknown; restored from __doc__
        """ get_tooltip_column(self) -> int """
        return 0

    def get_tooltip_context(self, x, y, keyboard_tip): # real signature unknown; restored from __doc__
    ...
    def get_visible_range(*args, **kwargs): # reliably restored by inspect
    ...
    def insert_column(self, column, position): # real signature unknown; restored from __doc__
        """ insert_column(self, column:Gtk.TreeViewColumn, position:int) -> int """
        return 0

    def insert_column_with_attributes(self, position, title, cell, **kwargs): # reliably restored by inspect
        # no doc
        pass

    def insert_column_with_data_func(self, position, title, cell, func, data=None): # real signature unknown; restored from __doc__
    ...
    def is_blank_at_pos(self, x, y): # real signature unknown; restored from __doc__
    ...
    def is_rubber_banding_active(self): # real signature unknown; restored from __doc__
    ...
    def map_expanded_rows(self, func, data=None): # real signature unknown; restored from __doc__
    ...
    def move_column_after(self, column, base_column=None): # real signature unknown; restored from __doc__
    ...
    def new_with_model(self, model): # real signature unknown; restored from __doc__
        """ new_with_model(model:Gtk.TreeModel) -> Gtk.Widget """
        pass
    ...
    def remove_column(self, column): # real signature unknown; restored from __doc__
    ...
    def row_activated(self, path, column): # real signature unknown; restored from __doc__
        """ row_activated(self, path:Gtk.TreePath, column:Gtk.TreeViewColumn) """
        pass

    def row_expanded(self, path): # real signature unknown; restored from __doc__
    ...
    def scroll_to_cell(self, path, column=None, use_align=False, row_align=0.0, col_align=0.0): # reliably restored by inspect
        # no doc
        pass

    def scroll_to_point(self, tree_x, tree_y): # real signature unknown; restored from __doc__
    ...
    def set_activate_on_single_click(self, single): # real signature unknown; restored from __doc__
    ...
    def set_column_drag_function(self, func=None, user_data=None): # real signature unknown; restored from __doc__
    ...
    def set_cursor(self, path, column=None, start_editing=False): # reliably restored by inspect
        # no doc
        pass

    def set_cursor_on_cell(self, path, focus_column=None, focus_cell=None, start_editing): # real signature unknown; restored from __doc__
    ...
    def set_destroy_count_func(self, func=None, data=None): # real signature unknown; restored from __doc__
    ...
    def set_drag_dest_row(self, path=None, pos): # real signature unknown; restored from __doc__
        """ set_drag_dest_row(self, path:Gtk.TreePath=None, pos:Gtk.TreeViewDropPosition) """
        pass

    def set_enable_search(self, enable_search): # real signature unknown; restored from __doc__
        """ set_enable_search(self, enable_search:bool) """
        pass

    def set_enable_tree_lines(self, enabled): # real signature unknown; restored from __doc__
    ...
    def set_expander_column(self, column=None): # real signature unknown; restored from __doc__
        """ set_expander_column(self, column:Gtk.TreeViewColumn=None) """
        pass

    def set_fixed_height_mode(self, enable): # real signature unknown; restored from __doc__
    ...
    def set_grid_lines(self, grid_lines): # real signature unknown; restored from __doc__
        """ set_grid_lines(self, grid_lines:Gtk.TreeViewGridLines) """
        pass

    def set_hadjustment(self, adjustment=None): # real signature unknown; restored from __doc__
    ...
    def set_headers_clickable(self, setting): # real signature unknown; restored from __doc__
        """ set_headers_clickable(self, setting:bool) """
        pass

    def set_headers_visible(self, headers_visible): # real signature unknown; restored from __doc__
    ...
    def set_hover_expand(self, expand): # real signature unknown; restored from __doc__
        """ set_hover_expand(self, expand:bool) """
        pass

    def set_hover_selection(self, hover): # real signature unknown; restored from __doc__
    ...
    def set_level_indentation(self, indentation): # real signature unknown; restored from __doc__
    ...
    def set_model(self, model=None): # real signature unknown; restored from __doc__
    ...
    def set_row_separator_func(self, func=None, data=None): # real signature unknown; restored from __doc__
        """ set_row_separator_func(self, func:Gtk.TreeViewRowSeparatorFunc=None, data=None) """
        pass

    def set_rubber_banding(self, enable): # real signature unknown; restored from __doc__
        """ set_rubber_banding(self, enable:bool) """
        pass

    def set_rules_hint(self, setting): # real signature unknown; restored from __doc__
        """ set_rules_hint(self, setting:bool) """
        pass

    def set_search_column(self, column): # real signature unknown; restored from __doc__
        """ set_search_column(self, column:int) """
        pass

    def set_search_entry(self, entry=None): # real signature unknown; restored from __doc__
        """ set_search_entry(self, entry:Gtk.Entry=None) """
        pass

    def set_search_equal_func(self, search_equal_func, search_user_data=None): # real signature unknown; restored from __doc__
        """ set_search_equal_func(self, search_equal_func:Gtk.TreeViewSearchEqualFunc, search_user_data=None) """
        pass

    def set_search_position_func(self, func=None, data=None): # real signature unknown; restored from __doc__
    ...
    def set_show_expanders(self, enabled): # real signature unknown; restored from __doc__
    ...
    def set_tooltip_cell(self, tooltip, path=None, column=None, cell=None): # real signature unknown; restored from __doc__
    ...
    def set_tooltip_column(self, column): # real signature unknown; restored from __doc__
    ...
    def set_tooltip_row(self, tooltip, path): # real signature unknown; restored from __doc__
    ...
    def set_vadjustment(self, adjustment=None): # real signature unknown; restored from __doc__
    ...
    def unset_rows_drag_dest(self): # real signature unknown; restored from __doc__
        """ unset_rows_drag_dest(self) """
        pass

    def unset_rows_drag_source(self): # real signature unknown; restored from __doc__
