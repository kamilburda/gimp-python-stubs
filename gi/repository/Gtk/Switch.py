...
class Switch(__gi_overrides_Gtk.Widget, Actionable, Activatable):
    """
    :Constructors:
    ...
    def do_state_set(self, *args, **kwargs): # real signature unknown
        """ state_set(self, state:bool) -> bool """
        pass
