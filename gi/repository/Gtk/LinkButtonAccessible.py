...
class LinkButtonAccessible(ButtonAccessible, __gi_repository_Atk.HyperlinkImpl):
    """
    :Constructors:
    
    ::
    
        LinkButtonAccessible(**properties)
    """
    ...
    def get_hyperlink(self): # real signature unknown; restored from __doc__
        """ get_hyperlink(self) -> Atk.Hyperlink """
        pass
