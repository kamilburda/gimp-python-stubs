...
class ToolPalette(__gi_overrides_Gtk.Container, Orientable, Scrollable):
    """
    :Constructors:
    
    ::
    
        ToolPalette(**properties)
        new() -> Gtk.Widget
    """
    ...
    def add_drag_dest(self, widget, flags, targets, actions): # real signature unknown; restored from __doc__
    ...
    def get_drag_item(self, selection): # real signature unknown; restored from __doc__
        """ get_drag_item(self, selection:Gtk.SelectionData) -> Gtk.Widget """
        pass

    def get_drag_target_group(self): # real signature unknown; restored from __doc__
        """ get_drag_target_group() -> Gtk.TargetEntry """
        pass

    def get_drag_target_item(self): # real signature unknown; restored from __doc__
        """ get_drag_target_item() -> Gtk.TargetEntry """
        pass

    def get_drop_group(self, x, y): # real signature unknown; restored from __doc__
        """ get_drop_group(self, x:int, y:int) -> Gtk.ToolItemGroup or None """
        pass

    def get_drop_item(self, x, y): # real signature unknown; restored from __doc__
        """ get_drop_item(self, x:int, y:int) -> Gtk.ToolItem or None """
        pass
    ...
    def get_exclusive(self, group): # real signature unknown; restored from __doc__
        """ get_exclusive(self, group:Gtk.ToolItemGroup) -> bool """
        return False

    def get_expand(self, group): # real signature unknown; restored from __doc__
    ...
    def get_group_position(self, group): # real signature unknown; restored from __doc__
    ...
    def set_drag_source(self, targets): # real signature unknown; restored from __doc__
    ...
    def set_exclusive(self, group, exclusive): # real signature unknown; restored from __doc__
        """ set_exclusive(self, group:Gtk.ToolItemGroup, exclusive:bool) """
        pass

    def set_expand(self, group, expand): # real signature unknown; restored from __doc__
    ...
    def set_group_position(self, group, position): # real signature unknown; restored from __doc__
    ...
    def set_icon_size(self, icon_size): # real signature unknown; restored from __doc__
    ...
    def unset_icon_size(self): # real signature unknown; restored from __doc__
    ...
    def unset_style(self): # real signature unknown; restored from __doc__
        """ unset_style(self) """
        pass
