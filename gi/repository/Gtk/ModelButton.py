...
class ModelButton(__gi_overrides_Gtk.Button):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd190bbe0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ModelButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkModelButton (3427492720)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkModelButton (3427492720)>'
