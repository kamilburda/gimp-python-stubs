...
class ToolItem(Bin, Activatable):
    ...
    def do_create_menu_proxy(self, *args, **kwargs): # real signature unknown
        """ create_menu_proxy(self) -> bool """
        pass
    ...
    def do_toolbar_reconfigured(self, *args, **kwargs): # real signature unknown
    ...
    def get_proxy_menu_item(self, menu_item_id): # real signature unknown; restored from __doc__
        """ get_proxy_menu_item(self, menu_item_id:str) -> Gtk.Widget or None """
        pass
    ...
    def get_toolbar_style(self): # real signature unknown; restored from __doc__
    ...
    def get_use_drag_window(self): # real signature unknown; restored from __doc__
    ...
    def retrieve_proxy_menu_item(self): # real signature unknown; restored from __doc__
    ...
    def set_proxy_menu_item(self, menu_item_id, menu_item=None): # real signature unknown; restored from __doc__
        """ set_proxy_menu_item(self, menu_item_id:str, menu_item:Gtk.Widget=None) """
        pass
    ...
    def set_tooltip_markup(self, markup): # real signature unknown; restored from __doc__
    ...
    def set_use_drag_window(self, use_drag_window): # real signature unknown; restored from __doc__
    ...
    def toolbar_reconfigured(self): # real signature unknown; restored from __doc__
        """ toolbar_reconfigured(self) """
        pass
