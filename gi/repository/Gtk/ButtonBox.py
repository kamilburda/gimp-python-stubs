...
class ButtonBox(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def get_child_non_homogeneous(self, child): # real signature unknown; restored from __doc__
    ...
    def get_child_secondary(self, child): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, orientation): # real signature unknown; restored from __doc__
        """ new(orientation:Gtk.Orientation) -> Gtk.Widget """
        pass
    ...
    def set_child_non_homogeneous(self, child, non_homogeneous): # real signature unknown; restored from __doc__
    ...
    def set_child_secondary(self, child, is_secondary): # real signature unknown; restored from __doc__
    ...
    def set_layout(self, layout_style): # real signature unknown; restored from __doc__
    ...
    box = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
