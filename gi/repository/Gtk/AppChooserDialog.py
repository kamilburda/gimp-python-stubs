...
class AppChooserDialog(__gi_overrides_Gtk.Dialog, AppChooser):
    """
    :Constructors:
    ...
    @classmethod
    def new(cls, parent=None, flags, file): # real signature unknown; restored from __doc__
        """ new(parent:Gtk.Window=None, flags:Gtk.DialogFlags, file:Gio.File) -> Gtk.Widget """
        pass
    ...
    @classmethod
    def new_for_content_type(cls, parent=None, flags, content_type): # real signature unknown; restored from __doc__
        """ new_for_content_type(parent:Gtk.Window=None, flags:Gtk.DialogFlags, content_type:str) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e8be0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
