...
class HScrollbar(HScrollbar):
    ...
    def new(self, adjustment=None): # real signature unknown; restored from __doc__
        """ new(adjustment:Gtk.Adjustment=None) -> Gtk.Widget """
        pass
    ...
    scrollbar = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
