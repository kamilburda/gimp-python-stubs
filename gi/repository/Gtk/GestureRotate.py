...
class GestureRotate(Gesture):
    ...
    def get_angle_delta(self): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd1904520>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureRotate), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureRotate (3537682096)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_angle_delta': gi.FunctionInfo(get_angle_delta)})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureRotate (3537682096)>'
