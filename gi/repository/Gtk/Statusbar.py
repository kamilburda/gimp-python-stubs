...
class Statusbar(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def do_text_popped(self, *args, **kwargs): # real signature unknown
        """ text_popped(self, context_id:int, text:str) """
        pass

    def do_text_pushed(self, *args, **kwargs): # real signature unknown
        """ text_pushed(self, context_id:int, text:str) """
        pass
    ...
    def get_context_id(self, context_description): # real signature unknown; restored from __doc__
    ...
    def get_message_area(self): # real signature unknown; restored from __doc__
    ...
    def pop(self, context_id): # real signature unknown; restored from __doc__
    ...
    def push(self, context_id, text): # real signature unknown; restored from __doc__
    ...
    def remove(self, context_id, message_id): # real signature unknown; restored from __doc__
    ...
    def remove_all(self, context_id): # real signature unknown; restored from __doc__
    ...
    parent_widget = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
