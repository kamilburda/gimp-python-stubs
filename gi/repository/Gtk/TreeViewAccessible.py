...
class TreeViewAccessible(ContainerAccessible, __gi_repository_Atk.Selection, __gi_repository_Atk.Table, CellAccessibleParent):
    """
    :Constructors:
    
    ::
    
        TreeViewAccessible(**properties)
    """
