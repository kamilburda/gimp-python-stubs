...
class IMMulticontext(__gi_overrides_Gtk.IMContext):
    """
    :Constructors:
    ...
    ::
        ...
        new() -> Gtk.IMContext
    """
    def append_menuitems(self, menushell): # real signature unknown; restored from __doc__
    ...
    def get_context_id(self): # real signature unknown; restored from __doc__
    ...
    def set_context_id(self, context_id): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17fe7a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IMMulticontext), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkIMMulticontext (3537708080)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'append_menuitems': gi.FunctionInfo(append_menuitems), 'get_context_id': gi.FunctionInfo(get_context_id), 'set_context_id': gi.FunctionInfo(set_context_id), 'object': <property object at 0x000002bfd18df560>, 'priv': <property object at 0x000002bfd18df650>})"
    __firstlineno__ = 788
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkIMMulticontext (3537708080)>'
