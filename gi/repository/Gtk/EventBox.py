...
class EventBox(Bin):
    ...
    def get_above_child(self): # real signature unknown; restored from __doc__
    ...
    def get_visible_window(self): # real signature unknown; restored from __doc__
    ...
    def set_above_child(self, above_child): # real signature unknown; restored from __doc__
    ...
    def set_visible_window(self, visible_window): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17ef3a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventBox (3427460800)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_above_child': gi.FunctionInfo(get_above_child), 'get_visible_window': gi.FunctionInfo(get_visible_window), 'set_above_child': gi.FunctionInfo(set_above_child), 'set_visible_window': gi.FunctionInfo(set_visible_window), 'bin': <property object at 0x000002bfd175d7b0>, 'priv': <property object at 0x000002bfd175d8a0>})"
    __firstlineno__ = 163
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventBox (3427460800)>'
    __info__ = ObjectInfo(EventBox)
