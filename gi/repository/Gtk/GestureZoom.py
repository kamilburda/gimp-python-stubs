...
class GestureZoom(Gesture):
    ...
    def get_scale_delta(self): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17f6e00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureZoom), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureZoom (3537683328)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_scale_delta': gi.FunctionInfo(get_scale_delta)})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureZoom (3537683328)>'
