...
class VPaned(__gi_overrides_Gtk.Paned):
    """
    :Constructors:
    ...
    paned = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
