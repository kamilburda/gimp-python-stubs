...
class AccelLabel(__gi_overrides_Gtk.Label):
    """
    :Constructors:
    
    ::
    
        AccelLabel(**properties)
    ...
    def get_accel(self): # real signature unknown; restored from __doc__
        """ get_accel(self) -> accelerator_key:int, accelerator_mods:Gdk.ModifierType """
        pass

    def get_accel_widget(self): # real signature unknown; restored from __doc__
        """ get_accel_widget(self) -> Gtk.Widget or None """
        pass

    def get_accel_width(self): # real signature unknown; restored from __doc__
    ...
    def get_angle(self): # real signature unknown; restored from __doc__
    ...
    def get_line_wrap(self): # real signature unknown; restored from __doc__
        """ get_line_wrap(self) -> bool """
        return False

    def get_line_wrap_mode(self): # real signature unknown; restored from __doc__
    ...
    def get_mnemonic_widget(self): # real signature unknown; restored from __doc__
    ...
    def get_selection_bounds(self): # real signature unknown; restored from __doc__
    ...
    def get_single_line_mode(self): # real signature unknown; restored from __doc__
    ...
    def get_track_visited_links(self): # real signature unknown; restored from __doc__
    ...
    def get_xalign(self): # real signature unknown; restored from __doc__
        """ get_xalign(self) -> float """
        return 0.0

    def get_yalign(self): # real signature unknown; restored from __doc__
    ...
    def new_with_mnemonic(self, p_str=None): # real signature unknown; restored from __doc__
    ...
    def refetch(self): # real signature unknown; restored from __doc__
        """ refetch(self) -> bool """
        return False
    ...
    def select_region(self, start_offset, end_offset): # real signature unknown; restored from __doc__
    ...
    def set_accel(self, accelerator_key, accelerator_mods): # real signature unknown; restored from __doc__
        """ set_accel(self, accelerator_key:int, accelerator_mods:Gdk.ModifierType) """
        pass

    def set_accel_closure(self, accel_closure=None): # real signature unknown; restored from __doc__
        """ set_accel_closure(self, accel_closure:GObject.Closure=None) """
        pass
    ...
    def set_accel_widget(self, accel_widget=None): # real signature unknown; restored from __doc__
        """ set_accel_widget(self, accel_widget:Gtk.Widget=None) """
        pass
    ...
    def set_ellipsize(self, mode): # real signature unknown; restored from __doc__
    ...
    def set_justify(self, jtype): # real signature unknown; restored from __doc__
        """ set_justify(self, jtype:Gtk.Justification) """
        pass

    def set_label(self, p_str): # real signature unknown; restored from __doc__
        """ set_label(self, str:str) """
        pass

    def set_lines(self, lines): # real signature unknown; restored from __doc__
        """ set_lines(self, lines:int) """
        pass

    def set_line_wrap(self, wrap): # real signature unknown; restored from __doc__
        """ set_line_wrap(self, wrap:bool) """
        pass

    def set_line_wrap_mode(self, wrap_mode): # real signature unknown; restored from __doc__
    ...
    def set_markup(self, p_str): # real signature unknown; restored from __doc__
        """ set_markup(self, str:str) """
        pass

    def set_markup_with_mnemonic(self, p_str): # real signature unknown; restored from __doc__
    ...
    def set_mnemonic_widget(self, widget=None): # real signature unknown; restored from __doc__
    ...
    def set_pattern(self, pattern): # real signature unknown; restored from __doc__
    ...
    def set_selectable(self, setting): # real signature unknown; restored from __doc__
    ...
    def set_single_line_mode(self, single_line_mode): # real signature unknown; restored from __doc__
    ...
    def set_text(self, p_str): # real signature unknown; restored from __doc__
        """ set_text(self, str:str) """
        pass

    def set_text_with_mnemonic(self, p_str): # real signature unknown; restored from __doc__
    ...
    def set_track_visited_links(self, track_links): # real signature unknown; restored from __doc__
        """ set_track_visited_links(self, track_links:bool) """
        pass

    def set_use_markup(self, setting): # real signature unknown; restored from __doc__
        """ set_use_markup(self, setting:bool) """
        pass

    def set_use_underline(self, setting): # real signature unknown; restored from __doc__
    ...
    def set_xalign(self, xalign): # real signature unknown; restored from __doc__
        """ set_xalign(self, xalign:float) """
        pass

    def set_yalign(self, yalign): # real signature unknown; restored from __doc__
    ...
    misc = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
