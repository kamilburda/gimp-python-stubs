...
class Table(Table, __gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    ::
        ...
        Table(**properties)
        new(rows:int, columns:int, homogeneous:bool) -> Gtk.Widget
    """
    ...
    def attach(self, child, left_attach, right_attach, top_attach, bottom_attach, xoptions=5, yoptions=5, xpadding=0, ypadding=0): # reliably restored by inspect
        # no doc
        pass

    def attach_defaults(self, widget, left_attach, right_attach, top_attach, bottom_attach): # real signature unknown; restored from __doc__
        """ attach_defaults(self, widget:Gtk.Widget, left_attach:int, right_attach:int, top_attach:int, bottom_attach:int) """
        pass
    ...
    def get_col_spacing(self, column): # real signature unknown; restored from __doc__
        """ get_col_spacing(self, column:int) -> int """
        return 0
    ...
    def get_default_col_spacing(self): # real signature unknown; restored from __doc__
        """ get_default_col_spacing(self) -> int """
        return 0
    ...
    def get_default_row_spacing(self): # real signature unknown; restored from __doc__
        """ get_default_row_spacing(self) -> int """
        return 0
    ...
    def get_row_spacing(self, row): # real signature unknown; restored from __doc__
        """ get_row_spacing(self, row:int) -> int """
        return 0
    ...
    def get_size(self): # real signature unknown; restored from __doc__
        """ get_size(self) -> rows:int, columns:int """
        pass
    ...
    def new(self, rows, columns, homogeneous): # real signature unknown; restored from __doc__
        """ new(rows:int, columns:int, homogeneous:bool) -> Gtk.Widget """
        pass
    ...
    def resize(self, rows, columns): # real signature unknown; restored from __doc__
        """ resize(self, rows:int, columns:int) """
        pass
    ...
    def set_col_spacing(self, column, spacing): # real signature unknown; restored from __doc__
        """ set_col_spacing(self, column:int, spacing:int) """
        pass

    def set_col_spacings(self, spacing): # real signature unknown; restored from __doc__
        """ set_col_spacings(self, spacing:int) """
        pass
    ...
    def set_row_spacing(self, row, spacing): # real signature unknown; restored from __doc__
        """ set_row_spacing(self, row:int, spacing:int) """
        pass

    def set_row_spacings(self, spacing): # real signature unknown; restored from __doc__
        """ set_row_spacings(self, spacing:int) """
        pass
