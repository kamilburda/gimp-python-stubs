...
class StyleProperties(__gi_overrides_GObject.Object, StyleProvider):
    """
    :Constructors:
    ...
    def get_property(self, property, state): # real signature unknown; restored from __doc__
        """ get_property(self, property:str, state:Gtk.StateFlags) -> bool, value:GObject.Value """
        return False
    ...
    def lookup_color(self, name): # real signature unknown; restored from __doc__
        """ lookup_color(self, name:str) -> Gtk.SymbolicColor """
        pass

    def map_color(self, name, color): # real signature unknown; restored from __doc__
        """ map_color(self, name:str, color:Gtk.SymbolicColor) """
        pass

    def merge(self, props_to_merge, replace): # real signature unknown; restored from __doc__
    ...
    def set_property(self, property, state, value): # real signature unknown; restored from __doc__
        """ set_property(self, property:str, state:Gtk.StateFlags, value:GObject.Value) """
        pass
    ...
    def unset_property(self, property, state): # real signature unknown; restored from __doc__
        """ unset_property(self, property:str, state:Gtk.StateFlags) """
        pass
