...
class CellRendererToggle(CellRenderer):
    ...
    def get_radio(self): # real signature unknown; restored from __doc__
        """ get_radio(self) -> bool """
        return False
    ...
    def set_activatable(self, setting): # real signature unknown; restored from __doc__
        """ set_activatable(self, setting:bool) """
        pass

    def set_active(self, setting): # real signature unknown; restored from __doc__
    ...
    def set_radio(self, radio): # real signature unknown; restored from __doc__
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e67a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererToggle), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererToggle (3428550896)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_activatable': gi.FunctionInfo(get_activatable), 'get_active': gi.FunctionInfo(get_active), 'get_radio': gi.FunctionInfo(get_radio), 'set_activatable': gi.FunctionInfo(set_activatable), 'set_active': gi.FunctionInfo(set_active), 'set_radio': gi.FunctionInfo(set_radio), 'do_toggled': gi.VFuncInfo(toggled), 'parent': <property object at 0x000002bfd178e980>, 'priv': <property object at 0x000002bfd178ea70>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererToggle (3428550896)>'
