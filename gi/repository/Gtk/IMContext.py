...
class IMContext(IMContext):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 788, 'get_surrounding': <function strip_boolean_result.<locals>.wrapped at 0x000002bfce4d7c10>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 788
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkIMContext (3416386896)>'
