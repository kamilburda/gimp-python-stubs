...
class RadioToolButton(ToggleToolButton):
    ...
    @classmethod
    def new_from_stock(cls, group=None, stock_id): # real signature unknown; restored from __doc__
        """ new_from_stock(group:list=None, stock_id:str) -> Gtk.ToolItem """
        pass
    ...
    @classmethod
    def new_with_stock_from_widget(cls, group=None, stock_id): # real signature unknown; restored from __doc__
        """ new_with_stock_from_widget(group:Gtk.RadioToolButton=None, stock_id:str) -> Gtk.ToolItem """
        pass
