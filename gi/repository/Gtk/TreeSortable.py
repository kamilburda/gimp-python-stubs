...
class TreeSortable(TreeSortable):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 1037, 'get_sort_column_id': <function strip_boolean_result.<locals>.wrapped at 0x000002bfcebd16f0>, 'set_sort_func': <function TreeSortable.set_sort_func at 0x000002bfcebd17a0>, 'set_default_sort_func': <function TreeSortable.set_default_sort_func at 0x000002bfcebd1850>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 1037
    __gdoc__ = 'Interface GtkTreeSortable\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTreeSortable (3416386800)>'
