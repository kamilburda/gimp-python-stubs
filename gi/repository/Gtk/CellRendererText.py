...
class CellRendererText(CellRenderer):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererText), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererText (3428537344)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'set_fixed_height_from_font': gi.FunctionInfo(set_fixed_height_from_font), 'do_edited': gi.VFuncInfo(edited), 'parent': <property object at 0x000002bfd1791c10>, 'priv': <property object at 0x000002bfd1791d00>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererText (3428537344)>'
