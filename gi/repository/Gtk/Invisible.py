...
class Invisible(__gi_overrides_Gtk.Widget):
    """
    :Constructors:
    ...
    ::
        ...
        new() -> Gtk.Widget
        new_for_screen(screen:Gdk.Screen) -> Gtk.Widget
    """
    ...
    @classmethod
    def new_for_screen(cls, screen): # real signature unknown; restored from __doc__
        """ new_for_screen(screen:Gdk.Screen) -> Gtk.Widget """
        pass
