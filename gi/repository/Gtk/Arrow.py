...
class Arrow(Arrow):
    ...
    ::
        ...
        Arrow(**properties)
        new(arrow_type:Gtk.ArrowType, shadow_type:Gtk.ShadowType) -> Gtk.Widget
    """
    ...
    def new(self, arrow_type, shadow_type): # real signature unknown; restored from __doc__
        """ new(arrow_type:Gtk.ArrowType, shadow_type:Gtk.ShadowType) -> Gtk.Widget """
        pass
    ...
    def set(self, arrow_type, shadow_type): # real signature unknown; restored from __doc__
        """ set(self, arrow_type:Gtk.ArrowType, shadow_type:Gtk.ShadowType) """
        pass
