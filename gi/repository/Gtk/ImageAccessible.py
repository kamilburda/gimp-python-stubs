...
class ImageAccessible(WidgetAccessible, __gi_repository_Atk.Image):
    """
    :Constructors:
    
    ::
    
        ImageAccessible(**properties)
    """
