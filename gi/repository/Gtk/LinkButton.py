...
class LinkButton(LinkButton):
    ...
    def new_with_label(self, uri, label=None): # real signature unknown; restored from __doc__
        """ new_with_label(uri:str, label:str=None) -> Gtk.Widget """
        pass
    ...
    def set_visited(self, visited): # real signature unknown; restored from __doc__
