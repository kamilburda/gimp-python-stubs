...
class StatusbarClass(__gi.Struct):
    """
    :Constructors:
    ...
    text_popped = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    text_pushed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
