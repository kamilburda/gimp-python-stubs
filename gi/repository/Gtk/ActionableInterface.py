...
class ActionableInterface(__gi.Struct):
    """
    :Constructors:
    ...
    get_action_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_action_target_value = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    g_iface = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    set_action_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    set_action_target_value = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
