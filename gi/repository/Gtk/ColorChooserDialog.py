...
class ColorChooserDialog(__gi_overrides_Gtk.Dialog, ColorChooser):
    """
    :Constructors:
    ...
    @classmethod
    def new(cls, title=None, parent=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, parent:Gtk.Window=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17e8a00>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
