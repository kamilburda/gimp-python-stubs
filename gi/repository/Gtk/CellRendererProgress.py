...
class CellRendererProgress(CellRenderer, Orientable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17ec640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererProgress), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererProgress (3428541936)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'parent_instance': <property object at 0x000002bfd178cb30>, 'priv': <property object at 0x000002bfd178cc20>})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererProgress (3428541936)>'
