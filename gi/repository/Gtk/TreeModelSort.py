...
class TreeModelSort(TreeModelSort):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd191ae60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 1057, '__init__': <function deprecated_init.<locals>.new_init at 0x000002bfcebd1900>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 1057
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTreeModelSort (3416383728)>'
