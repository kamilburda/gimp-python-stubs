...
class VScale(Scale):
    ...
    ::
        ...
        VScale(**properties)
        new(adjustment:Gtk.Adjustment) -> Gtk.Widget
    ...
    @classmethod
    def new(cls, adjustment): # real signature unknown; restored from __doc__
        """ new(adjustment:Gtk.Adjustment) -> Gtk.Widget """
        pass
