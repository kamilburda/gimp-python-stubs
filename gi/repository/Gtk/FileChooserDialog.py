...
class FileChooserDialog(FileChooserDialog):
    """
    :Constructors:
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17fee00>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 718, '__init__': <function deprecated_init.<locals>.new_init at 0x000002bfce4d7530>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 718
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFileChooserDialog (3426518624)>'
    __info__ = ObjectInfo(FileChooserDialog)
