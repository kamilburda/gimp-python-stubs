...
class Image(Misc):
    ...
    def get_icon_set(self): # real signature unknown; restored from __doc__
    ...
    def set_from_animation(self, animation): # real signature unknown; restored from __doc__
        """ set_from_animation(self, animation:GdkPixbuf.PixbufAnimation) """
        pass

    def set_from_file(self, filename=None): # real signature unknown; restored from __doc__
        """ set_from_file(self, filename:str=None) """
        pass

    def set_from_gicon(self, icon, size): # real signature unknown; restored from __doc__
        """ set_from_gicon(self, icon:Gio.Icon, size:int) """
        pass

    def set_from_icon_name(self, icon_name=None, size): # real signature unknown; restored from __doc__
        """ set_from_icon_name(self, icon_name:str=None, size:int) """
        pass

    def set_from_icon_set(self, icon_set, size): # real signature unknown; restored from __doc__
    ...
    def set_from_resource(self, resource_path=None): # real signature unknown; restored from __doc__
        """ set_from_resource(self, resource_path:str=None) """
        pass

    def set_from_stock(self, stock_id, size): # real signature unknown; restored from __doc__
        """ set_from_stock(self, stock_id:str, size:int) """
        pass

    def set_from_surface(self, surface=None): # real signature unknown; restored from __doc__
        """ set_from_surface(self, surface:cairo.Surface=None) """
        pass
    ...
    def set_pixel_size(self, pixel_size): # real signature unknown; restored from __doc__
