...
class PrintOperationPreviewIface(__gi.Struct):
    """
    :Constructors:
    ...
    end_preview = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    got_page_size = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    render_page = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
