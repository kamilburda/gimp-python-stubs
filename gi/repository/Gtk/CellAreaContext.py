...
class CellAreaContext(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    """
    def allocate(self, width, height): # real signature unknown; restored from __doc__
    ...
    def push_preferred_height(self, minimum_height, natural_height): # real signature unknown; restored from __doc__
        """ push_preferred_height(self, minimum_height:int, natural_height:int) """
        pass

    def push_preferred_width(self, minimum_width, natural_width): # real signature unknown; restored from __doc__
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellAreaContext (3418539584)>'
