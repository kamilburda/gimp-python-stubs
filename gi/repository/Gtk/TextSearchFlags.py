...
class TextSearchFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'VISIBLE_ONLY': <TextSearchFlags.VISIBLE_ONLY: 1>, 'TEXT_ONLY': <TextSearchFlags.TEXT_ONLY: 2>, 'CASE_INSENSITIVE': <TextSearchFlags.CASE_INSENSITIVE: 4>})"
    __name__ = 'TextSearchFlags'
    __qualname__ = 'TextSearchFlags'
