...
class InfoBar(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def get_revealed(self): # real signature unknown; restored from __doc__
        """ get_revealed(self) -> bool """
        return False
    ...
    def set_message_type(self, message_type): # real signature unknown; restored from __doc__
    ...
    def set_revealed(self, revealed): # real signature unknown; restored from __doc__
        """ set_revealed(self, revealed:bool) """
        pass
