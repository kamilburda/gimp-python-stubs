...
class ListBoxRow(Bin, Actionable):
    ...
    def get_header(self): # real signature unknown; restored from __doc__
        """ get_header(self) -> Gtk.Widget or None """
        pass
    ...
    def is_selected(self): # real signature unknown; restored from __doc__
    ...
    def set_header(self, header=None): # real signature unknown; restored from __doc__
        """ set_header(self, header:Gtk.Widget=None) """
        pass
    ...
    def set_selectable(self, selectable): # real signature unknown; restored from __doc__
        """ set_selectable(self, selectable:bool) """
        pass
