...
class StateFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NORMAL': <StateFlags.NORMAL: 0>, 'ACTIVE': <StateFlags.ACTIVE: 1>, 'PRELIGHT': <StateFlags.PRELIGHT: 2>, 'SELECTED': <StateFlags.SELECTED: 4>, 'INSENSITIVE': <StateFlags.INSENSITIVE: 8>, 'INCONSISTENT': <StateFlags.INCONSISTENT: 16>, 'FOCUSED': <StateFlags.FOCUSED: 32>, 'BACKDROP': <StateFlags.BACKDROP: 64>, 'DIR_LTR': <StateFlags.DIR_LTR: 128>, 'DIR_RTL': <StateFlags.DIR_RTL: 256>, 'LINK': <StateFlags.LINK: 512>, 'VISITED': <StateFlags.VISITED: 1024>, 'CHECKED': <StateFlags.CHECKED: 2048>, 'DROP_ACTIVE': <StateFlags.DROP_ACTIVE: 4096>})"
    __name__ = 'StateFlags'
    __qualname__ = 'StateFlags'
