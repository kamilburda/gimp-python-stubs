...
class IconViewClass(__gi.Struct):
    """
    :Constructors:
    ...
    activate_cursor_item = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    select_cursor_item = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    toggle_cursor_item = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
