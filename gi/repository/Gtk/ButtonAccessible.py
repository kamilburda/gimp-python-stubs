...
class ButtonAccessible(ContainerAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.Image):
    """
    :Constructors:
    
    ::
    
        ButtonAccessible(**properties)
    """
