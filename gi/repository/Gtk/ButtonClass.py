...
class ButtonClass(__gi.Struct):
    ...
    enter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    leave = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    pressed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    released = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
