...
class Stack(__gi_overrides_Gtk.Container):
    """
    :Constructors:
    ...
    def add_named(self, child, name): # real signature unknown; restored from __doc__
    ...
    def add_titled(self, child, name, title): # real signature unknown; restored from __doc__
    ...
    def get_child_by_name(self, name): # real signature unknown; restored from __doc__
        """ get_child_by_name(self, name:str) -> Gtk.Widget or None """
        pass
    ...
    def get_hhomogeneous(self): # real signature unknown; restored from __doc__
    ...
    def get_vhomogeneous(self): # real signature unknown; restored from __doc__
    ...
    def get_visible_child(self): # real signature unknown; restored from __doc__
        """ get_visible_child(self) -> Gtk.Widget or None """
        pass

    def get_visible_child_name(self): # real signature unknown; restored from __doc__
        """ get_visible_child_name(self) -> str or None """
        return ""
    ...
    def set_hhomogeneous(self, hhomogeneous): # real signature unknown; restored from __doc__
    ...
    def set_vhomogeneous(self, vhomogeneous): # real signature unknown; restored from __doc__
    ...
    def set_visible_child(self, child): # real signature unknown; restored from __doc__
        """ set_visible_child(self, child:Gtk.Widget) """
        pass

    def set_visible_child_full(self, name, transition): # real signature unknown; restored from __doc__
