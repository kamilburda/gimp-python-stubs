...
class EventControllerKey(EventController):
    ...
    ::
        ...
        new(widget:Gtk.Widget) -> Gtk.EventController
    """
    ...
    def forward(self, widget): # real signature unknown; restored from __doc__
        """ forward(self, widget:Gtk.Widget) -> bool """
        return False
    ...
    def get_im_context(self): # real signature unknown; restored from __doc__
        """ get_im_context(self) -> Gtk.IMContext """
        pass
    ...
    @classmethod
    def new(cls, widget): # real signature unknown; restored from __doc__
        """ new(widget:Gtk.Widget) -> Gtk.EventController """
        pass
    ...
    def set_im_context(self, im_context): # real signature unknown; restored from __doc__
        """ set_im_context(self, im_context:Gtk.IMContext) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd17efbb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventControllerKey), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventControllerKey (3537637520)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'forward': gi.FunctionInfo(forward), 'get_group': gi.FunctionInfo(get_group), 'get_im_context': gi.FunctionInfo(get_im_context), 'set_im_context': gi.FunctionInfo(set_im_context)})"
    __firstlineno__ = 651
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventControllerKey (3537637520)>'
