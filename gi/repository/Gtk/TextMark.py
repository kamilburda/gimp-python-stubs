...
class TextMark(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    def get_left_gravity(self): # real signature unknown; restored from __doc__
    ...
    def set_visible(self, setting): # real signature unknown; restored from __doc__
