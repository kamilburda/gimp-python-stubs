...
class AspectFrame(Frame):
    ...
    @classmethod
    def new(cls, label=None, xalign, yalign, ratio, obey_child): # real signature unknown; restored from __doc__
        """ new(label:str=None, xalign:float, yalign:float, ratio:float, obey_child:bool) -> Gtk.Widget """
        pass
    ...
    def set(self, xalign, yalign, ratio, obey_child): # real signature unknown; restored from __doc__
