...
class MenuBar(MenuShell):
    ...
    def get_child_pack_direction(self): # real signature unknown; restored from __doc__
    ...
    def get_pack_direction(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new_from_model(cls, model): # real signature unknown; restored from __doc__
        """ new_from_model(model:Gio.MenuModel) -> Gtk.Widget """
        pass
    ...
    def set_child_pack_direction(self, child_pack_dir): # real signature unknown; restored from __doc__
    ...
    def set_pack_direction(self, pack_dir): # real signature unknown; restored from __doc__
