...
class LabelAccessible(WidgetAccessible, __gi_repository_Atk.Hypertext, __gi_repository_Atk.Text):
    """
    :Constructors:
    
    ::
    
        LabelAccessible(**properties)
    """
