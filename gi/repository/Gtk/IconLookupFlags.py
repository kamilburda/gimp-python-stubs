...
class IconLookupFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NO_SVG': <IconLookupFlags.NO_SVG: 1>, 'FORCE_SVG': <IconLookupFlags.FORCE_SVG: 2>, 'USE_BUILTIN': <IconLookupFlags.USE_BUILTIN: 4>, 'GENERIC_FALLBACK': <IconLookupFlags.GENERIC_FALLBACK: 8>, 'FORCE_SIZE': <IconLookupFlags.FORCE_SIZE: 16>, 'FORCE_REGULAR': <IconLookupFlags.FORCE_REGULAR: 32>, 'FORCE_SYMBOLIC': <IconLookupFlags.FORCE_SYMBOLIC: 64>, 'DIR_LTR': <IconLookupFlags.DIR_LTR: 128>, 'DIR_RTL': <IconLookupFlags.DIR_RTL: 256>})"
    __name__ = 'IconLookupFlags'
    __qualname__ = 'IconLookupFlags'
