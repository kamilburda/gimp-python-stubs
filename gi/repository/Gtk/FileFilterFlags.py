...
class FileFilterFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'FILENAME': <FileFilterFlags.FILENAME: 1>, 'URI': <FileFilterFlags.URI: 2>, 'DISPLAY_NAME': <FileFilterFlags.DISPLAY_NAME: 4>, 'MIME_TYPE': <FileFilterFlags.MIME_TYPE: 8>})"
    __name__ = 'FileFilterFlags'
    __qualname__ = 'FileFilterFlags'
