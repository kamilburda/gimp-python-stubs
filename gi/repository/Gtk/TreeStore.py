...
class TreeStore(TreeStore, __gi_overrides_Gtk.TreeModel, __gi_overrides_Gtk.TreeSortable):
    """
    :Constructors:
    ...
    def append(self, parent, row=None): # reliably restored by inspect
        # no doc
        pass
    ...
    def insert(self, parent, position, row=None): # reliably restored by inspect
        # no doc
        pass

    def insert_after(self, parent, sibling, row=None): # reliably restored by inspect
        # no doc
        pass

    def insert_before(self, parent, sibling, row=None): # reliably restored by inspect
        # no doc
        pass

    def insert_with_values(self, parent=None, position, columns, values): # real signature unknown; restored from __doc__
    ...
    def is_ancestor(self, iter, descendant): # real signature unknown; restored from __doc__
    ...
    def iter_depth(self, iter): # real signature unknown; restored from __doc__
    ...
    def move_after(self, iter, position=None): # real signature unknown; restored from __doc__
        """ move_after(self, iter:Gtk.TreeIter, position:Gtk.TreeIter=None) """
        pass

    def move_before(self, iter, position=None): # real signature unknown; restored from __doc__
        """ move_before(self, iter:Gtk.TreeIter, position:Gtk.TreeIter=None) """
        pass

    def new(self, types): # real signature unknown; restored from __doc__
        """ new(types:list) -> Gtk.TreeStore """
        pass
    ...
    def prepend(self, parent, row=None): # reliably restored by inspect
        # no doc
        pass
    ...
    def set(self, treeiter, *args): # reliably restored by inspect
        # no doc
        pass
    ...
    def set_column_types(self, types): # real signature unknown; restored from __doc__
    ...
    def set_value(self, treeiter, column, value): # reliably restored by inspect
        # no doc
        pass
    ...
    def _do_insert(self, parent, position, row): # reliably restored by inspect
        # no doc
        pass
    ...
    def __init__(self, *column_types): # reliably restored by inspect
        # no doc
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002bfd191c730>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__firstlineno__': 1351, '__init__': <function TreeStore.__init__ at 0x000002bfcebd3270>, '_do_insert': <function TreeStore._do_insert at 0x000002bfcebd3320>, 'append': <function TreeStore.append at 0x000002bfcebd33d0>, 'prepend': <function TreeStore.prepend at 0x000002bfcebd3480>, 'insert': <function TreeStore.insert at 0x000002bfcebd3530>, 'insert_before': <function TreeStore.insert_before at 0x000002bfcebd35e0>, 'insert_after': <function TreeStore.insert_after at 0x000002bfcebd3690>, 'set_value': <function TreeStore.set_value at 0x000002bfcebd3740>, 'set': <function TreeStore.set at 0x000002bfcebd37f0>, '__static_attributes__': (), '__doc__': None, '__gsignals__': {}})"
    __firstlineno__ = 1351
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTreeStore (3416387376)>'
