...
class AccessibleClass(__gi.Struct):
    """
    :Constructors:
    ...
    connect_widget_destroyed = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    widget_set = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    widget_unset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
