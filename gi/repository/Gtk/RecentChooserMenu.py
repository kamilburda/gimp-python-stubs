...
class RecentChooserMenu(__gi_overrides_Gtk.Menu, Activatable, RecentChooser):
    """
    :Constructors:
    
    ::
    
        RecentChooserMenu(**properties)
        new() -> Gtk.Widget
    ...
    def activate_item(self, menu_item, force_deactivate): # real signature unknown; restored from __doc__
    ...
    def attach(self, child, left_attach, right_attach, top_attach, bottom_attach): # real signature unknown; restored from __doc__
        """ attach(self, child:Gtk.Widget, left_attach:int, right_attach:int, top_attach:int, bottom_attach:int) """
        pass

    def attach_to_widget(self, attach_widget, detacher=None): # real signature unknown; restored from __doc__
        """ attach_to_widget(self, attach_widget:Gtk.Widget, detacher:Gtk.MenuDetachFunc=None) """
        pass

    def bind_model(self, model=None, action_namespace=None, with_separators): # real signature unknown; restored from __doc__
    ...
    def do_activate_current(self, *args, **kwargs): # real signature unknown
        """ activate_current(self, force_hide:bool) """
        pass
    ...
    def do_deactivate(self, *args, **kwargs): # real signature unknown
        """ deactivate(self) """
        pass
    ...
    def do_get_popup_delay(self, *args, **kwargs): # real signature unknown
        """ get_popup_delay(self) -> int """
        pass
    ...
    def do_move_current(self, *args, **kwargs): # real signature unknown
        """ move_current(self, direction:Gtk.MenuDirectionType) """
        pass
    ...
    def do_move_selected(self, *args, **kwargs): # real signature unknown
        """ move_selected(self, distance:int) -> bool """
        pass
    ...
    def do_selection_done(self, *args, **kwargs): # real signature unknown
        """ selection_done(self) """
        pass
    ...
    def do_select_item(self, *args, **kwargs): # real signature unknown
    ...
    def get_attach_widget(self): # real signature unknown; restored from __doc__
    ...
    def get_for_attach_widget(self, widget): # real signature unknown; restored from __doc__
    ...
    def get_monitor(self): # real signature unknown; restored from __doc__
    ...
    def get_parent_shell(self): # real signature unknown; restored from __doc__
    ...
    def get_reserve_toggle_size(self): # real signature unknown; restored from __doc__
    ...
    def get_selected_item(self): # real signature unknown; restored from __doc__
    ...
    def get_take_focus(self): # real signature unknown; restored from __doc__
        """ get_take_focus(self) -> bool """
        return False

    def get_tearoff_state(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new_for_manager(cls, manager): # real signature unknown; restored from __doc__
        """ new_for_manager(manager:Gtk.RecentManager) -> Gtk.Widget """
        pass

    def new_from_model(self, model): # real signature unknown; restored from __doc__
    ...
    def place_on_monitor(self, monitor): # real signature unknown; restored from __doc__
        """ place_on_monitor(self, monitor:Gdk.Monitor) """
        pass
    ...
    def popup(self, parent_menu_shell, parent_menu_item, func, data, button, activate_time): # reliably restored by inspect
        # no doc
        pass

    def popup_at_pointer(self, trigger_event=None): # real signature unknown; restored from __doc__
        """ popup_at_pointer(self, trigger_event:Gdk.Event=None) """
        pass

    def popup_at_rect(self, rect_window, rect, rect_anchor, menu_anchor, trigger_event=None): # real signature unknown; restored from __doc__
        """ popup_at_rect(self, rect_window:Gdk.Window, rect:Gdk.Rectangle, rect_anchor:Gdk.Gravity, menu_anchor:Gdk.Gravity, trigger_event:Gdk.Event=None) """
        pass

    def popup_at_widget(self, widget, widget_anchor, menu_anchor, trigger_event=None): # real signature unknown; restored from __doc__
        """ popup_at_widget(self, widget:Gtk.Widget, widget_anchor:Gdk.Gravity, menu_anchor:Gdk.Gravity, trigger_event:Gdk.Event=None) """
        pass

    def popup_for_device(self, device=None, parent_menu_shell=None, parent_menu_item=None, func=None, data=None, button, activate_time): # real signature unknown; restored from __doc__
    ...
    def reposition(self): # real signature unknown; restored from __doc__
        """ reposition(self) """
        pass
    ...
    def select_first(self, search_sensitive): # real signature unknown; restored from __doc__
        """ select_first(self, search_sensitive:bool) """
        pass

    def select_item(self, menu_item): # real signature unknown; restored from __doc__
        """ select_item(self, menu_item:Gtk.Widget) """
        pass
    ...
    def set_accel_path(self, accel_path=None): # real signature unknown; restored from __doc__
    ...
    def set_active(self, index): # real signature unknown; restored from __doc__
    ...
    def set_monitor(self, monitor_num): # real signature unknown; restored from __doc__
    ...
    def set_reserve_toggle_size(self, reserve_toggle_size): # real signature unknown; restored from __doc__
    ...
    def set_screen(self, screen=None): # real signature unknown; restored from __doc__
    ...
    def set_take_focus(self, take_focus): # real signature unknown; restored from __doc__
        """ set_take_focus(self, take_focus:bool) """
        pass

    def set_tearoff_state(self, torn_off): # real signature unknown; restored from __doc__
    ...
    menu_shell = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
