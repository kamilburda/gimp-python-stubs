...
class CellView(__gi_overrides_Gtk.Widget, CellLayout, Orientable):
    """
    :Constructors:
    ...
    def get_displayed_row(self): # real signature unknown; restored from __doc__
        """ get_displayed_row(self) -> Gtk.TreePath or None """
        pass
    ...
    def get_draw_sensitive(self): # real signature unknown; restored from __doc__
    ...
    def get_fit_model(self): # real signature unknown; restored from __doc__
    ...
    def get_size_of_row(self, path): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new_with_context(cls, area, context): # real signature unknown; restored from __doc__
        """ new_with_context(area:Gtk.CellArea, context:Gtk.CellAreaContext) -> Gtk.Widget """
        pass

    @classmethod
    def new_with_markup(cls, markup): # real signature unknown; restored from __doc__
        """ new_with_markup(markup:str) -> Gtk.Widget """
        pass

    @classmethod
    def new_with_pixbuf(cls, pixbuf): # real signature unknown; restored from __doc__
        """ new_with_pixbuf(pixbuf:GdkPixbuf.Pixbuf) -> Gtk.Widget """
        pass

    @classmethod
    def new_with_text(cls, text): # real signature unknown; restored from __doc__
        """ new_with_text(text:str) -> Gtk.Widget """
        pass
    ...
    def set_background_color(self, color): # real signature unknown; restored from __doc__
    ...
    def set_displayed_row(self, path=None): # real signature unknown; restored from __doc__
    ...
    def set_draw_sensitive(self, draw_sensitive): # real signature unknown; restored from __doc__
    ...
    def set_fit_model(self, fit_model): # real signature unknown; restored from __doc__
