...
class CalendarDisplayOptions(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'SHOW_HEADING': <CalendarDisplayOptions.SHOW_HEADING: 1>, 'SHOW_DAY_NAMES': <CalendarDisplayOptions.SHOW_DAY_NAMES: 2>, 'NO_MONTH_CHANGE': <CalendarDisplayOptions.NO_MONTH_CHANGE: 4>, 'SHOW_WEEK_NUMBERS': <CalendarDisplayOptions.SHOW_WEEK_NUMBERS: 8>, 'SHOW_DETAILS': <CalendarDisplayOptions.SHOW_DETAILS: 32>})"
    __name__ = 'CalendarDisplayOptions'
    __qualname__ = 'CalendarDisplayOptions'
