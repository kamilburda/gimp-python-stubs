...
class Label(Label):
    ...
    def new(self, p_str=None): # real signature unknown; restored from __doc__
        """ new(str:str=None) -> Gtk.Widget """
        pass
