...
class ScaleButton(__gi_overrides_Gtk.Button, Orientable):
    """
    :Constructors:
    ...
    def get_minus_button(self): # real signature unknown; restored from __doc__
    ...
    def get_plus_button(self): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new(cls, size, min, max, step, icons=None): # real signature unknown; restored from __doc__
        """ new(size:int, min:float, max:float, step:float, icons:list=None) -> Gtk.Widget """
        pass
    ...
    def set_icons(self, icons): # real signature unknown; restored from __doc__
