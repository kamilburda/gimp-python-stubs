...
class ApplicationInhibitFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'LOGOUT': <ApplicationInhibitFlags.LOGOUT: 1>, 'SWITCH': <ApplicationInhibitFlags.SWITCH: 2>, 'SUSPEND': <ApplicationInhibitFlags.SUSPEND: 4>, 'IDLE': <ApplicationInhibitFlags.IDLE: 8>})"
    __name__ = 'ApplicationInhibitFlags'
    __qualname__ = 'ApplicationInhibitFlags'
