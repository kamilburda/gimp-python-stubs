...
class EventControllerScrollFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <EventControllerScrollFlags.NONE: 0>, 'VERTICAL': <EventControllerScrollFlags.VERTICAL: 1>, 'HORIZONTAL': <EventControllerScrollFlags.HORIZONTAL: 2>, 'DISCRETE': <EventControllerScrollFlags.DISCRETE: 4>, 'KINETIC': <EventControllerScrollFlags.KINETIC: 8>, 'BOTH_AXES': <EventControllerScrollFlags.BOTH_AXES: 3>})"
    __name__ = 'EventControllerScrollFlags'
    __qualname__ = 'EventControllerScrollFlags'
