...
class CellAccessibleParentIface(__gi.Struct):
    """
    :Constructors:
    ...
    edit = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    expand_collapse = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_cell_area = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_cell_extents = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_cell_position = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_child_index = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_column_header_cells = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    get_renderer_state = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    update_relationset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
