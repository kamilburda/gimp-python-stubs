...
class Template(object):
    ...
    @classmethod
    def from_resource(cls, *args, **kwargs): # real signature unknown
        pass
    ...
    def __call__(self, cls): # reliably restored by inspect
        # no doc
        pass
    ...
    def __init__(self, **kwargs): # reliably restored by inspect
        # no doc
        pass
