...
class Calendar(__gi_overrides_Gtk.Widget):
    """
    :Constructors:
    ...
    def do_day_selected(self, *args, **kwargs): # real signature unknown
        """ day_selected(self) """
        pass

    def do_day_selected_double_click(self, *args, **kwargs): # real signature unknown
        """ day_selected_double_click(self) """
        pass
    ...
    def do_month_changed(self, *args, **kwargs): # real signature unknown
        """ month_changed(self) """
        pass
    ...
    def do_next_month(self, *args, **kwargs): # real signature unknown
        """ next_month(self) """
        pass

    def do_next_year(self, *args, **kwargs): # real signature unknown
        """ next_year(self) """
        pass
    ...
    def do_prev_month(self, *args, **kwargs): # real signature unknown
        """ prev_month(self) """
        pass

    def do_prev_year(self, *args, **kwargs): # real signature unknown
        """ prev_year(self) """
        pass
    ...
    def get_day_is_marked(self, day): # real signature unknown; restored from __doc__
    ...
    def get_detail_height_rows(self): # real signature unknown; restored from __doc__
        """ get_detail_height_rows(self) -> int """
        return 0

    def get_detail_width_chars(self): # real signature unknown; restored from __doc__
    ...
    def get_display_options(self): # real signature unknown; restored from __doc__
    ...
    def mark_day(self, day): # real signature unknown; restored from __doc__
    ...
    def select_day(self, day): # real signature unknown; restored from __doc__
        """ select_day(self, day:int) """
        pass

    def select_month(self, month, year): # real signature unknown; restored from __doc__
    ...
    def set_detail_func(self, func, data=None): # real signature unknown; restored from __doc__
        """ set_detail_func(self, func:Gtk.CalendarDetailFunc, data=None) """
        pass

    def set_detail_height_rows(self, rows): # real signature unknown; restored from __doc__
        """ set_detail_height_rows(self, rows:int) """
        pass

    def set_detail_width_chars(self, chars): # real signature unknown; restored from __doc__
    ...
    def set_display_options(self, flags): # real signature unknown; restored from __doc__
    ...
    def unmark_day(self, day): # real signature unknown; restored from __doc__
