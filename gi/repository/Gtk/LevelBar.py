...
class LevelBar(__gi_overrides_Gtk.Widget, Orientable):
    """
    :Constructors:
    ...
    def add_offset_value(self, name, value): # real signature unknown; restored from __doc__
    ...
    def do_offset_changed(self, *args, **kwargs): # real signature unknown
        """ offset_changed(self, name:str) """
        pass
    ...
    def get_max_value(self): # real signature unknown; restored from __doc__
        """ get_max_value(self) -> float """
        return 0.0

    def get_min_value(self): # real signature unknown; restored from __doc__
    ...
    def get_offset_value(self, name=None): # real signature unknown; restored from __doc__
    ...
    @classmethod
    def new_for_interval(cls, min_value, max_value): # real signature unknown; restored from __doc__
        """ new_for_interval(min_value:float, max_value:float) -> Gtk.Widget """
        pass
    ...
    def remove_offset_value(self, name=None): # real signature unknown; restored from __doc__
    ...
    def set_inverted(self, inverted): # real signature unknown; restored from __doc__
    ...
    def set_max_value(self, value): # real signature unknown; restored from __doc__
        """ set_max_value(self, value:float) """
        pass

    def set_min_value(self, value): # real signature unknown; restored from __doc__
