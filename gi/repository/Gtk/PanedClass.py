...
class PanedClass(__gi.Struct):
    ...
    accept_position = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    cancel_position = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    cycle_child_focus = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    cycle_handle_focus = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    move_handle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    parent_class = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    toggle_handle_focus = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
