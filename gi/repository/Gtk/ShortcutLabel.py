...
class ShortcutLabel(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    ...
    def get_accelerator(self): # real signature unknown; restored from __doc__
        """ get_accelerator(self) -> str or None """
        return ""
    ...
    def get_disabled_text(self): # real signature unknown; restored from __doc__
        """ get_disabled_text(self) -> str or None """
        return ""
    ...
    @classmethod
    def new(cls, accelerator): # real signature unknown; restored from __doc__
        """ new(accelerator:str) -> Gtk.Widget """
        pass
    ...
    def set_accelerator(self, accelerator): # real signature unknown; restored from __doc__
        """ set_accelerator(self, accelerator:str) """
        pass
    ...
    def set_disabled_text(self, disabled_text): # real signature unknown; restored from __doc__
        """ set_disabled_text(self, disabled_text:str) """
        pass
