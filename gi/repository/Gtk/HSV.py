...
class HSV(__gi_overrides_Gtk.Widget):
    """
    :Constructors:
    ...
    def do_move(self, *args, **kwargs): # real signature unknown
        """ move(self, type:Gtk.DirectionType) """
        pass
    ...
    def get_color(self): # real signature unknown; restored from __doc__
        """ get_color(self) -> h:float, s:float, v:float """
        pass
    ...
    def get_metrics(self): # real signature unknown; restored from __doc__
        """ get_metrics(self) -> size:int, ring_width:int """
        pass
    ...
    def set_color(self, h, s, v): # real signature unknown; restored from __doc__
        """ set_color(self, h:float, s:float, v:float) """
        pass
    ...
    def set_metrics(self, size, ring_width): # real signature unknown; restored from __doc__
        """ set_metrics(self, size:int, ring_width:int) """
        pass
    ...
    def to_rgb(self, h, s, v): # real signature unknown; restored from __doc__
        """ to_rgb(h:float, s:float, v:float) -> r:float, g:float, b:float """
        pass
