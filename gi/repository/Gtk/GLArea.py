...
class GLArea(__gi_overrides_Gtk.Widget):
    """
    :Constructors:
    ...
    def attach_buffers(self): # real signature unknown; restored from __doc__
        """ attach_buffers(self) """
        pass
    ...
    def do_resize(self, *args, **kwargs): # real signature unknown
    ...
    def get_auto_render(self): # real signature unknown; restored from __doc__
    ...
    def get_has_depth_buffer(self): # real signature unknown; restored from __doc__
        """ get_has_depth_buffer(self) -> bool """
        return False

    def get_has_stencil_buffer(self): # real signature unknown; restored from __doc__
    ...
    def queue_render(self): # real signature unknown; restored from __doc__
        """ queue_render(self) """
        pass
    ...
    def set_auto_render(self, auto_render): # real signature unknown; restored from __doc__
    ...
    def set_error(self, error=None): # real signature unknown; restored from __doc__
    ...
    def set_has_alpha(self, has_alpha): # real signature unknown; restored from __doc__
        """ set_has_alpha(self, has_alpha:bool) """
        pass

    def set_has_depth_buffer(self, has_depth_buffer): # real signature unknown; restored from __doc__
        """ set_has_depth_buffer(self, has_depth_buffer:bool) """
        pass

    def set_has_stencil_buffer(self, has_stencil_buffer): # real signature unknown; restored from __doc__
